...
void check_and_replace_bootloader(bool shutdown_on_replace)
{
    ...
    if (!known_bootloader(r, hash)) {
        layoutDialog(
            &bmp_icon_error, NULL, NULL, NULL, _("Unknown bootloader"), _("detected."), NULL,
            _("Unplug your Trezor"), _("contact our support."), NULL);
        shutdown();
    }
    ...
    layoutDialog(
        &bmp_icon_warning, NULL, NULL, NULL, _("Updating bootloader"), NULL, NULL,
        _("DO NOT UNPLUG"), _("YOUR TREZOR!"), NULL);
    ...
    for (int tries = 0; tries < 10; tries++) {
        ...
        if (r == 32 && 0 == memcmp(hash, bl_hash, 32)) {
            if (shutdown_on_replace) {
                ...
                layoutDialog(
                    &bmp_icon_info, NULL, NULL, NULL, _("Update finished"), _("successfully."),
                    NULL, _("Please reconnect"), _("the device."), NULL);
                shutdown();
            }
            return;
        }
    ...
    // show info and halt
    layoutDialog(
        &bmp_icon_error, NULL, NULL, NULL, _("Bootloader update"), _("broken."), NULL,
        _("Unplug your Trezor"), _("contact our support."), NULL);
    shutdown();
#endif
