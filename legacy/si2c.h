...
#define SET_I2C_SDA_OUT()   (gpio_mode_setup(GPIO_SI2C_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE,  GPIO_SI2C_SDA))
#define SET_I2C_SDA_IN()    (gpio_mode_setup(GPIO_SI2C_PORT, GPIO_MODE_INPUT, GPIO_PUPD_PULLUP,  GPIO_SI2C_SDA))
