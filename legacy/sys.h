...
#define DISP_INPUTPIN			0x06 //按照右图提示输入PIN码//Enter PIN code according to the prompts on the right screen
#define DISP_BUTTON_OK_RO_NO	0x07 //按下 OK 确认，按<取消//Press OK to confirm, Press < to Cancel
...
#define DISP_SIGN_SUCCESS	  	0x0F //签名成功！请与手机贴合//Signed! Touch it to the phone closely
#define DISP_SIGN_PRESS_OK_HOME 0x10 //签名完成！按OK返回首页//Signed! Press OK to return to homepage
#define DISP_SIGN_SUCCESS_VIEW  0x11 //签名成功！请在手机查看交易//Signed! Please view transaction on your phone
#define DISP_UPDATGE_APP_GOING	0x12 //正在升级，请不要关机Upgrading, do not turn off
#define DISP_UPDATGE_SUCCESS  	0x13 //固件升级成功，按OK返回首页//Firmware upgraded, press OK to return to homepage
