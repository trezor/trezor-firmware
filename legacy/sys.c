...
void vDisp_PromptInfo(uint8_t ucIndex)
{
    ...
    switch(ucIndex)
    {
        ...
        case DISP_INPUTPIN:
           if(g_ucLanguageFlag)
            ...
            else
            {
                ...
                oledDrawStringCenter(0, 56, "to the prompts on the right screen", FONT_STANDARD);
            }
            break;
        ...
        case DISP_UPDATGE_APP_GOING:
            ...
            {
                oledDrawStringCenter(0, 48, "Upgrading, do not turn off", FONT_STANDARD);
            }
            break;
        case DISP_UPDATGE_SUCCESS:
            ...
            else
            {
                ...
                oledDrawStringCenter(0, 56, "press OK to return to homepage", FONT_STANDARD);
            }
            break;
...
void vPower_Control(uint8_t ucMode)
{
  ...
  else
  {
        if((WORK_MODE_USB !=  g_ucWorkMode) && (GET_BUTTON_CANCEL()))
        {
            ...
            if((0x00 == GET_USB_INSERT())&& (POWER_BUTTON_UP == s_usPower_Button_Status)&& (GET_NFC_INSERT()))
	        {
