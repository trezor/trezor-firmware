...
int known_bootloader(int r, const uint8_t *hash) {
	...
	if (0 == memcmp(hash, "\x53\xdd\xee\xef\x09\xb9\x0d\x36\xf6\x3a\x12\x85\xd0\x6d\xf2\xd3\x9d\xbf\x06\x83\x78\x30\x90\x3d\x57\x96\xbc\x2b\x3b\xa7\x36\x56", 32)) return 1;  // 1.8.0 shipped with fw 1.8.0
	return 0;
}
