...
class TestCryptoBip39(unittest.TestCase):
    def test_mnemonic(self):
        ...
        for d, m, s in v:
            self.assertEqual(bip39.from_data(bytes.fromhex(d)), m)
            self.assertEqual(bip39.seed(m, "TREZOR"), bytes.fromhex(s))
    ...
    def test_check_fail(self):
        v = [
            ...
            "above abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon address",
            ...
            "above abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon admit",
