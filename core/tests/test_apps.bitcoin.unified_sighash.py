...
"""The device's digest against Knots' cross-implementation vectors.

Runs the 27 of the 166 that are hash type 0x21 on a script type this firmware
can spend. The rest are skipped by hash type or as tapscript, both counted, and
the total is asserted against the vector file so a shrinking set cannot pass.
"""
