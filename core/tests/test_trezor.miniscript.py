...
class TestMiniscriptScript(unittest.TestCase):
    ...
    vectors = [
        (
            ...
            [
                False,
                1,
                "bc1q5ztlw2eq7xqdmqtzfpnu3jc2fv05r3eld3mjr4zpk0k9e4yrhwyq2ulchr",
            ],
        ),
        (
        ...
        (
            ...
            [
                False,
                1,
                "tb1qkcqsdd5k4hg6vp0wc9nqksjq4qhpj0xjy6q04rf3c9ahzj9epjrsjwpj7c",
            ],
            [
                False,
                2,
                "tb1qlwmhydmvs25nq2vlz0ukt3hsz0lesz8unx79kvl2nhmcs9vzdyvq7uh86v",
            ],
        ),
        (
            ...
            [
                False,
                1,
                "bc1qkye36enq7qzxadptuhh4v9t09zhelpw3cz9n0knvg2ayhdns5c7sc6vyde",
            ],
        ),
        (
            ...
            [
                False,
                2048,
                "bc1qyqwat6ts2wcwp0zj24vhz7vdky5rhef03np67d7nsuyh7j8w4z5sy6dcr0",
            ],
            [
                True,
                2048,
                "bc1q4j4dqp0ascxv9n6vmzkkw0fdj0agq2q5untuhf57mut99j5tqjqqy2mq2n",
            ],
        ),
        (
        ...
        (
            ...
            [
                False,
                77,
                "bc1q2p4v6zelvdq9zfzz56jq0zyjeae8cy6wadzrx0fe2zszw9s4e8tsml9p6q",
            ],
            [
                True,
                77,
                "bc1qt835665jr9422vut3234q95tf27jvggx7jry0cfl3kq9hr9ala4qsluma6",
            ],
        ),
        (
            ...
            [
                False,
                120,
                "bc1q73sxy54qdr0f2mgnqhd4felm67nm9tfg99w2grag3zz055ee3nxq0fdcxp",
            ],
            [
                True,
                120,
                "bc1ql0cpv6q85qlr6a2wcfg0lh3ms89f8z98sy9fc4m7q45k5r3kyf2s2z2v4g",
            ],
        ),
        # From https://adys.dev/miniscript
        (
            ...
            [
                False,
                0,
                "bc1q8ptytc24ztnhhe0ksd7ngq56sf5afe8erz6phhtw4yxh7yk5kx3q880634",
            ],
        ),
        (
            # Emergency Recovery",
            ...
            [
                False,
                0,
                "bc1qk6s8edzztsx0lfx5clr8xe6pxaz6wqmu0eah5u8jglg66zv7ldnsksr73p",
            ],
        ),
        (
            # 2FA + Backup
            ...
            [
                False,
                0,
                "bc1qfr0lnd8ujtech9l5p6llh8wusz4779ezjt0xpz6ntnw3lzqspnhqkz98lv",
            ],
        ),
        (
            # HODL Wallet
            ...
            [
                False,
                0,
                "bc1qy7sn46zry0x039ydl6j3jalj63vsuhg64c0s8ms9wuejz3mx9kpsqkga9y",
            ],
        ),
        (
            # Timelocked Multisig
            ...
            [
                False,
                0,
                "bc1qtw2r0rs7u5cusde4lfvnepeshyuy87ujx5tudk30un6h6ujxj30sx9dyqs",
            ],
        ),
        (
            # Atomic Swap
            ...
            [
                False,
                0,
                "bc1qlxxylc6h34j5pw45yp4dnj9n9m2ney4cg97wawxe8jkpt7c4k0cqlxvlvl",
            ],
        ),
    ]
    ...
    def test_vectors(self):
        for template, xpubs, *addrs in self.vectors:
            for path, index, expected in addrs:
                ms = _miniscript(template, xpubs)
                script = trezorminiscript.compile(ms, path, index)
