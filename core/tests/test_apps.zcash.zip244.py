...
from apps.bitcoin.scripts import parse_input_script_p2pkh
...
class TestZcashSigHasher(unittest.TestCase):
    def test_zcash_extended_sig_hasher(self):
        # tx a56650ec3dcc388c010b62d8303fcdb7c35e60d9709783acf806a912ab9a4d64
        # from sldev.cz testnet
        tx = SignTx(
            version=5,
        ...
        public_key, signature, hash_type = parse_input_script_p2pkh(signature_script)
        outputs = [
            PrevOutput(
                amount=100000000,
        ...
        # expected sighash computed by tool in zcash-test-vectors 
