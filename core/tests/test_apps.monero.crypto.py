...
class TestMoneroCrypto(unittest.TestCase):
    ...
    def test_cn_fast_hash(self):
        inp = bytes.fromhex(
            "259ef2aba8feb473cf39058a0fe30b9ff6d245b42b6826687ebd6b63128aff6405"
        )
        res = crypto.fast_hash_into(None, inp)
        self.assertEqual(
            res,
            bytes.fromhex(
                "86db87b83fb1246efca5f3b0db09ce3fa4d605b0d10e6507cac253dd31a3ec16"
            ),
        )
    ...
    def test_hash_to_scalar(self):
        ...
        exp = crypto_helpers.decodeint(
            bytes.fromhex(
                "9907925b254e12162609fc0dfd0fef2aa4d605b0d10e6507cac253dd31a3ec06"
            )
        )
    ...
    def test_derivation_to_scalar(self):
        derivation = bytes.fromhex(
            "e720a09f2e3a0bbf4e4ba7ad93653bb296885510121f806acb2a5f9168fafa01"
        )
        scalar = bytes.fromhex(
            "25d08763414c379aa9cf989cdcb3cadd36bd5193b500107d6bf5f921f18e470e"
        )
    ...
    def test_generate_key_derivation(self):
        key_pub = crypto_helpers.decodepoint(
            bytes.fromhex(
                "7739c95d3298e2f87362dba9e0e0b3980a692ae8e2f16796b0e382098cd6bd83"
            )
        )
        ...
        deriv_exp = bytes.fromhex(
            "fa188a45a0e4daccc0e6d4f6f6858fd46392104be74183ec0047e7e9f4eaf739"
        )
    ...
    def test_sc_inversion(self):
        ...
        self.assertEqual(
            crypto_helpers.encodeint(res).hex(),
            "bcf365a551e6358f3f281a6241d4a25eded60230b60a1d48c67b51a85e33d70e",
        )
    ...
    def test_addr_encode(self):
        ...
        addr = tcry.xmr_base58_addr_encode_check(
            19,
            bytes.fromhex(
                "eda9fe8dfcdd25d5430ea64229d04f6b41b2e5a1587c29cd499a63eb79d117113076a02b73d130fb904c9e91075fcd16f735c6850dfadb125eb826d96a113f098a125052fe6f3877"
            ),
        )
        ...
        addr2 = encode_addr(
            ...
            bytes.fromhex("8a125052fe6f3877"),
        )
    ...
    def test_wallet_addr(self):
        addr = encode_addr(
            net_version(),
            bytes.fromhex(
                "3bec484c5d7f0246af520aab550452b5b6013733feabebd681c4a60d457b7fc1"
            ),
            bytes.fromhex(
                "2d5918e31d3c003da3c778592c07b398ad6f961a67082a75fd49394d51e69bbe"
            ),
        )
    ...
    def test_derive_subaddress_public_key(self):
        out_key = crypto_helpers.decodepoint(
            bytes.fromhex(
                "f4efc29da4ccd6bc6e81f52a6f47b2952966442a7efb49901cce06a7a3bef3e5"
            )
        )
        ...
        self.assertEqual(
            res,
            bytes.fromhex(
                "5a10cca900ee47a7f412cd661b29f5ab356d6a1951884593bb170b5ec8b6f2e8"
            ),
        )
    ...
    def test_get_subaddress_secret_key(self):
        ...
        self.assertEqual(
            ...
            bytes.fromhex(
                "b6ff4d689b95e3310efbf683850c075bcde46361923054e42ef30016b287ff0c"
            ),
        )
    ...
    def test_public_spend(self):
        ...
        pkey_ex = bytes.fromhex(
            "0846cae7405077b6b7800f0b932c10a186448370b6db318f8c9e13f781dab546"
        )
    ...
    def test_view_tags(self):
        ...
        for key, idx, exp in test_vectors:
            self.assertEqual(
                _derive_view_tags(crypto_helpers.decodepoint(bytes.fromhex(key)), idx),
                exp,
            )
