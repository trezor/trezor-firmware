...
class TestMoneroBulletproof(unittest.TestCase):
    ...
    def test_dvct_skips(self):
        z_sq = bytes.fromhex(
            "e0408b528e9d35ccb8386b87f39b85c724740644f4db412483a8852cdb3ceb00"
        )
    ...
    def bproof_plus_2(self):
        return BulletproofPlus(
            V=[
                bytes.fromhex("e0dae61095ac728a15d4d9754f1f9f956c22d4fa2deee2c0ff1def031b083e02"),
                bytes.fromhex("5b424ecb1f8ea02351d324296a34a0608ecc104610feaad06e6002f61992bfe1"),
            ],
            A=bytes.fromhex("6ae6f16a6b01cf494fb2cf368573365293f76c624cfc11152d648479238e9319"),
            ...
            r1=bytes.fromhex("40ad8a9c6b3bdd95c7fb8605e50135050e64f1ce29d1c4b37b1271e658354500"),
            s1=bytes.fromhex("aed959c770499134aaa7e099f566dac56ee12959d797b62a3d8d1037b790b806"),
            d1=bytes.fromhex("395a1e8d3df8e90e716fdeaa493090782c8db922337d09a36b50c1f02cd8e100"),

            L=[bytes.fromhex("ed2d768bb9c8b5a9fa24c90b5831d3cceb3e78cef45eba90e52f89a2b3c859d2"),
               bytes.fromhex("7f25cc8e211783e9c1b80dd13ee286943da0ec07bd33291536639432758f6927"),
               bytes.fromhex("7bae3d31f4e2a6d78d74d2bcb6d0656e4222161423d635f7ce08805e96cec83e"),
               bytes.fromhex("c87f949f70cf569c4baa332612305733fd19a2262490c55ec88c16a68d7b5e7d"),
               bytes.fromhex("34d06caf0d02129ebcc8bf318da8f6a0ddfaf2c7cb85f4144726561cefc86dcd"),
               bytes.fromhex("ab3effd3a2706591774e013c76f5b8ece9e58abf7efc0a11b479f9d2a89d0c55"),
               bytes.fromhex("ebf8d34e6643533bf73b13d2dd56aeaf2113fb3017d39bc6db6a2f71bc1d53f1"),
               ],
            R=[bytes.fromhex("27e146e61e88944246dcd90ddb4284923c7fdc6fd6a187ed2efa3dcb8c380346"),
               bytes.fromhex("fab99152d48d835b9a01cdbec46301db0f57ca091f6cbaa0b45c8498f18babe1"),
               bytes.fromhex("8467f87acd7be026a27ed798cca6cc1526b0f805ac534a9c5162a9cd75460011"),
               bytes.fromhex("f421fa4bda1dba042ca56c6bdce313dc8d18cee084d722af47447ce54b6ff8df"),
    ...
    def bproof_plus_2_invalid(self):
        return BulletproofPlus(
            ...
            A=bytes.fromhex("6ae6f16a6b01cf494fb2cf368573365293f76c624cfc11152d648479238e9309"),
            A1=bytes.fromhex("33ad318a44df6f14a945e6d051911ab9a24841457d15d62bd1436fb3edc8a193"),
            B=bytes.fromhex("5f56531cb8e78dbb3450f1d599a6d4c7f5e4c04ee3e7015643c19a528bcbb109"),
