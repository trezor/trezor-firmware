...
class TestCryptoGroestl512(unittest.TestCase):
    ...
    vectors = [
        ...
        (
            bytes.fromhex("82E192E4043DDCD12ECF52969D0F807EED"),
    ...
    def test_digest(self):
        for b, d in self.vectors:
            self.assertEqual(hashlib.groestl512(b).digest(), bytes.fromhex(d))
    ...
    def test_update(self):
        ...
        # self.assertEqual(x.digest(), bytes.fromhex('787C88460E5D09ABD7A98C050F3422BBFDBD36A74B05DE04B57A13FA3F36A570B8561580AB9DA4096CCD5111B5DE948F769D9D61833A6CE2B2F223061E688994'))
