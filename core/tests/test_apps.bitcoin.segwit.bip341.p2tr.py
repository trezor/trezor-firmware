    ...
    {  # https://github.com/bitcoin/bips/pull/1191/commits/fa40b5ae3544c1ed1615ead93a688d72be963e08
        ...
        "inputs": [
            TxInput(
                ...
                sequence=0,
                script_pubkey=bytes.fromhex(
                    "0014196a5bea745288a7f947993c28e3a0f2108d2e0a"
                ),
            ),
            TxInput(
                prev_hash=bytes.fromhex(
