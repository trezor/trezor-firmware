...
class TestRippleSerializer(unittest.TestCase):
    ...
    def test_transactions(self):
        ...
        common = RippleSignTx(None, 10, None, 1, None, payment = payment, account=source_address)
        ...
        common = RippleSignTx(None, 99, None, 99, None, payment = payment, account=source_address)
        self.assertEqual(serialize(common, "payment",for_signing=True), unhexlify(
        ...
        common = RippleSignTx(None, 10, 0, 2, None, payment = payment, account=source_address)
        self.assertEqual(serialize(common, "payment",for_signing=True), unhexlify(
        ...
        common = RippleSignTx(None, 15, 0, 144, None, payment = payment, account=source_address)
        ...
        common = RippleSignTx(None, 12, 0, 1, None, payment = payment, account=source_address)
        self.assertEqual(serialize(common, "payment", for_signing=True), unhexlify(
    ...
    def test_transactions_for_signing(self):
        ...
        common = RippleSignTx(None, 10, 2147483648, 1, None, payment = payment, account=source_address, signing_pub_key="ed5f5ac8b98974a3ca843326d9b88cebd0560177b973ee0b149f782cfaa06dc66a")
