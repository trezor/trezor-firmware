...
class TestCardanoGetPublicKey(unittest.TestCase):
    ...
    def test_get_public_key_scheme_12_words(self):
        ...
        public_keys = [
            ...
            "f698a764b23aa6667b1157fc4247c6a1b58c21a3865ac6a47a3590167a9e0211",
            "e9c46841be76e3be0289694fd5c7503c04f40e5b036abac200b98a9006cf6647",
            "6d225f078ca611f00d86cbfd8ba6c6ac7826721434eae6525686efb878b72370",
        ...
        chain_codes = [
            ...
            "13cfb6de37a568aae56cadac907e6469b121464fe1b70a10c213eaea2cbb6636",
            "58f3f46f4a93e7a4431e75b10af7497b747c3053cb7466ed53f4277e78a63c52",
            "f72b3c361381db2d88289440268c94c5e7467c9414375e6b63d03026750f3c66",
            "f123474e140a2c360b01f0fa66f2f22e2e965a5b07a80358cf75f77abbd66088",
        ]
        ...
        for index, derivation_path in enumerate(derivation_paths):
            ...
            self.assertEqual(key.node.public_key.hex(), public_keys[index])
            self.assertEqual(key.node.chain_code.hex(), chain_codes[index])
    ...
    def test_get_public_key_scheme_18_words(self):
        ...
        public_keys = [
            "82f12f1916c0c35a412291e72204f17f033b0b7edf148dfd7d75acd3975c9ac0",
            "d92d0590e76bbf0300112a9f283fba2f7f8af5cf1054d634b610d1e4f541df90",
        ]

        chain_codes = [
            "974f9cd4336e23b976f934752026a2d4c32d2e23f0532f4f87152b45fa5ca81f",
            "352499ed19b47f2bc8c164b47df0d55f428cc8c12f96b7e65d7563114ddfd75b",
        ]
    ...
    def test_get_public_key_scheme_24_words(self):
        ...
        public_keys = [
            "9d45d1e979bd0b942adb1896019c85d08fbc562f012775a1f72fc7be8fe9e4b6",
            "a85a339897354931d584f828f6d79d4227ed16f3468990687ab42f13a87c9ea8",
        ]

        chain_codes = [
            "aad67fd6d620f7af88ad816a229de09cfacff3e28008a528759b2e2cf28d859a",
            "e6f844931e7e2ec724e6e62efde662ae2669355322dc3eb9b307bc1c8e75e219",
        ]
