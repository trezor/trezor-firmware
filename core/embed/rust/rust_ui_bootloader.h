...
void screen_connect(bool initial_setup, uint8_t* mem, size_t mem_len);
uint32_t screen_connect_event(uint8_t* mem, size_t mem_len, int16_t iface,
                              poll_event_t event);
...
uint32_t screen_welcome_event(uint8_t* mem, size_t mem_len, int16_t iface,
                              poll_event_t event);
...
uint32_t screen_pairing_mode(bool initial_setup);
