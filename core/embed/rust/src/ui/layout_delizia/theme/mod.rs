...
pub const PROPS_KEY_FONT: TextStyle = TEXT_MONO;
pub const PROPS_VALUE_FONT: TextStyle = TEXT_SUB_GREY_LIGHT;
pub const PROPS_VALUE_MONO_FONT: TextStyle = TEXT_MONO;
