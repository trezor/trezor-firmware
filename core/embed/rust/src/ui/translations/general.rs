...
pub struct TranslationsGeneral {
    ...
    pub buttons__back: &'static str,
    pub buttons__show_details: &'static str,
    pub solana__account_index: &'static str,
    pub solana__associated_token_account: &'static str,
    pub solana__confirm_multisig: &'static str,
    pub solana__expected_fee: &'static str,
    pub solana__instruction_accounts_template: &'static str,
    pub solana__instruction_data: &'static str,
    pub solana__instruction_is_multisig: &'static str,
    pub solana__is_provided_via_lookup_table_template: &'static str,
    pub solana__lookup_table_address: &'static str,
    pub solana__multiple_signers: &'static str,
    pub solana__token_address: &'static str,
    pub solana__transaction_contains_unknown_instructions: &'static str,
    pub solana__transaction_requires_x_signers_template: &'static str,
    pub stellar__balance_id: &'static str,
    pub stellar__claim_claimable_balance: &'static str,
    pub words__account: &'static str,
    pub words__blockhash: &'static str,
    pub words__fee: &'static str,
...
impl TranslationsGeneral {
    ...
    fn get_info(&self, key: &str) -> Option<(&'static str, usize)> {
        match key {
            ...
            "buttons__back" => Some((self.buttons__back, 832)),
            "buttons__show_details" => Some((self.buttons__show_details, 833)),
            "solana__account_index" => Some((self.solana__account_index, 834)),
            "solana__associated_token_account" => Some((self.solana__associated_token_account, 835)),
            "solana__confirm_multisig" => Some((self.solana__confirm_multisig, 836)),
            "solana__expected_fee" => Some((self.solana__expected_fee, 837)),
            "solana__instruction_accounts_template" => Some((self.solana__instruction_accounts_template, 838)),
            "solana__instruction_data" => Some((self.solana__instruction_data, 839)),
            "solana__instruction_is_multisig" => Some((self.solana__instruction_is_multisig, 840)),
            "solana__is_provided_via_lookup_table_template" => Some((self.solana__is_provided_via_lookup_table_template, 841)),
            "solana__lookup_table_address" => Some((self.solana__lookup_table_address, 842)),
            "solana__multiple_signers" => Some((self.solana__multiple_signers, 843)),
            "solana__token_address" => Some((self.solana__token_address, 844)),
            "solana__transaction_contains_unknown_instructions" => Some((self.solana__transaction_contains_unknown_instructions, 845)),
            "solana__transaction_requires_x_signers_template" => Some((self.solana__transaction_requires_x_signers_template, 846)),
            "stellar__balance_id" => Some((self.stellar__balance_id, 847)),
            "stellar__claim_claimable_balance" => Some((self.stellar__claim_claimable_balance, 848)),
            "words__account" => Some((self.words__account, 849)),
            "words__blockhash" => Some((self.words__blockhash, 850)),
            "words__fee" => Some((self.words__fee, 851)),
