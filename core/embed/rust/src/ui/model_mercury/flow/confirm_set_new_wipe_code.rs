...
pub enum SetNewWipePin {
    Intro,
    Menu,
}

impl FlowController for SetNewWipePin {
    #[inline]
...
pub fn new_set_new_wipe_pin(
    ...
    let res = SwipeFlow::new(&SetNewWipePin::Intro)?
        .with_page(&SetNewWipePin::Intro, content_intro)?
        .with_page(&SetNewWipePin::Menu, content_menu)?;
    Ok(res)
}
