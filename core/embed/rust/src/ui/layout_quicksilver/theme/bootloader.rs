...
// BLD icons
pub const X24: &[u8] = include_res!("layout_quicksilver/res/x24.toif");
pub const X32: &[u8] = include_res!("layout_quicksilver/res/x32.toif");
pub const FIRE24: &[u8] = include_res!("layout_quicksilver/res/fire24.toif");
pub const FIRE32: &[u8] = include_res!("layout_quicksilver/res/fire32.toif");
pub const FIRE40: &[u8] = include_res!("layout_quicksilver/res/fire40.toif");
pub const REFRESH24: &[u8] = include_res!("layout_quicksilver/res/refresh24.toif");
pub const MENU32: &[u8] = include_res!("layout_quicksilver/res/menu32.toif");
pub const INFO32: &[u8] = include_res!("layout_quicksilver/res/info32.toif");
pub const DOWNLOAD24: &[u8] = include_res!("layout_quicksilver/res/download24.toif");
pub const WARNING40: &[u8] = include_res!("layout_quicksilver/res/warning40.toif");
pub const CHECK24: &[u8] = include_res!("layout_quicksilver/res/check24.toif");
pub const CHECK40: &[u8] = include_res!("layout_quicksilver/res/check40.toif");
