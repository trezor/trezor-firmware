...
// 12x12
include_icon!(ICON_FORESLASH, "layout_quicksilver/res/foreslash12.toif");
...
include_icon!(ICON_PAGE_DOWN, "layout_quicksilver/res/page_down20.toif");
include_icon!(ICON_PAGE_UP, "layout_quicksilver/res/page_up20.toif");

// 24x24
include_icon!(ICON_CANCEL, "layout_quicksilver/res/cancel24.toif");
include_icon!(
    ICON_CHEVRON_LEFT,
    "layout_quicksilver/res/chevron_left24.toif"
);
include_icon!(
    ICON_CHEVRON_RIGHT,
    "layout_quicksilver/res/chevron_right24.toif"
);
include_icon!(ICON_DOWNLOAD, "layout_quicksilver/res/download24.toif");
include_icon!(ICON_KEY, "layout_quicksilver/res/key20.toif");
include_icon!(ICON_QR_CODE, "layout_quicksilver/res/qr_code24.toif");
include_icon!(ICON_REBOOT, "layout_quicksilver/res/reboot24.toif");
include_icon!(ICON_WARNING, "layout_quicksilver/res/warning24.toif");
include_icon!(
    ICON_SIMPLE_CHECKMARK24,
    "layout_quicksilver/res/simple_checkmark24.toif"
);

// 30x30
include_icon!(ICON_AUTOFILL, "layout_quicksilver/res/autofill30.toif");
include_icon!(ICON_CLOSE, "layout_quicksilver/res/close30.toif");
include_icon!(
    ICON_CONFIRM_INPUT,
    "layout_quicksilver/res/confirm_input30.toif"
);
include_icon!(ICON_DELETE, "layout_quicksilver/res/delete30.toif");
include_icon!(ICON_MENU, "layout_quicksilver/res/menu30.toif");
include_icon!(
    ICON_SIMPLE_CHECKMARK30,
    "layout_quicksilver/res/simple_checkmark30.toif"
);
include_icon!(ICON_SIGN, "layout_quicksilver/res/sign30.toif");

// 40x40
include_icon!(ICON_MINUS, "layout_quicksilver/res/minus40.toif");
include_icon!(ICON_PLUS, "layout_quicksilver/res/plus40.toif");

// Homescreen
include_icon!(
    ICON_LOCKSCREEN_FILTER,
    "layout_quicksilver/res/lockscreen_filter.toif"
);

// Scrollbar/PIN dots - taken from model T
include_icon!(DOT_ACTIVE, "layout_quicksilver/res/scroll-active.toif");
include_icon!(DOT_INACTIVE, "layout_quicksilver/res/scroll-inactive.toif");
include_icon!(
    DOT_INACTIVE_HALF,
    "layout_quicksilver/res/scroll-inactive-half.toif"
);
include_icon!(
    DOT_INACTIVE_QUARTER,
    "layout_quicksilver/res/scroll-inactive-quarter.toif"
);
include_icon!(DOT_SMALL, "layout_quicksilver/res/scroll-small.toif");
include_icon!(ICON_PIN_BULLET, "layout_quicksilver/res/pin_bullet6.toif");

// Text arrows.
include_icon!(ICON_PAGE_NEXT, "layout_quicksilver/res/page-next.toif");
include_icon!(ICON_PAGE_PREV, "layout_quicksilver/res/page-prev.toif");

// Icon for "<space>*#" key on the passphrase keyboard.
include_icon!(
    ICON_SPECIAL_CHARS_GROUP,
    "layout_quicksilver/res/special_chars_group.toif"
);
// Icon for "next keyboard layout" for special characters
include_icon!(ICON_ASTERISK, "layout_quicksilver/res/asterisk16.toif");

// Welcome screen.
include_icon!(ICON_LOGO, "layout_quicksilver/res/lock_full.toif");

// Homescreen notifications.
include_icon!(ICON_WARNING40, "layout_quicksilver/res/warning40.toif");

// Default homescreen
include_icon!(HOMESCREEN_ICON, "layout_quicksilver/res/hs_lock.toif");
