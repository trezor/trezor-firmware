...
pub enum TranslatedString {
    ...
    reset__slip39_checklist_num_shares_x_template = 913,  // {"Bolt": "Number of shares: {0}", "Caesar": "Number of shares: {0}", "Delizia": "Number of shares: {0}", "Eckhart": "Number of shares {0}"}
    reset__slip39_checklist_threshold_x_template = 914,  // {"Bolt": "Recovery threshold: {0}", "Caesar": "Recovery threshold: {0}", "Delizia": "Recovery threshold: {0}", "Eckhart": "Recovery threshold {0}"}
    ...
    reset__slip39_checklist_num_groups_x_template = 931,  // {"Bolt": "Number of groups: {0}", "Caesar": "Number of groups: {0}", "Delizia": "Number of groups: {0}", "Eckhart": "Number of groups {0}"}
