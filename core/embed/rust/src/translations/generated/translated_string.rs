...
pub enum TranslatedString {
    ...
    address__title_cosigner = 10,
    address__title_receive_address = 11,
    address__title_yours = 12,
    address_details__account = 13,
    address_details__derivation_path = 14,
    address_details__title_receive_address = 15,
    address_details__title_receiving_to = 16,
    authenticate__confirm_template = 17,
    authenticate__header = 18,
    auto_lock__change_template = 19,
    auto_lock__title = 20,
    backup__can_back_up_anytime = 21,
    backup__it_should_be_backed_up = 22,
    backup__it_should_be_backed_up_now = 23,
    backup__new_wallet_created = 24,
    backup__new_wallet_successfully_created = 25,
    backup__recover_anytime = 26,
    backup__title_backup_wallet = 27,
    backup__title_skip = 28,
    backup__want_to_skip = 29,
    binance__buy = 30,
    binance__confirm_cancel = 31,
    binance__confirm_input = 32,
    binance__confirm_order = 33,
    binance__confirm_output = 34,
    binance__order_id = 35,
    binance__pair = 36,
    binance__price = 37,
    binance__quantity = 38,
    binance__sell = 39,
    binance__sender_address = 40,
    binance__side = 41,
    binance__unknown = 42,
    bitcoin__commitment_data = 43,
    bitcoin__confirm_locktime = 44,
    bitcoin__create_proof_of_ownership = 45,
    bitcoin__high_mining_fee_template = 46,
    bitcoin__locktime_no_effect = 47,
    bitcoin__locktime_set_to = 48,
    bitcoin__locktime_set_to_blockheight = 49,
    bitcoin__lot_of_change_outputs = 50,
    bitcoin__multiple_accounts = 51,
    bitcoin__new_fee_rate = 52,
    bitcoin__simple_send_of = 53,
    bitcoin__ticket_amount = 54,
    bitcoin__title_confirm_details = 55,
    bitcoin__title_finalize_transaction = 56,
    bitcoin__title_high_mining_fee = 57,
    bitcoin__title_meld_transaction = 58,
    bitcoin__title_modify_amount = 59,
    bitcoin__title_payjoin = 60,
    bitcoin__title_proof_of_ownership = 61,
    bitcoin__title_purchase_ticket = 62,
    bitcoin__title_update_transaction = 63,
    bitcoin__unknown_path = 64,
    bitcoin__unknown_transaction = 65,
    bitcoin__unusually_high_fee = 66,
    bitcoin__unverified_external_inputs = 67,
    bitcoin__valid_signature = 68,
    bitcoin__voting_rights = 69,
    buttons__abort = 70,
    buttons__access = 71,
    buttons__again = 72,
    buttons__allow = 73,
    ...
    buttons__change = 76,
    buttons__check = 77,
    buttons__check_again = 78,
    buttons__close = 79,
    buttons__confirm = 80,
    buttons__continue = 81,
    buttons__details = 82,
    buttons__enable = 83,
    buttons__enter = 84,
    buttons__enter_share = 85,
    buttons__export = 86,
    buttons__format = 87,
    buttons__go_back = 88,
    buttons__hold_to_confirm = 89,
    buttons__info = 90,
    buttons__install = 91,
    buttons__more_info = 92,
    buttons__ok_i_understand = 93,
    buttons__purchase = 94,
    buttons__quit = 95,
    buttons__restart = 96,
    buttons__retry = 97,
    buttons__select = 98,
    buttons__set = 99,
    buttons__show_all = 100,
    buttons__show_words = 101,
    buttons__skip = 102,
    buttons__try_again = 103,
    buttons__turn_off = 104,
    buttons__turn_on = 105,
    cardano__addr_base = 106,
    cardano__addr_enterprise = 107,
    cardano__addr_legacy = 108,
    cardano__addr_pointer = 109,
    cardano__addr_reward = 110,
    cardano__address_no_staking = 111,
    cardano__amount = 112,
    cardano__amount_burned_decimals_unknown = 113,
    cardano__amount_minted_decimals_unknown = 114,
    cardano__amount_sent_decimals_unknown = 115,
    cardano__anonymous_pool = 116,
    cardano__asset_fingerprint = 117,
    cardano__auxiliary_data_hash = 118,
    cardano__block = 119,
    cardano__catalyst = 120,
    cardano__certificate = 121,
    cardano__certificate_path = 122,
    cardano__change_output = 123,
    cardano__change_output_path = 124,
    cardano__change_output_staking_path = 125,
    cardano__check_all_items = 126,
    cardano__choose_level_of_details = 127,
    cardano__collateral_input_id = 128,
    cardano__collateral_input_index = 129,
    cardano__collateral_output_contains_tokens = 130,
    cardano__collateral_return = 131,
    cardano__confirm = 132,
    cardano__confirm_signing_stake_pool = 133,
    cardano__confirm_transaction = 134,
    cardano__confirming_a_multisig_transaction = 135,
    cardano__confirming_pool_registration = 136,
    cardano__confirming_transction = 137,
    cardano__cost = 138,
    cardano__credential_mismatch = 139,
    cardano__datum_hash = 140,
    cardano__delegating_to = 141,
    cardano__for_account_and_index_template = 142,
    cardano__for_account_template = 143,
    cardano__for_key_hash = 144,
    cardano__for_script = 145,
    cardano__inline_datum = 146,
    cardano__input_id = 147,
    cardano__input_index = 148,
    cardano__intro_text_address = 149,
    cardano__intro_text_change = 150,
    cardano__intro_text_owned_by_device = 151,
    cardano__intro_text_registration_payment = 152,
    cardano__key_hash = 153,
    cardano__margin = 154,
    cardano__multisig_path = 155,
    cardano__nested_scripts_template = 156,
    cardano__network = 157,
    cardano__no_output_tx = 158,
    cardano__nonce = 159,
    cardano__other = 160,
    cardano__path = 161,
    cardano__pledge = 162,
    cardano__pointer = 163,
    cardano__policy_id = 164,
    cardano__pool_metadata_hash = 165,
    cardano__pool_metadata_url = 166,
    cardano__pool_owner = 167,
    cardano__pool_owner_path = 168,
    cardano__pool_reward_account = 169,
    cardano__reference_input_id = 170,
    cardano__reference_input_index = 171,
    cardano__reference_script = 172,
    cardano__required_signer = 173,
    cardano__reward = 174,
    cardano__reward_address = 175,
    cardano__reward_eligibility_warning = 176,
    cardano__rewards_go_to = 177,
    cardano__script = 178,
    cardano__script_all = 179,
    cardano__script_any = 180,
    cardano__script_data_hash = 181,
    cardano__script_hash = 182,
    cardano__script_invalid_before = 183,
    cardano__script_invalid_hereafter = 184,
    cardano__script_key = 185,
    cardano__script_n_of_k = 186,
    cardano__script_reward = 187,
    cardano__sending = 188,
    cardano__show_simple = 189,
    cardano__sign_tx_path_template = 190,
    cardano__stake_delegation = 191,
    cardano__stake_deregistration = 192,
    cardano__stake_pool_registration = 193,
    cardano__stake_pool_registration_pool_id = 194,
    cardano__stake_registration = 195,
    cardano__staking_key_for_account = 196,
    cardano__to_pool = 197,
    cardano__token_minting_path = 198,
    cardano__total_collateral = 199,
    cardano__transaction = 200,
    cardano__transaction_contains_minting_or_burning = 201,
    cardano__transaction_contains_script_address_no_datum = 202,
    cardano__transaction_fee = 203,
    cardano__transaction_id = 204,
    cardano__transaction_no_collateral_input = 205,
    cardano__transaction_no_script_data_hash = 206,
    cardano__transaction_output_contains_tokens = 207,
    cardano__ttl = 208,
    cardano__unknown = 209,
    cardano__unknown_collateral_amount = 210,
    cardano__unusual_path = 211,
    cardano__valid_since = 212,
    cardano__verify_script = 213,
    cardano__vote_key_registration = 214,
    cardano__vote_public_key = 215,
    cardano__voting_purpose = 216,
    cardano__warning = 217,
    cardano__weight = 218,
    cardano__withdrawal_for_address_template = 219,
    cardano__witness_path = 220,
    cardano__x_of_y_signatures_template = 221,
    coinjoin__access_account = 222,
    coinjoin__do_not_disconnect = 223,
    coinjoin__max_mining_fee = 224,
    coinjoin__max_rounds = 225,
    coinjoin__title = 226,
    coinjoin__title_do_not_disconnect = 227,
    coinjoin__title_progress = 228,
    coinjoin__waiting_for_others = 229,
    confirm_total__account = 230,
    confirm_total__fee_rate = 231,
    confirm_total__sending_from_account = 232,
    confirm_total__title_fee = 233,
    confirm_total__title_sending_from = 234,
    debug__loading_seed = 235,
    debug__loading_seed_not_recommended = 236,
    device_name__change_template = 237,
    device_name__title = 238,
    entropy__send = 239,
    entropy__title = 240,
    entropy__title_confirm = 241,
    eos__about_to_sign_template = 242,
    eos__account = 243,
    eos__action_name = 244,
    eos__amount = 245,
    eos__arbitrary_data = 246,
    eos__buy_ram = 247,
    eos__bytes = 248,
    eos__cancel_vote = 249,
    eos__checksum = 250,
    eos__code = 251,
    eos__contract = 252,
    eos__cpu = 253,
    eos__creator = 254,
    eos__delegate = 255,
    eos__delete_auth = 256,
    eos__from = 257,
    eos__link_auth = 258,
    eos__memo = 259,
    eos__name = 260,
    eos__net = 261,
    eos__new_account = 262,
    eos__no = 263,
    eos__owner = 264,
    eos__parent = 265,
    eos__payer = 266,
    ...
    eos__receiver = 269,
    eos__refund = 270,
    eos__requirement = 271,
    eos__sell_ram = 272,
    eos__sender = 273,
    eos__sign_transaction = 274,
    eos__threshold = 275,
    eos__to = 276,
    eos__transfer = 277,
    eos__type = 278,
    eos__undelegate = 279,
    eos__unlink_auth = 280,
    eos__update_auth = 281,
    eos__vote_for_producers = 282,
    eos__vote_for_proxy = 283,
    eos__voter = 284,
    eos__yes = 285,
    ethereum__amount_sent = 286,
    ethereum__confirm_fee = 287,
    ethereum__contract = 288,
    ethereum__data_size_template = 289,
    ethereum__gas_limit = 290,
    ethereum__gas_price = 291,
    ethereum__max_gas_price = 292,
    ethereum__name_and_version = 293,
    ethereum__new_contract = 294,
    ethereum__no_message_field = 295,
    ethereum__priority_fee = 296,
    ethereum__show_full_array = 297,
    ethereum__show_full_domain = 298,
    ethereum__show_full_message = 299,
    ethereum__show_full_struct = 300,
    ethereum__sign_eip712 = 301,
    ethereum__title_confirm_data = 302,
    ethereum__title_confirm_domain = 303,
    ethereum__title_confirm_message = 304,
    ethereum__title_confirm_struct = 305,
    ethereum__title_confirm_typed_data = 306,
    ethereum__title_signing_address = 307,
    ethereum__units_template = 308,
    ethereum__unknown_token = 309,
    ethereum__valid_signature = 310,
    experimental_mode__enable = 311,
    experimental_mode__only_for_dev = 312,
    experimental_mode__title = 313,
    fido__already_registered = 314,
    fido__device_already_registered = 315,
    fido__device_already_registered_with_template = 316,
    fido__device_not_registered = 317,
    fido__does_not_belong = 318,
    fido__erase_credentials = 319,
    fido__export_credentials = 320,
    fido__not_registered = 321,
    fido__not_registered_with_template = 322,
    fido__please_enable_pin_protection = 323,
    fido__title_authenticate = 324,
    fido__title_import_credential = 325,
    fido__title_list_credentials = 326,
    fido__title_register = 327,
    fido__title_remove_credential = 328,
    fido__title_reset = 329,
    fido__title_u2f_auth = 330,
    fido__title_u2f_register = 331,
    fido__title_verify_user = 332,
    fido__unable_to_verify_user = 333,
    fido__wanna_erase_credentials = 334,
    firmware_update__title = 335,
    firmware_update__title_fingerprint = 336,
    homescreen__click_to_connect = 337,
    homescreen__click_to_unlock = 338,
    homescreen__title_backup_failed = 339,
    homescreen__title_backup_needed = 340,
    homescreen__title_coinjoin_authorized = 341,
    homescreen__title_experimental_mode = 342,
    homescreen__title_hold_to_lock = 343,
    homescreen__title_no_usb_connection = 344,
    homescreen__title_pin_not_set = 345,
    homescreen__title_seedless = 346,
    homescreen__title_set = 347,
    inputs__back = 348,
    inputs__cancel = 349,
    inputs__delete = 350,
    inputs__enter = 351,
    ...
    inputs__space = 354,
    joint__title = 355,
    joint__to_the_total_amount = 356,
    joint__you_are_contributing = 357,
    language__change_template = 358,
    language__set_default = 359,
    language__title_change = 360,
    lockscreen__tap_to_connect = 361,
    lockscreen__tap_to_unlock = 362,
    lockscreen__title_locked = 363,
    lockscreen__title_not_connected = 364,
    misc__decrypt_value = 365,
    misc__encrypt_value = 366,
    misc__title_suite_labeling = 367,
    modify_amount__address = 368,
    modify_amount__decrease_amount = 369,
    modify_amount__increase_amount = 370,
    modify_amount__new_amount = 371,
    modify_amount__title = 372,
    modify_fee__decrease_fee = 373,
    modify_fee__fee_rate = 374,
    modify_fee__increase_fee = 375,
    modify_fee__new_transaction_fee = 376,
    modify_fee__no_change = 377,
    modify_fee__title = 378,
    modify_fee__transaction_fee = 379,
    monero__confirm_export = 380,
    monero__confirm_fee = 381,
    monero__confirm_ki_sync = 382,
    monero__confirm_refresh = 383,
    monero__confirm_unlock_time = 384,
    monero__hashing_inputs = 385,
    monero__payment_id = 386,
    monero__postprocessing = 387,
    monero__processing = 388,
    monero__processing_inputs = 389,
    monero__processing_outputs = 390,
    monero__signing = 391,
    monero__signing_inputs = 392,
    monero__unlock_time_set_template = 393,
    monero__wanna_export_tx_der = 394,
    monero__wanna_export_tx_key = 395,
    monero__wanna_export_watchkey = 396,
    monero__wanna_start_refresh = 397,
    monero__wanna_sync_key_images = 398,
    nem__absolute = 399,
    nem__activate = 400,
    nem__add = 401,
    nem__confirm_action = 402,
    nem__confirm_address = 403,
    nem__confirm_creation_fee = 404,
    nem__confirm_fee = 405,
    nem__confirm_mosaic = 406,
    nem__confirm_multisig_fee = 407,
    nem__confirm_namespace = 408,
    nem__confirm_payload = 409,
    nem__confirm_properties = 410,
    nem__confirm_rental_fee = 411,
    nem__confirm_transfer_of = 412,
    nem__convert_account_to_multisig = 413,
    nem__cosign_transaction_for = 414,
    nem__cosignatory = 415,
    nem__create_mosaic = 416,
    nem__create_namespace = 417,
    nem__deactivate = 418,
    nem__decrease = 419,
    nem__description = 420,
    nem__divisibility_and_levy_cannot_be_shown = 421,
    nem__encrypted = 422,
    nem__final_confirm = 423,
    nem__immutable = 424,
    nem__increase = 425,
    nem__initial_supply = 426,
    nem__initiate_transaction_for = 427,
    nem__levy_divisibility = 428,
    nem__levy_fee = 429,
    nem__levy_fee_of = 430,
    nem__levy_mosaic = 431,
    nem__levy_namespace = 432,
    nem__levy_recipient = 433,
    nem__levy_type = 434,
    nem__modify_supply_for = 435,
    nem__modify_the_number_of_cosignatories_by = 436,
    nem__mutable = 437,
    nem__no = 438,
    nem__of = 439,
    nem__percentile = 440,
    nem__raw_units_template = 441,
    nem__remote_harvesting = 442,
    nem__remove = 443,
    nem__set_minimum_cosignatories_to = 444,
    nem__sign_tx_fee_template = 445,
    nem__supply_change = 446,
    nem__supply_units_template = 447,
    nem__transferable = 448,
    nem__under_namespace = 449,
    nem__unencrypted = 450,
    nem__unknown_mosaic = 451,
    nem__yes = 452,
    passphrase__access_hidden_wallet = 453,
    passphrase__always_on_device = 454,
    passphrase__from_host_not_shown = 455,
    passphrase__hidden_wallet = 456,
    passphrase__hide = 457,
    passphrase__next_screen_will_show_passphrase = 458,
    passphrase__please_enter = 459,
    passphrase__revoke_on_device = 460,
    passphrase__title_confirm = 461,
    passphrase__title_enter = 462,
    passphrase__title_hide = 463,
    passphrase__title_settings = 464,
    passphrase__title_source = 465,
    passphrase__turn_off = 466,
    passphrase__turn_on = 467,
    pin__change = 468,
    pin__changed = 469,
    pin__cursor_will_change = 470,
    pin__diff_from_wipe_code = 471,
    pin__disabled = 472,
    pin__enabled = 473,
    pin__enter = 474,
    pin__enter_new = 475,
    pin__entered_not_valid = 476,
    pin__info = 477,
    pin__invalid_pin = 478,
    pin__last_attempt = 479,
    pin__mismatch = 480,
    pin__pin_mismatch = 481,
    pin__please_check_again = 482,
    pin__reenter_new = 483,
    pin__reenter_to_confirm = 484,
    pin__should_be_long = 485,
    pin__title_check_pin = 486,
    pin__title_settings = 487,
    pin__title_wrong_pin = 488,
    pin__tries_left = 489,
    pin__turn_off = 490,
    pin__turn_on = 491,
    pin__wrong_pin = 492,
    progress__authenticity_check = 493,
    progress__done = 494,
    progress__loading_transaction = 495,
    progress__one_second_left = 496,
    progress__please_wait = 497,
    progress__processing = 498,
    progress__refreshing = 499,
    progress__signing_transaction = 500,
    progress__syncing = 501,
    progress__x_seconds_left_template = 502,
    reboot_to_bootloader__restart = 503,
    reboot_to_bootloader__title = 504,
    reboot_to_bootloader__version_by_template = 505,
    recovery__cancel_dry_run = 506,
    recovery__check_dry_run = 507,
    recovery__cursor_will_change = 508,
    recovery__dry_run_bip39_valid_match = 509,
    recovery__dry_run_bip39_valid_mismatch = 510,
    recovery__dry_run_slip39_valid_match = 511,
    recovery__dry_run_slip39_valid_mismatch = 512,
    recovery__enter_any_share = 513,
    recovery__enter_backup = 514,
    recovery__enter_different_share = 515,
    recovery__enter_share_from_diff_group = 516,
    recovery__group_num_template = 517,
    recovery__group_threshold_reached = 518,
    recovery__invalid_seed_entered = 519,
    recovery__invalid_share_entered = 520,
    recovery__more_shares_needed = 521,
    recovery__num_of_words = 522,
    recovery__only_first_n_letters = 523,
    recovery__progress_will_be_lost = 524,
    recovery__select_num_of_words = 525,
    recovery__share_already_entered = 526,
    recovery__share_from_another_shamir = 527,
    recovery__share_num_template = 528,
    recovery__title = 529,
    recovery__title_cancel_dry_run = 530,
    recovery__title_cancel_recovery = 531,
    recovery__title_dry_run = 532,
    recovery__title_recover = 533,
    recovery__title_remaining_shares = 534,
    recovery__type_word_x_of_y_template = 535,
    recovery__wallet_recovered = 536,
    recovery__wanna_cancel_dry_run = 537,
    recovery__wanna_cancel_recovery = 538,
    recovery__word_count_template = 539,
    recovery__word_x_of_y_template = 540,
    recovery__x_of_y_entered_template = 541,
    recovery__you_have_entered = 542,
    reset__advanced_group_threshold_info = 543,
    reset__all_x_of_y_template = 544,
    reset__any_x_of_y_template = 545,
    reset__button_create = 546,
    reset__button_recover = 547,
    reset__by_continuing = 548,
    reset__check_backup_title = 549,
    reset__check_group_share_title_template = 550,
    reset__check_seed_title = 551,
    reset__check_share_title_template = 552,
    reset__continue_with_next_share = 553,
    reset__continue_with_share_template = 554,
    reset__finished_verifying_group_template = 555,
    reset__finished_verifying_seed = 556,
    reset__finished_verifying_shares = 557,
    reset__group_description = 558,
    reset__group_info = 559,
    reset__group_share_checked_successfully_template = 560,
    reset__group_share_title_template = 561,
    reset__more_info_at = 562,
    reset__need_all_share_template = 563,
    reset__need_any_share_template = 564,
    reset__needed_to_form_a_group = 565,
    reset__needed_to_recover_your_wallet = 566,
    reset__never_make_digital_copy = 567,
    reset__num_of_share_holders_template = 568,
    reset__num_of_shares_advanced_info_template = 569,
    reset__num_of_shares_basic_info = 570,
    reset__num_shares_for_group_template = 571,
    reset__number_of_shares_info = 572,
    reset__one_share = 573,
    reset__only_one_share_will_be_created = 574,
    reset__recovery_seed_title = 575,
    reset__recovery_share_title_template = 576,
    reset__required_number_of_groups = 577,
    reset__select_correct_word = 578,
    reset__select_word_template = 579,
    reset__select_word_x_of_y_template = 580,
    reset__set_it_to_count_template = 581,
    reset__share_checked_successfully_template = 582,
    reset__share_words_title = 583,
    reset__slip39_checklist_num_groups = 584,
    reset__slip39_checklist_num_shares = 585,
    reset__slip39_checklist_set_num_groups = 586,
    reset__slip39_checklist_set_num_shares = 587,
    reset__slip39_checklist_set_sizes = 588,
    reset__slip39_checklist_set_sizes_longer = 589,
    reset__slip39_checklist_set_threshold = 590,
    reset__slip39_checklist_title = 591,
    reset__slip39_checklist_write_down = 592,
    reset__slip39_checklist_write_down_recovery = 593,
    reset__the_threshold_sets_the_number_of_shares = 594,
    reset__threshold_info = 595,
    reset__title_backup_is_done = 596,
    reset__title_create_wallet = 597,
    reset__title_create_wallet_shamir = 598,
    reset__title_group_threshold = 599,
    reset__title_number_of_groups = 600,
    reset__title_number_of_shares = 601,
    reset__title_set_group_threshold = 602,
    reset__title_set_number_of_groups = 603,
    reset__title_set_number_of_shares = 604,
    reset__title_set_threshold = 605,
    reset__to_form_group_template = 606,
    reset__tos_link = 607,
    reset__total_number_of_shares_in_group_template = 608,
    reset__use_your_backup = 609,
    reset__write_down_words_template = 610,
    reset__wrong_word_selected = 611,
    reset__you_need_one_share = 612,
    reset__your_backup_is_done = 613,
    ripple__confirm_tag = 614,
    ripple__destination_tag_template = 615,
    rotation__change_template = 616,
    rotation__east = 617,
    rotation__north = 618,
    rotation__south = 619,
    rotation__title_change = 620,
    rotation__west = 621,
    safety_checks__approve_unsafe_always = 622,
    safety_checks__approve_unsafe_temporary = 623,
    safety_checks__enforce_strict = 624,
    safety_checks__title = 625,
    safety_checks__title_safety_override = 626,
    sd_card__all_data_will_be_lost = 627,
    sd_card__card_required = 628,
    sd_card__disable = 629,
    sd_card__disabled = 630,
    sd_card__enable = 631,
    sd_card__enabled = 632,
    sd_card__error = 633,
    sd_card__format_card = 634,
    sd_card__insert_correct_card = 635,
    sd_card__please_insert = 636,
    sd_card__please_unplug_and_insert = 637,
    sd_card__problem_accessing = 638,
    sd_card__refresh = 639,
    sd_card__refreshed = 640,
    sd_card__restart = 641,
    sd_card__title = 642,
    sd_card__title_problem = 643,
    sd_card__unknown_filesystem = 644,
    sd_card__unplug_and_insert_correct = 645,
    sd_card__use_different_card = 646,
    sd_card__wanna_format = 647,
    sd_card__wrong_sd_card = 648,
    send__address_path = 649,
    send__amount = 650,
    send__confirm_sending = 651,
    send__from_multiple_accounts = 652,
    send__including_fee = 653,
    send__maximum_fee = 654,
    send__receiving_to_multisig = 655,
    send__title_amount = 656,
    send__title_confirm_sending = 657,
    send__title_joint_transaction = 658,
    send__title_receiving_to = 659,
    send__title_recipient = 660,
    send__title_sending = 661,
    send__title_sending_amount = 662,
    send__title_sending_to = 663,
    send__to_the_total_amount = 664,
    send__total_amount = 665,
    send__transaction_id = 666,
    send__you_are_contributing = 667,
    share_words__words_in_order = 668,
    share_words__wrote_down_all = 669,
    sign_message__bytes_template = 670,
    sign_message__confirm_address = 671,
    sign_message__confirm_message = 672,
    sign_message__message_size = 673,
    sign_message__verify_address = 674,
    stellar__account = 675,
    ...
    stellar__asset = 682,
    stellar__bump_sequence = 683,
    stellar__buying = 684,
    stellar__clear_data = 685,
    stellar__clear_flags = 686,
    stellar__confirm_issuer = 687,
    stellar__confirm_memo = 688,
    stellar__confirm_network = 689,
    stellar__confirm_operation = 690,
    stellar__confirm_stellar = 691,
    stellar__confirm_timebounds = 692,
    stellar__create_account = 693,
    stellar__debited_amount = 694,
    stellar__delete = 695,
    stellar__delete_passive_offer = 696,
    stellar__delete_trust = 697,
    stellar__destination = 698,
    stellar__exchanges_require_memo = 699,
    stellar__final_confirm = 700,
    stellar__hash = 701,
    stellar__high = 702,
    stellar__home_domain = 703,
    stellar__inflation = 704,
    stellar__initial_balance = 705,
    stellar__initialize_signing_with = 706,
    stellar__issuer_template = 707,
    stellar__key = 708,
    stellar__limit = 709,
    stellar__low = 710,
    stellar__master_weight = 711,
    stellar__medium = 712,
    stellar__new_offer = 713,
    stellar__new_passive_offer = 714,
    stellar__no_memo_set = 715,
    stellar__no_restriction = 716,
    stellar__on_network_template = 717,
    stellar__path_pay = 718,
    stellar__path_pay_at_least = 719,
    stellar__pay = 720,
    stellar__pay_at_most = 721,
    stellar__preauth_transaction = 722,
    stellar__price_per_template = 723,
    stellar__private_network = 724,
    stellar__remove_signer = 725,
    stellar__revoke_trust = 726,
    stellar__selling = 727,
    stellar__set_data = 728,
    stellar__set_flags = 729,
    stellar__set_sequence_to_template = 730,
    stellar__sign_tx_count_template = 731,
    stellar__sign_tx_fee_template = 732,
    stellar__source_account = 733,
    stellar__testnet_network = 734,
    stellar__trusted_account = 735,
    stellar__update = 736,
    stellar__valid_from = 737,
    stellar__valid_to = 738,
    stellar__value_sha256 = 739,
    stellar__wanna_clean_value_key_template = 740,
    stellar__your_account = 741,
    tezos__address = 742,
    tezos__amount = 743,
    ...
    tezos__fee = 750,
    tezos__proposal = 751,
    tezos__register_delegate = 752,
    tezos__remove_delegation = 753,
    tezos__submit_ballot = 754,
    tezos__submit_proposal = 755,
    tezos__submit_proposals = 756,
    tutorial__middle_click = 757,
    tutorial__press_and_hold = 758,
    tutorial__ready_to_use = 759,
    tutorial__scroll_down = 760,
    tutorial__sure_you_want_skip = 761,
    tutorial__title_hello = 762,
    tutorial__title_screen_scroll = 763,
    tutorial__title_skip = 764,
    tutorial__title_tutorial_complete = 765,
    tutorial__use_trezor = 766,
    tutorial__welcome_press_right = 767,
    u2f__get = 768,
    ...
    wipe__info = 772,
    wipe__title = 773,
    wipe__want_to_wipe = 774,
    wipe_code__change = 775,
    wipe_code__changed = 776,
    wipe_code__diff_from_pin = 777,
    wipe_code__disabled = 778,
    wipe_code__enabled = 779,
    wipe_code__enter_new = 780,
    wipe_code__info = 781,
    wipe_code__invalid = 782,
    wipe_code__mismatch = 783,
    wipe_code__reenter = 784,
    wipe_code__reenter_to_confirm = 785,
    wipe_code__title_check = 786,
    wipe_code__title_invalid = 787,
    wipe_code__title_settings = 788,
    wipe_code__turn_off = 789,
    wipe_code__turn_on = 790,
    wipe_code__wipe_code_mismatch = 791,
    word_count__title = 792,
    words__are_you_sure = 793,
    words__buying = 794,
    words__continue_anyway = 795,
    words__continue_with = 796,
    words__error = 797,
    words__from = 798,
    words__keep_it_safe = 799,
    words__know_what_your_doing = 800,
    words__my_trezor = 801,
    words__outputs = 802,
    words__please_check_again = 803,
    words__please_try_again = 804,
    words__really_wanna = 805,
    words__sign = 806,
    words__title_check = 807,
    words__title_group = 808,
    words__title_information = 809,
    words__title_remember = 810,
    words__title_share = 811,
    words__title_shares = 812,
    words__title_success = 813,
    words__title_summary = 814,
    words__title_threshold = 815,
    words__unknown = 816,
    words__warning = 817,
    plurals__sign_x_actions = 818,
    plurals__contains_x_keys = 819,
    words__contains = 820,
    plurals__x_shares_needed = 821,
    words__array_of = 822,
    recovery__x_more_shares_needed_template_plural = 823,
    plurals__transaction_of_x_operations = 824,
    plurals__x_groups_needed = 825,
    recovery__x_more_items_starting_template_plural = 826,
    plurals__lock_after_x_hours = 827,
    plurals__lock_after_x_milliseconds = 828,
    plurals__lock_after_x_minutes = 829,
    plurals__lock_after_x_seconds = 830,
    words__confirm = 831,
    buttons__back = 832,
    buttons__show_details = 833,
    solana__account_index = 834,
    solana__associated_token_account = 835,
    solana__confirm_multisig = 836,
    solana__expected_fee = 837,
    solana__instruction_accounts_template = 838,
    solana__instruction_data = 839,
    solana__instruction_is_multisig = 840,
    solana__is_provided_via_lookup_table_template = 841,
    solana__lookup_table_address = 842,
    solana__multiple_signers = 843,
    solana__token_address = 844,
    solana__transaction_contains_unknown_instructions = 845,
    solana__transaction_requires_x_signers_template = 846,
    stellar__balance_id = 847,
    stellar__claim_claimable_balance = 848,
    words__account = 849,
    words__blockhash = 850,
    words__fee = 851,
    words__recipient = 852,
    words__signer = 853,
    words__writable = 854,
    words__amount = 855,
    words__address = 856,
...
impl TranslatedString {
    pub fn untranslated(self) -> &'static str {
        match self {
            ...
            Self::homescreen__title_hold_to_lock => "HOLD TO LOCK",
    ...
    pub fn from_qstr(qstr: Qstr) -> Option<Self> {
        match qstr {
            ...
            Qstr::MP_QSTR_address_details__account => Some(Self::address_details__account),
            ...
            Qstr::MP_QSTR_binance__unknown => Some(Self::binance__unknown),
            ...
            Qstr::MP_QSTR_cardano__amount => Some(Self::cardano__amount),
            ...
            Qstr::MP_QSTR_cardano__certificate_path => Some(Self::cardano__certificate_path),
            Qstr::MP_QSTR_cardano__change_output => Some(Self::cardano__change_output),
            Qstr::MP_QSTR_cardano__change_output_path => Some(Self::cardano__change_output_path),
            Qstr::MP_QSTR_cardano__change_output_staking_path => Some(Self::cardano__change_output_staking_path),
            ...
            Qstr::MP_QSTR_cardano__intro_text_address => Some(Self::cardano__intro_text_address),
            ...
            Qstr::MP_QSTR_cardano__pool_owner_path => Some(Self::cardano__pool_owner_path),
            ...
            Qstr::MP_QSTR_cardano__unknown => Some(Self::cardano__unknown),
            ...
            Qstr::MP_QSTR_cardano__witness_path => Some(Self::cardano__witness_path),
            ...
            Qstr::MP_QSTR_confirm_total__account => Some(Self::confirm_total__account),
            ...
            Qstr::MP_QSTR_eos__account => Some(Self::eos__account),
            Qstr::MP_QSTR_eos__action_name => Some(Self::eos__action_name),
            Qstr::MP_QSTR_eos__amount => Some(Self::eos__amount),
            ...
            Qstr::MP_QSTR_eos__no => Some(Self::eos__no),
            ...
            Qstr::MP_QSTR_eos__yes => Some(Self::eos__yes),
            Qstr::MP_QSTR_ethereum__amount_sent => Some(Self::ethereum__amount_sent),
            Qstr::MP_QSTR_ethereum__confirm_fee => Some(Self::ethereum__confirm_fee),
            ...
            Qstr::MP_QSTR_homescreen__title_hold_to_lock => Some(Self::homescreen__title_hold_to_lock),
            ...
            Qstr::MP_QSTR_language__change_template => Some(Self::language__change_template),
            Qstr::MP_QSTR_language__set_default => Some(Self::language__set_default),
            Qstr::MP_QSTR_language__title_change => Some(Self::language__title_change),
            ...
            Qstr::MP_QSTR_modify_amount__address => Some(Self::modify_amount__address),
            ...
            Qstr::MP_QSTR_monero__confirm_fee => Some(Self::monero__confirm_fee),
            ...
            Qstr::MP_QSTR_nem__confirm_fee => Some(Self::nem__confirm_fee),
            ...
            Qstr::MP_QSTR_nem__no => Some(Self::nem__no),
            ...
            Qstr::MP_QSTR_nem__yes => Some(Self::nem__yes),
            ...
            Qstr::MP_QSTR_send__amount => Some(Self::send__amount),
            ...
            Qstr::MP_QSTR_send__title_amount => Some(Self::send__title_amount),
            ...
            Qstr::MP_QSTR_send__title_recipient => Some(Self::send__title_recipient),
            ...
            Qstr::MP_QSTR_stellar__account => Some(Self::stellar__account),
            ...
            Qstr::MP_QSTR_tezos__address => Some(Self::tezos__address),
            Qstr::MP_QSTR_tezos__amount => Some(Self::tezos__amount),
            ...
            Qstr::MP_QSTR_tezos__fee => Some(Self::tezos__fee),
