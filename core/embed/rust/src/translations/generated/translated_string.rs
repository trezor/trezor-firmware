...
pub enum TranslatedString {
    ...
    tutorial__title_hold = 947,  // "Hold the button to confirm important actions"
    ...
    buttons__finish = 1056,  // "Finish"
    instructions__menu_to_continue = 1057,  // "Use menu to continue"
    tutorial__last_one = 1058,  // "Last one"
    tutorial__menu_appendix = 1059,  // "View more info, quit flow, ..."
    tutorial__navigation_ts7 = 1060,  // "Use buttons at the bottom to navigate and confirm your actions."
    tutorial__suite_restart = 1061,  // "Replay this tutorial anytime from the Trezor Suite app."
    tutorial__tropic = 1062,  // "Secured with TROPIC01"
    tutorial__tropic_info1 = 1063,  // "TROPIC01 is a next-gen secure element with tamper-proof protection and open architecture."
    tutorial__tropic_info2 = 1064,  // "Private keys stay on-chip, safeguarded by hardware-enforced boundaries and anti-tamper tech."
    tutorial__tropic_info3 = 1065,  // "Built for security from the ground up, and open to independent audits."
    tutorial__welcome_safe7 = 1066,  // "Welcome to\nTrezor\nSafe 7"
    tutorial__what_is_tropic = 1067,  // "What is TROPIC01?"
}
