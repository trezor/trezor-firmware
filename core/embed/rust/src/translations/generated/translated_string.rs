        ...
        impl TranslatedString {
            const BTC_ONLY_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::instructions__shares_start_with_x_template, 13901),
                    (Self::reset__check_share_backup_template, 13938),
                    (Self::reset__select_word_from_share_template, 13970),
                    (Self::recovery__share_from_group_entered_template, 14005),
                    (Self::send__cancel_transaction, 14023),
                    (Self::send__multisig_different_paths, 14065),
                    (Self::address__xpub, 14069),
                    (Self::words__cancel_question, 14076),
                    (Self::address__coin_address_template, 14087),
                    (Self::buttons__view, 14091),
                ],
            };
            ...
            const ALTCOIN_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::ethereum__title_all_input_data_template, 7571),
                    (Self::ethereum__contract_address, 7596),
                ],
            };
        ...
        impl TranslatedString {
            const BTC_ONLY_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::instructions__shares_start_with_x_template, 13906),
                    (Self::reset__check_share_backup_template, 13943),
                    (Self::reset__select_word_from_share_template, 13975),
                    (Self::recovery__share_from_group_entered_template, 14010),
                    (Self::send__cancel_transaction, 14028),
                    (Self::send__multisig_different_paths, 14070),
                    (Self::address__xpub, 14074),
                    (Self::words__cancel_question, 14081),
                    (Self::address__coin_address_template, 14092),
                    (Self::buttons__view, 14096),
                ],
            };
        ...
        impl TranslatedString {
            const BTC_ONLY_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::instructions__shares_start_with_x_template, 13998),
                    (Self::reset__check_share_backup_template, 14035),
                    (Self::reset__select_word_from_share_template, 14067),
                    (Self::recovery__share_from_group_entered_template, 14102),
                    (Self::send__cancel_transaction, 14120),
                    (Self::send__multisig_different_paths, 14162),
                    (Self::address__xpub, 14179),
                    (Self::words__cancel_question, 14186),
                    (Self::address__coin_address_template, 14197),
                    (Self::buttons__view, 14201),
                ],
            };
            ...
            const ALTCOIN_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::ethereum__title_all_input_data_template, 7613),
                    (Self::ethereum__contract_address, 7638),
                ],
            };
