...
pub enum TranslatedString {
    ...
    instructions__shares_start_with_x_template = 1038,  // "Start with Share #{0}"
    reset__check_share_backup_template = 1039,  // "Let's do a quick check of Share #{0}."
    reset__select_word_from_share_template = 1040,  // "Select word #{0} from\nShare #{1}"
}
