...
pub enum TranslatedString {
    ...
    send__sign_cancelled = 1001,  // "Sign cancelled."
    words__send = 1002,  // "Send"
    send__send_int_the_app = 1003,  // "After signing, send the transaction in the app."
...
impl TranslatedString {
    ...
    pub fn untranslated(self) -> &'static str {
        match self {
            ...
            Self::send__send_int_the_app => "After signing, send the transaction in the app.",
    ...
    pub fn from_qstr(qstr: Qstr) -> Option<Self> {
        match qstr {
            ...
            Qstr::MP_QSTR_send__send_int_the_app => Some(Self::send__send_int_the_app),
