        ...
        impl TranslatedString {
            const BTC_ONLY_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::pin__info, 3243),
                    (Self::pin__invalid_pin, 3254),
                    (Self::pin__last_attempt, 3266),
                    (Self::pin__mismatch, 3292),
                    (Self::pin__pin_mismatch, 3304),
                    (Self::pin__please_check_again, 3323),
                    (Self::pin__reenter_new, 3339),
                    (Self::pin__reenter_to_confirm, 3370),
                    (Self::pin__should_be_long, 3401),
                    (Self::pin__title_check_pin, 3410),
                    (Self::pin__title_settings, 3422),
                    (Self::pin__title_wrong_pin, 3431),
                    (Self::pin__tries_left, 3441),
                    (Self::pin__turn_off, 3490),
                    (Self::pin__turn_on, 3513),
                    (Self::pin__wrong_pin, 3522),
                    (Self::plurals__contains_x_keys, 3530),
                    (Self::plurals__lock_after_x_hours, 3540),
                    (Self::plurals__lock_after_x_milliseconds, 3564),
                    (Self::plurals__lock_after_x_minutes, 3578),
                    (Self::plurals__lock_after_x_seconds, 3592),
                    (Self::plurals__sign_x_actions, 3606),
                    (Self::plurals__transaction_of_x_operations, 3626),
                    (Self::plurals__x_groups_needed, 3638),
                    (Self::plurals__x_shares_needed, 3650),
                    (Self::progress__authenticity_check, 3674),
                    (Self::progress__done, 3678),
                    (Self::progress__loading_transaction, 3700),
                    (Self::progress__locking_device, 3721),
                    (Self::progress__one_second_left, 3734),
                    (Self::progress__please_wait, 3745),
                    (Self::storage_msg__processing, 3755),
                    (Self::progress__refreshing, 3768),
                    (Self::progress__signing_transaction, 3790),
                    (Self::progress__syncing, 3800),
                    (Self::progress__x_seconds_left_template, 3816),
                    (Self::reboot_to_bootloader__restart, 3855),
                    (Self::reboot_to_bootloader__title, 3871),
                    (Self::reboot_to_bootloader__version_by_template, 3898),
                    (Self::recovery__cancel_dry_run, 3917),
                    (Self::recovery__check_dry_run, 3935),
                    (Self::recovery__cursor_will_change, 4008),
                    (Self::recovery__dry_run_bip39_valid_match, 4078),
                    (Self::recovery__dry_run_bip39_valid_mismatch, 4154),
                    (Self::recovery__dry_run_slip39_valid_match, 4234),
                    (Self::recovery__dry_run_slip39_valid_mismatch, 4321),
                    (Self::recovery__enter_any_share, 4336),
                    (Self::recovery__enter_backup, 4354),
                    (Self::recovery__enter_different_share, 4378),
                    (Self::recovery__enter_share_from_diff_group, 4413),
                    (Self::recovery__group_num_template, 4422),
                    (Self::recovery__group_threshold_reached, 4446),
                    (Self::recovery__invalid_wallet_backup_entered, 4476),
                    (Self::recovery__invalid_share_entered, 4507),
                    (Self::recovery__more_shares_needed, 4525),
                    (Self::recovery__num_of_words, 4567),
                    (Self::recovery__only_first_n_letters, 4629),
                    (Self::recovery__progress_will_be_lost, 4655),
                    (Self::recovery__share_already_entered, 4676),
                    (Self::recovery__share_from_another_multi_share_backup, 4725),
                    (Self::recovery__share_num_template, 4734),
                    (Self::recovery__title, 4748),
                    (Self::recovery__title_cancel_dry_run, 4767),
                    (Self::recovery__title_cancel_recovery, 4782),
                    (Self::recovery__title_dry_run, 4794),
                    (Self::recovery__title_recover, 4808),
                    (Self::recovery__title_remaining_shares, 4824),
                    (Self::recovery__type_word_x_of_y_template, 4844),
                    (Self::recovery__wallet_recovered, 4870),
                    (Self::recovery__wanna_cancel_dry_run, 4919),
                    (Self::recovery__wanna_cancel_recovery, 4972),
                    (Self::recovery__word_count_template, 4983),
                    (Self::recovery__word_x_of_y_template, 4998),
                    (Self::recovery__x_more_items_starting_template_plural, 5028),
                    (Self::recovery__x_more_shares_needed_template_plural, 5056),
                    (Self::recovery__x_of_y_entered_template, 5082),
                    (Self::recovery__you_have_entered, 5098),
                    (Self::reset__advanced_group_threshold_info, 5181),
                    (Self::reset__all_x_of_y_template, 5202),
                    (Self::reset__any_x_of_y_template, 5223),
                    (Self::reset__button_create, 5236),
                    (Self::reset__button_recover, 5250),
                    (Self::reset__by_continuing, 5308),
                    (Self::reset__check_backup_title, 5320),
                    (Self::reset__check_group_share_title_template, 5342),
                    (Self::reset__check_wallet_backup_title, 5361),
                    (Self::reset__check_share_title_template, 5377),
                    (Self::reset__continue_with_next_share, 5406),
                    (Self::reset__continue_with_share_template, 5431),
                    (Self::reset__finished_verifying_group_template, 5494),
                    (Self::reset__finished_verifying_wallet_backup, 5541),
                    (Self::reset__finished_verifying_shares, 5590),
                    (Self::reset__group_description, 5628),
                    (Self::reset__group_info, 5761),
                    (Self::reset__group_share_checked_successfully_template, 5804),
                    (Self::reset__group_share_title_template, 5825),
                    (Self::reset__more_info_at, 5837),
                    (Self::reset__need_all_share_template, 5881),
                    (Self::reset__need_any_share_template, 5925),
                    (Self::reset__needed_to_form_a_group, 5949),
                    (Self::reset__needed_to_recover_your_wallet, 5980),
                    (Self::reset__never_make_digital_copy, 6019),
                    (Self::reset__num_of_share_holders_template, 6068),
                    (Self::reset__num_of_shares_advanced_info_template, 6193),
                    (Self::reset__num_of_shares_basic_info_template, 6310),
                    (Self::reset__num_shares_for_group_template, 6358),
                    (Self::reset__number_of_shares_info, 6417),
                    (Self::reset__one_share, 6424),
                    (Self::reset__only_one_share_will_be_created, 6455),
                    (Self::reset__recovery_wallet_backup_title, 6468),
                    (Self::reset__recovery_share_title_template, 6487),
                    (Self::reset__required_number_of_groups, 6530),
                    (Self::reset__select_correct_word, 6572),
                    (Self::reset__select_word_template, 6612),
                    (Self::reset__select_word_x_of_y_template, 6635),
                    (Self::reset__set_it_to_count_template, 6667),
                    (Self::reset__share_checked_successfully_template, 6699),
                    (Self::reset__share_words_title, 6714),
                    (Self::reset__slip39_checklist_num_groups, 6730),
                    (Self::reset__slip39_checklist_num_shares, 6746),
                    (Self::reset__slip39_checklist_set_num_groups, 6766),
                    (Self::reset__slip39_checklist_set_num_shares, 6786),
                    (Self::reset__slip39_checklist_set_sizes, 6810),
                    (Self::reset__slip39_checklist_set_sizes_longer, 6847),
                    (Self::reset__slip39_checklist_set_threshold, 6869),
                    (Self::reset__slip39_checklist_title, 6885),
                    (Self::reset__slip39_checklist_write_down, 6916),
                    (Self::reset__slip39_checklist_write_down_recovery, 6959),
                    (Self::reset__the_threshold_sets_the_number_of_shares, 6999),
                    (Self::reset__threshold_info, 7055),
                    (Self::reset__title_backup_is_done, 7069),
                    (Self::reset__title_create_wallet, 7082),
                    (Self::reset__title_group_threshold, 7097),
                    (Self::reset__title_number_of_groups, 7113),
                    (Self::reset__title_number_of_shares, 7129),
                    (Self::reset__title_set_group_threshold, 7148),
                    (Self::reset__title_set_number_of_groups, 7168),
                    (Self::reset__title_set_number_of_shares, 7188),
                    (Self::reset__title_set_threshold, 7201),
                    (Self::reset__to_form_group_template, 7219),
                    (Self::reset__tos_link, 7240),
                    (Self::reset__total_number_of_shares_in_group_template, 7284),
                    (Self::reset__use_your_backup, 7337),
                    (Self::reset__write_down_words_template, 7403),
                    (Self::reset__wrong_word_selected, 7423),
                    (Self::reset__you_need_one_share, 7453),
                    (Self::reset__your_backup_is_done, 7473),
                    (Self::rotation__change_template, 7507),
                    (Self::rotation__east, 7511),
                    (Self::rotation__north, 7516),
                    (Self::rotation__south, 7521),
                    (Self::rotation__title_change, 7540),
                    (Self::rotation__west, 7544),
                    (Self::safety_checks__approve_unsafe_always, 7612),
                    (Self::safety_checks__approve_unsafe_temporary, 7692),
                    (Self::safety_checks__enforce_strict, 7757),
                    (Self::safety_checks__title, 7770),
                    (Self::safety_checks__title_safety_override, 7785),
                    (Self::sd_card__all_data_will_be_lost, 7822),
                    (Self::sd_card__card_required, 7839),
                    (Self::sd_card__disable, 7904),
                    (Self::sd_card__disabled, 7949),
                    (Self::sd_card__enable, 8014),
                    (Self::sd_card__enabled, 8058),
                    (Self::sd_card__error, 8071),
                    (Self::sd_card__format_card, 8085),
                    (Self::sd_card__insert_correct_card, 8135),
                    (Self::sd_card__please_insert, 8162),
                    (Self::sd_card__please_unplug_and_insert, 8211),
                    (Self::sd_card__problem_accessing, 8253),
                    (Self::sd_card__refresh, 8337),
                    (Self::sd_card__refreshed, 8383),
                    (Self::sd_card__restart, 8432),
                    (Self::sd_card__title, 8450),
                    (Self::sd_card__title_problem, 8465),
                    (Self::sd_card__unknown_filesystem, 8484),
                    (Self::sd_card__unplug_and_insert_correct, 8540),
                    (Self::sd_card__use_different_card, 8607),
                    (Self::sd_card__wanna_format, 8648),
                    (Self::sd_card__wrong_sd_card, 8662),
                    (Self::send__confirm_sending, 8676),
                    (Self::send__from_multiple_accounts, 8707),
                    (Self::send__including_fee, 8721),
                    (Self::send__maximum_fee, 8732),
                    (Self::send__receiving_to_multisig, 8764),
                    (Self::send__title_confirm_sending, 8779),
                    (Self::send__title_joint_transaction, 8796),
                    (Self::send__title_receiving_to, 8808),
                    (Self::send__title_sending, 8815),
                    (Self::send__title_sending_amount, 8829),
                    (Self::send__title_sending_to, 8839),
                    (Self::send__to_the_total_amount, 8859),
                    (Self::send__transaction_id, 8873),
                    (Self::send__you_are_contributing, 8894),
                    (Self::share_words__words_in_order, 8910),
                    (Self::share_words__wrote_down_all, 8927),
                    (Self::sign_message__bytes_template, 8936),
                    (Self::sign_message__confirm_address, 8951),
                    (Self::sign_message__confirm_message, 8966),
                    (Self::sign_message__message_size, 8978),
                    (Self::sign_message__verify_address, 8992),
                    (Self::tutorial__middle_click, 9046),
                    (Self::tutorial__press_and_hold, 9110),
                    (Self::tutorial__ready_to_use, 9137),
                    (Self::tutorial__scroll_down, 9246),
                    (Self::tutorial__sure_you_want_skip, 9289),
                    (Self::tutorial__title_hello, 9294),
                    (Self::tutorial__title_screen_scroll, 9307),
                    (Self::tutorial__title_skip, 9320),
                    (Self::tutorial__title_tutorial_complete, 9337),
                    (Self::tutorial__use_trezor, 9404),
                    (Self::tutorial__welcome_press_right, 9447),
                    (Self::wipe__info, 9471),
                    (Self::wipe__title, 9482),
                    (Self::wipe__want_to_wipe, 9521),
                    (Self::wipe_code__change, 9538),
                    (Self::wipe_code__changed, 9556),
                    (Self::wipe_code__diff_from_pin, 9602),
                    (Self::wipe_code__disabled, 9621),
                    (Self::wipe_code__enabled, 9639),
                    (Self::wipe_code__enter_new, 9652),
                    (Self::wipe_code__info, 9709),
                    (Self::wipe_code__invalid, 9726),
                    (Self::wipe_code__mismatch, 9766),
                    (Self::wipe_code__reenter, 9784),
                    (Self::wipe_code__reenter_to_confirm, 9821),
                    (Self::wipe_code__title_check, 9836),
                    (Self::wipe_code__title_invalid, 9853),
                    (Self::wipe_code__title_settings, 9871),
                    (Self::wipe_code__turn_off, 9901),
                    (Self::wipe_code__turn_on, 9930),
                    (Self::wipe_code__wipe_code_mismatch, 9948),
                    (Self::word_count__title, 9963),
                    (Self::words__account, 9970),
                    (Self::words__account_colon, 9978),
                    (Self::words__address, 9985),
                    (Self::words__amount, 9991),
                    (Self::words__are_you_sure, 10004),
                    (Self::words__array_of, 10012),
                    (Self::words__blockhash, 10021),
                    (Self::words__buying, 10027),
                    (Self::words__confirm, 10034),
                    (Self::words__confirm_fee, 10045),
                    (Self::words__contains, 10053),
                    (Self::words__continue_anyway_question, 10069),
                    (Self::words__continue_with, 10082),
                    (Self::words__error, 10087),
                    (Self::words__fee, 10090),
                    (Self::words__from, 10094),
                    (Self::words__keep_it_safe, 10107),
                    (Self::words__know_what_your_doing, 10152),
                    (Self::words__my_trezor, 10161),
                    (Self::words__no, 10163),
                    (Self::words__outputs, 10170),
                    (Self::words__please_check_again, 10188),
                    (Self::words__please_try_again, 10204),
                    (Self::words__really_wanna, 10225),
                    (Self::words__recipient, 10234),
                    (Self::words__sign, 10238),
                    (Self::words__signer, 10244),
                    (Self::words__title_check, 10249),
                    (Self::words__title_group, 10254),
                    (Self::words__title_information, 10265),
                    (Self::words__title_remember, 10273),
                    (Self::words__title_share, 10278),
                    (Self::words__title_shares, 10284),
                    (Self::words__title_success, 10291),
                    (Self::words__title_summary, 10298),
                    (Self::words__title_threshold, 10307),
                    (Self::words__unknown, 10314),
                    (Self::words__warning, 10321),
                    (Self::words__writable, 10329),
                    (Self::words__yes, 10332),
                    (Self::reboot_to_bootloader__just_a_moment, 10348),
                    (Self::inputs__previous, 10356),
                    (Self::storage_msg__starting, 10367),
                    (Self::storage_msg__verifying_pin, 10380),
                    (Self::storage_msg__wrong_pin, 10389),
                    (Self::reset__create_x_of_y_multi_share_backup_template, 10443),
                    (Self::reset__title_shamir_backup, 10461),
                    (Self::instructions__tap_to_confirm, 10475),
                    (Self::instructions__hold_to_confirm, 10490),
                    (Self::words__important, 10499),
                    (Self::reset__words_written_down_template, 10535),
                    (Self::backup__create_backup_to_prevent_loss, 10595),
                    (Self::reset__check_backup_instructions, 10633),
                    (Self::words__instructions, 10645),
                    (Self::words__not_recommended, 10661),
                    (Self::address_details__account_info, 10673),
                    (Self::address__cancel_contact_support, 10751),
                    (Self::address__cancel_receive, 10766),
                    (Self::address__qr_code, 10773),
                    (Self::address_details__derivation_path, 10788),
                    (Self::instructions__continue_in_app, 10807),
                    (Self::words__cancel_and_exit, 10822),
                    (Self::address__confirmed, 10847),
                    (Self::pin__cancel_description, 10867),
                    (Self::pin__cancel_info, 10912),
                    (Self::pin__cancel_setup, 10928),
                    (Self::send__cancel_sign, 10939),
                    (Self::send__send_from, 10948),
                    (Self::instructions__hold_to_sign, 10960),
                    (Self::confirm_total__fee_rate, 10968),
                    (Self::send__incl_transaction_fee, 10989),
                    (Self::send__total_amount, 11001),
                    (Self::auto_lock__turned_on, 11020),
                    (Self::backup__info_multi_share_backup, 11101),
                    (Self::backup__info_single_share_backup, 11159),
                    (Self::backup__title_backup_completed, 11183),
                    (Self::backup__title_create_wallet_backup, 11203),
                    (Self::haptic_feedback__disable, 11227),
                    (Self::haptic_feedback__enable, 11250),
                    (Self::haptic_feedback__subtitle, 11257),
                    (Self::haptic_feedback__title, 11272),
                    (Self::instructions__continue_holding, 11284),
                    (Self::instructions__enter_next_share, 11300),
                    (Self::instructions__hold_to_continue, 11316),
                    (Self::instructions__hold_to_exit_tutorial, 11337),
                    (Self::instructions__learn_more, 11347),
                    (Self::instructions__shares_continue_with_x_template, 11371),
                    (Self::instructions__shares_start_with_1, 11390),
                    (Self::instructions__tap_to_start, 11402),
                    (Self::passphrase__title_passphrase, 11412),
                    (Self::recovery__dry_run_backup_not_on_this_device, 11444),
                    (Self::recovery__dry_run_invalid_backup_entered, 11473),
                    (Self::recovery__dry_run_slip39_valid_all_shares, 11533),
                    (Self::recovery__dry_run_slip39_valid_share, 11595),
                    (Self::recovery__dry_run_verify_remaining_shares, 11628),
                    (Self::recovery__enter_each_word, 11675),
                    (Self::recovery__info_about_disconnect, 11759),
                    (Self::recovery__share_does_not_match, 11778),
                    (Self::reset__cancel_create_wallet, 11798),
                    (Self::reset__incorrect_word_selected, 11822),
                    (Self::reset__more_at, 11829),
                    (Self::reset__num_of_shares_how_many, 11881),
                    (Self::reset__num_of_shares_long_info_template, 12052),
                    (Self::reset__select_threshold, 12110),
                    (Self::reset__share_completed_template, 12130),
                    (Self::reset__slip39_checklist_num_shares_x_template, 12151),
                    (Self::reset__slip39_checklist_threshold_x_template, 12174),
                    (Self::send__transaction_signed, 12192),
                    (Self::tutorial__continue, 12209),
                    (Self::tutorial__exit, 12222),
                    (Self::tutorial__menu, 12276),
                    (Self::tutorial__ready_to_use_safe5, 12318),
                    (Self::tutorial__swipe_up_and_down, 12389),
                    (Self::tutorial__title_easy_navigation, 12404),
                    (Self::tutorial__welcome_safe5, 12428),
                    (Self::words__good_to_know, 12440),
                    (Self::words__operation_cancelled, 12459),
                    (Self::words__settings, 12467),
                    (Self::words__try_again, 12476),
                    (Self::reset__slip39_checklist_num_groups_x_template, 12497),
                    (Self::brightness__title, 12515),
                    (Self::recovery__title_unlock_repeated_backup, 12533),
                    (Self::recovery__unlock_repeated_backup, 12558),
                    (Self::recovery__unlock_repeated_backup_verb, 12571),
                    (Self::homescreen__set_default, 12605),
                    (Self::reset__words_may_repeat, 12622),
                    (Self::reset__repeat_for_all_shares, 12644),
                    (Self::homescreen__settings_subtitle, 12652),
                    (Self::homescreen__settings_title, 12662),
                    (Self::reset__the_word_is_repeated, 12708),
                    (Self::tutorial__title_lets_begin, 12719),
                    (Self::tutorial__did_you_know, 12732),
                    (Self::tutorial__first_wallet, 12809),
                    (Self::tutorial__restart_tutorial, 12825),
                    (Self::tutorial__title_handy_menu, 12835),
                    (Self::tutorial__title_hold, 12868),
                    (Self::tutorial__title_well_done, 12878),
                    (Self::tutorial__lets_begin, 12930),
                    (Self::tutorial__get_started, 12942),
                    (Self::instructions__swipe_horizontally, 12960),
                    (Self::setting__adjust, 12966),
                    (Self::setting__apply, 12971),
                    (Self::brightness__changed_title, 12997),
                    (Self::brightness__change_title, 13022),
                    (Self::words__title_done, 13026),
                    (Self::reset__slip39_checklist_more_info_threshold, 13104),
                    (Self::reset__slip39_checklist_more_info_threshold_example_template, 13191),
                    (Self::passphrase__continue_with_empty_passphrase, 13222),
                    (Self::instructions__swipe_down, 13232),
                    (Self::address__public_key_confirmed, 13252),
                    (Self::words__continue_anyway, 13267),
                    (Self::buttons__view_all_data, 13280),
                    (Self::instructions__view_all_data, 13306),
                    (Self::misc__enable_labeling, 13322),
                    (Self::sign_message__confirm_without_review, 13344),
                    (Self::instructions__tap_to_continue, 13359),
                    (Self::ble__unpair_all, 13387),
                    (Self::ble__unpair_current, 13410),
                    (Self::ble__unpair_title, 13416),
                    (Self::words__unlocked, 13424),
                    (Self::words__unlimited, 13433),
                    (Self::words__chain, 13438),
                    (Self::words__token, 13443),
                    (Self::instructions__tap, 13446),
                    (Self::reset__share_words_first, 13488),
                    (Self::backup__not_recommend, 13538),
                    (Self::words__pay_attention, 13551),
                    (Self::address__check_with_source, 13581),
                    (Self::words__receive, 13588),
                    (Self::reset__recovery_share_description, 13667),
                    (Self::reset__recovery_share_number, 13713),
                    (Self::words__recovery_share, 13727),
                    (Self::send__send_in_the_app, 13774),
                    (Self::send__sign_cancelled, 13789),
                    (Self::words__send, 13793),
                    (Self::words__wallet, 13799),
                    (Self::words__authenticate, 13811),
                    (Self::auto_lock__description, 13863),
                    (Self::plurals__lock_after_x_days, 13871),
                    (Self::firmware_update__restart, 13904),
                    (Self::passphrase__access_hidden_wallet, 13924),
                    (Self::passphrase__hidden_wallet, 13937),
                    (Self::passphrase__show, 13952),
                ],
            };
