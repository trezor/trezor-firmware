        ...
        impl TranslatedString {
            const BTC_ONLY_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::words__unlimited, 13394),
                    (Self::words__chain, 13399),
                    (Self::words__token, 13404),
                    (Self::instructions__tap, 13407),
                ],
            };
            ...
            const ALTCOIN_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::ethereum__contract, 2696),
                    (Self::ethereum__data_size_template, 2711),
                    (Self::ethereum__gas_limit, 2720),
                    (Self::ethereum__gas_price, 2729),
                    (Self::ethereum__max_gas_price, 2744),
                    (Self::ethereum__name_and_version, 2760),
                    (Self::ethereum__new_contract, 2789),
                    (Self::ethereum__no_message_field, 2805),
                    (Self::ethereum__priority_fee, 2821),
                    (Self::ethereum__show_full_array, 2836),
                    (Self::ethereum__show_full_domain, 2852),
                    (Self::ethereum__show_full_message, 2869),
                    (Self::ethereum__show_full_struct, 2885),
                    (Self::ethereum__sign_eip712, 2916),
                    (Self::ethereum__title_input_data, 2926),
                    (Self::ethereum__title_confirm_domain, 2940),
                    (Self::ethereum__title_confirm_message, 2955),
                    (Self::ethereum__title_confirm_struct, 2969),
                    (Self::ethereum__title_confirm_typed_data, 2987),
                    (Self::ethereum__title_signing_address, 3002),
                    (Self::ethereum__units_template, 3011),
                    (Self::ethereum__unknown_token, 3024),
                    (Self::ethereum__valid_signature, 3047),
                    (Self::fido__already_registered, 3065),
                    (Self::fido__device_already_registered, 3121),
                    (Self::fido__device_already_registered_with_template, 3164),
                    (Self::fido__device_not_registered, 3216),
                    (Self::fido__does_not_belong, 3294),
                    (Self::fido__erase_credentials, 3316),
                    (Self::fido__export_credentials, 3379),
                    (Self::fido__not_registered, 3393),
                    (Self::fido__not_registered_with_template, 3432),
                    (Self::fido__please_enable_pin_protection, 3461),
                    (Self::fido__title_authenticate, 3479),
                    (Self::fido__title_import_credential, 3496),
                    (Self::fido__title_list_credentials, 3512),
                    (Self::fido__title_register, 3526),
                    (Self::fido__title_remove_credential, 3543),
                    (Self::fido__title_reset, 3554),
                    (Self::fido__title_u2f_auth, 3570),
                    (Self::fido__title_u2f_register, 3582),
                    (Self::fido__title_verify_user, 3599),
                    (Self::fido__unable_to_verify_user, 3621),
                    (Self::fido__wanna_erase_credentials, 3665),
                    (Self::monero__confirm_export, 3679),
                    (Self::monero__confirm_ki_sync, 3694),
                    (Self::monero__confirm_refresh, 3709),
                    (Self::monero__confirm_unlock_time, 3728),
                    (Self::monero__hashing_inputs, 3742),
                    (Self::monero__payment_id, 3752),
                    (Self::monero__postprocessing, 3769),
                    (Self::monero__processing, 3782),
                    (Self::monero__processing_inputs, 3799),
                    (Self::monero__processing_outputs, 3817),
                    (Self::monero__signing, 3827),
                    (Self::monero__signing_inputs, 3841),
                    (Self::monero__unlock_time_set_template, 3887),
                    (Self::monero__wanna_export_tx_der, 3936),
                    (Self::monero__wanna_export_tx_key, 3972),
                    (Self::monero__wanna_export_watchkey, 4024),
                    (Self::monero__wanna_start_refresh, 4060),
                    (Self::monero__wanna_sync_key_images, 4098),
                    (Self::nem__absolute, 4106),
                    (Self::nem__activate, 4114),
                    (Self::nem__add, 4117),
                    (Self::nem__confirm_action, 4131),
                    (Self::nem__confirm_address, 4146),
                    (Self::nem__confirm_creation_fee, 4166),
                    (Self::nem__confirm_mosaic, 4180),
                    (Self::nem__confirm_multisig_fee, 4200),
                    (Self::nem__confirm_namespace, 4217),
                    (Self::nem__confirm_payload, 4232),
                    (Self::nem__confirm_properties, 4250),
                    (Self::nem__confirm_rental_fee, 4268),
                    (Self::nem__confirm_transfer_of, 4287),
                    (Self::nem__convert_account_to_multisig, 4323),
                    (Self::nem__cosign_transaction_for, 4345),
                    (Self::nem__cosignatory, 4357),
                    (Self::nem__create_mosaic, 4370),
                    (Self::nem__create_namespace, 4386),
                    (Self::nem__deactivate, 4396),
                    (Self::nem__decrease, 4404),
                    (Self::nem__description, 4416),
                    (Self::nem__divisibility_and_levy_cannot_be_shown, 4473),
                    (Self::nem__encrypted, 4482),
                    (Self::nem__final_confirm, 4495),
                    (Self::nem__immutable, 4504),
                    (Self::nem__increase, 4512),
                    (Self::nem__initial_supply, 4527),
                    (Self::nem__initiate_transaction_for, 4551),
                    (Self::nem__levy_divisibility, 4569),
                    (Self::nem__levy_fee, 4578),
                    (Self::nem__levy_fee_of, 4604),
                    (Self::nem__levy_mosaic, 4616),
                    (Self::nem__levy_namespace, 4631),
                    (Self::nem__levy_recipient, 4646),
                    (Self::nem__levy_type, 4656),
                    (Self::nem__modify_supply_for, 4673),
                    (Self::nem__modify_the_number_of_cosignatories_by, 4711),
                    (Self::nem__mutable, 4718),
                    (Self::nem__of, 4720),
                    (Self::nem__percentile, 4730),
                    (Self::nem__raw_units_template, 4743),
                    (Self::nem__remote_harvesting, 4762),
                    (Self::nem__remove, 4768),
                    (Self::nem__set_minimum_cosignatories_to, 4797),
                    (Self::nem__sign_tx_fee_template, 4847),
                    (Self::nem__supply_change, 4860),
                    (Self::nem__supply_units_template, 4890),
                    (Self::nem__transferable, 4903),
                    (Self::nem__under_namespace, 4918),
                    (Self::nem__unencrypted, 4929),
                    (Self::nem__unknown_mosaic, 4944),
                    (Self::ripple__confirm_tag, 4955),
                    (Self::ripple__destination_tag_template, 4975),
                    (Self::solana__account_index, 4988),
                    (Self::solana__associated_token_account, 5012),
                    (Self::solana__confirm_multisig, 5028),
                    (Self::solana__expected_fee, 5040),
                    (Self::solana__instruction_accounts_template, 5105),
                    (Self::solana__instruction_data, 5121),
                    (Self::solana__instruction_is_multisig, 5173),
                    (Self::solana__is_provided_via_lookup_table_template, 5208),
                    (Self::solana__lookup_table_address, 5228),
                    (Self::solana__multiple_signers, 5244),
                    (Self::solana__transaction_contains_unknown_instructions, 5286),
                    (Self::solana__transaction_requires_x_signers_template, 5343),
                    (Self::stellar__account_merge, 5356),
                    (Self::stellar__account_thresholds, 5374),
                    (Self::stellar__add_signer, 5384),
                    (Self::stellar__add_trust, 5393),
                    (Self::stellar__all_will_be_sent_to, 5416),
                    (Self::stellar__allow_trust, 5427),
                    (Self::stellar__asset, 5432),
                    (Self::stellar__balance_id, 5442),
                    (Self::stellar__bump_sequence, 5455),
                    (Self::stellar__buying, 5462),
                    (Self::stellar__claim_claimable_balance, 5485),
                    (Self::stellar__clear_data, 5495),
                    (Self::stellar__clear_flags, 5506),
                    (Self::stellar__confirm_issuer, 5520),
                    (Self::stellar__confirm_memo, 5532),
                    (Self::stellar__confirm_network, 5547),
                    (Self::stellar__confirm_operation, 5564),
                    (Self::stellar__confirm_stellar, 5579),
                    (Self::stellar__confirm_timebounds, 5597),
                    (Self::stellar__create_account, 5611),
                    (Self::stellar__debited_amount, 5625),
                    (Self::stellar__delete, 5631),
                    (Self::stellar__delete_passive_offer, 5651),
                    (Self::stellar__delete_trust, 5663),
                    (Self::stellar__destination, 5674),
                    (Self::stellar__exchanges_require_memo, 5730),
                    (Self::stellar__final_confirm, 5743),
                    (Self::stellar__hash, 5747),
                    (Self::stellar__high, 5752),
                    (Self::stellar__home_domain, 5763),
                    (Self::stellar__inflation, 5772),
                    (Self::stellar__initial_balance, 5787),
                    (Self::stellar__initialize_signing_with, 5810),
                    (Self::stellar__issuer_template, 5820),
                    (Self::stellar__key, 5824),
                    (Self::stellar__limit, 5829),
                    (Self::stellar__low, 5833),
                    (Self::stellar__master_weight, 5847),
                    (Self::stellar__medium, 5854),
                    (Self::stellar__new_offer, 5863),
                    (Self::stellar__new_passive_offer, 5880),
                    (Self::stellar__no_memo_set, 5892),
                    (Self::stellar__no_restriction, 5908),
                    (Self::stellar__on_network_template, 5929),
                    (Self::stellar__path_pay, 5937),
                    (Self::stellar__path_pay_at_least, 5954),
                    (Self::stellar__pay, 5957),
                    (Self::stellar__pay_at_most, 5968),
                    (Self::stellar__preauth_transaction, 5988),
                    (Self::stellar__price_per_template, 6002),
                    (Self::stellar__private_network, 6017),
                    (Self::stellar__remove_signer, 6030),
                    (Self::stellar__revoke_trust, 6042),
                    (Self::stellar__selling, 6050),
                    (Self::stellar__set_data, 6058),
                    (Self::stellar__set_flags, 6067),
                    (Self::stellar__set_sequence_to_template, 6087),
                    (Self::stellar__sign_tx_count_template, 6123),
                    (Self::stellar__sign_tx_fee_template, 6143),
                    (Self::stellar__source_account, 6157),
                    (Self::stellar__testnet_network, 6172),
                    (Self::stellar__trusted_account, 6187),
                    (Self::stellar__update, 6193),
                    (Self::stellar__valid_from, 6209),
                    (Self::stellar__valid_to, 6223),
                    (Self::stellar__value_sha256, 6239),
                    (Self::stellar__wanna_clean_value_key_template, 6274),
                    (Self::stellar__your_account, 6287),
                    (Self::tezos__baker_address, 6300),
                    (Self::tezos__balance, 6308),
                    (Self::tezos__ballot, 6315),
                    (Self::tezos__confirm_delegation, 6333),
                    (Self::tezos__confirm_origination, 6352),
                    (Self::tezos__delegator, 6361),
                    (Self::tezos__proposal, 6369),
                    (Self::tezos__register_delegate, 6386),
                    (Self::tezos__remove_delegation, 6403),
                    (Self::tezos__submit_ballot, 6416),
                    (Self::tezos__submit_proposal, 6431),
                    (Self::tezos__submit_proposals, 6447),
                    (Self::u2f__get, 6485),
                    (Self::u2f__set_template, 6512),
                    (Self::u2f__title_get, 6527),
                    (Self::u2f__title_set, 6542),
                    (Self::ethereum__staking_claim, 6547),
                    (Self::ethereum__staking_claim_address, 6560),
                    (Self::ethereum__staking_claim_intro, 6585),
                    (Self::ethereum__staking_stake, 6590),
                    (Self::ethereum__staking_stake_address, 6603),
                    (Self::ethereum__staking_stake_intro, 6626),
                    (Self::ethereum__staking_unstake, 6633),
                    (Self::ethereum__staking_unstake_intro, 6660),
                    (Self::cardano__always_abstain, 6674),
                    (Self::cardano__always_no_confidence, 6694),
                    (Self::cardano__delegating_to_key_hash, 6717),
                    (Self::cardano__delegating_to_script, 6738),
                    (Self::cardano__deposit, 6746),
                    (Self::cardano__vote_delegation, 6761),
                    (Self::fido__more_credentials, 6777),
                    (Self::fido__select_intro, 6845),
                    (Self::fido__title_for_authentication, 6863),
                    (Self::fido__title_select_credential, 6880),
                    (Self::fido__title_credential_details, 6898),
                    (Self::ethereum__unknown_contract_address, 6969),
                    (Self::ethereum__token_contract, 6983),
                    (Self::ethereum__interaction_contract, 7003),
                    (Self::ethereum__unknown_contract_address_short, 7028),
                    (Self::solana__base_fee, 7036),
                    (Self::solana__claim, 7041),
                    (Self::solana__claim_question, 7070),
                    (Self::solana__claim_recipient_warning, 7122),
                    (Self::solana__priority_fee, 7134),
                    (Self::solana__stake, 7139),
                    (Self::solana__stake_account, 7152),
                    (Self::solana__stake_provider, 7160),
                    (Self::solana__stake_question, 7170),
                    (Self::solana__stake_withdrawal_warning, 7230),
                    (Self::solana__stake_withdrawal_warning_title, 7256),
                    (Self::solana__unstake, 7263),
                    (Self::solana__unstake_question, 7294),
                    (Self::solana__vote_account, 7306),
                    (Self::solana__stake_on_question, 7323),
                    (Self::nostr__event_kind_template, 7338),
                    (Self::solana__max_fees_rent, 7355),
                    (Self::solana__max_rent_fee, 7367),
                    (Self::solana__transaction_fee, 7382),
                    (Self::ethereum__approve, 7389),
                    (Self::ethereum__approve_amount_allowance, 7405),
                    (Self::ethereum__approve_chain_id, 7413),
                    (Self::ethereum__approve_intro, 7454),
                    (Self::ethereum__approve_intro_title, 7468),
                    (Self::ethereum__approve_to, 7478),
                    (Self::ethereum__approve_unlimited_template, 7511),
                    (Self::ethereum__approve_intro_revoke, 7551),
                    (Self::ethereum__approve_intro_title_revoke, 7567),
                    (Self::ethereum__approve_revoke, 7573),
                    (Self::ethereum__approve_revoke_from, 7584),
                ],
            };
        ...
        impl TranslatedString {
            const BTC_ONLY_BLOB: StringsBlob = StringsBlob {
                ...
                offsets: &[
                    ...
                    (Self::backup__it_should_be_backed_up, 433),
                    (Self::backup__it_should_be_backed_up_now, 460),
                    (Self::backup__new_wallet_created, 476),
                    (Self::backup__new_wallet_successfully_created, 504),
                    (Self::backup__recover_anytime, 563),
                    (Self::backup__title_backup_wallet, 577),
                    (Self::backup__title_skip, 588),
                    (Self::backup__want_to_skip, 629),
                    (Self::bitcoin__commitment_data, 644),
                    (Self::bitcoin__confirm_locktime, 660),
                    (Self::bitcoin__create_proof_of_ownership, 703),
                    (Self::bitcoin__high_mining_fee_template, 746),
                    (Self::bitcoin__locktime_no_effect, 786),
                    (Self::bitcoin__locktime_set_to, 801),
                    (Self::bitcoin__locktime_set_to_blockheight, 828),
                    (Self::bitcoin__lot_of_change_outputs, 852),
                    (Self::bitcoin__multiple_accounts, 869),
                    (Self::bitcoin__new_fee_rate, 882),
                    (Self::bitcoin__simple_send_of, 896),
                    (Self::bitcoin__ticket_amount, 909),
                    (Self::bitcoin__title_confirm_details, 924),
                    (Self::bitcoin__title_finalize_transaction, 944),
                    (Self::bitcoin__title_high_mining_fee, 959),
                    (Self::bitcoin__title_meld_transaction, 976),
                    (Self::bitcoin__title_modify_amount, 989),
                    (Self::bitcoin__title_payjoin, 996),
                    (Self::bitcoin__title_proof_of_ownership, 1014),
                    (Self::bitcoin__title_purchase_ticket, 1029),
                    (Self::bitcoin__title_update_transaction, 1047),
                    (Self::bitcoin__unknown_path, 1059),
                    (Self::bitcoin__unknown_transaction, 1078),
                    (Self::bitcoin__unusually_high_fee, 1097),
                    (Self::bitcoin__unverified_external_inputs, 1149),
                    (Self::bitcoin__valid_signature, 1172),
                    (Self::bitcoin__voting_rights, 1188),
                    (Self::buttons__abort, 1193),
                    (Self::buttons__access, 1199),
                    (Self::buttons__again, 1204),
                    (Self::buttons__allow, 1209),
                    (Self::buttons__back, 1213),
                    (Self::buttons__back_up, 1220),
                    (Self::buttons__cancel, 1226),
                    (Self::buttons__change, 1232),
                    (Self::buttons__check, 1237),
                    (Self::buttons__check_again, 1248),
                    (Self::buttons__close, 1253),
                    (Self::buttons__confirm, 1260),
                    (Self::buttons__continue, 1268),
                    (Self::buttons__details, 1275),
                    (Self::buttons__enable, 1281),
                    (Self::buttons__enter, 1286),
                    (Self::buttons__enter_share, 1297),
                    (Self::buttons__export, 1303),
                    (Self::buttons__format, 1309),
                    (Self::buttons__go_back, 1316),
                    (Self::buttons__hold_to_confirm, 1331),
                    (Self::buttons__info, 1335),
                    (Self::buttons__install, 1342),
                    (Self::buttons__more_info, 1351),
                    (Self::buttons__ok_i_understand, 1367),
                    (Self::buttons__purchase, 1375),
                    (Self::buttons__quit, 1379),
                    (Self::buttons__restart, 1386),
                    (Self::buttons__retry, 1391),
                    (Self::buttons__select, 1397),
                    (Self::buttons__set, 1400),
                    (Self::buttons__show_all, 1408),
                    (Self::buttons__show_details, 1420),
                    (Self::buttons__show_words, 1430),
                    (Self::buttons__skip, 1434),
                    (Self::buttons__try_again, 1443),
                    (Self::buttons__turn_off, 1451),
                    (Self::buttons__turn_on, 1458),
                    (Self::coinjoin__access_account, 1487),
                    (Self::coinjoin__do_not_disconnect, 1517),
                    (Self::coinjoin__max_mining_fee, 1531),
                    (Self::coinjoin__max_rounds, 1541),
                    (Self::coinjoin__title, 1559),
                    (Self::coinjoin__title_do_not_disconnect, 1589),
                    (Self::coinjoin__title_progress, 1609),
                    (Self::coinjoin__waiting_for_others, 1627),
                    (Self::confirm_total__fee_rate_colon, 1636),
                    (Self::confirm_total__sending_from_account, 1657),
                    (Self::confirm_total__title_fee, 1665),
                    (Self::confirm_total__title_sending_from, 1677),
                    (Self::device_name__change_template, 1703),
                    (Self::device_name__title, 1714),
                    (Self::entropy__send, 1749),
                    (Self::entropy__title_confirm, 1764),
                    (Self::send__sign_transaction, 1780),
                    (Self::experimental_mode__enable, 1809),
                    (Self::experimental_mode__only_for_dev, 1847),
                    (Self::experimental_mode__title, 1864),
                    (Self::firmware_update__title, 1879),
                    (Self::firmware_update__title_fingerprint, 1893),
                    (Self::homescreen__click_to_connect, 1909),
                    (Self::homescreen__click_to_unlock, 1924),
                    (Self::homescreen__title_backup_failed, 1937),
                    (Self::homescreen__title_backup_needed, 1950),
                    (Self::homescreen__title_coinjoin_authorized, 1969),
                    (Self::homescreen__title_experimental_mode, 1986),
                    (Self::homescreen__title_no_usb_connection, 2003),
                    (Self::homescreen__title_pin_not_set, 2014),
                    (Self::homescreen__title_seedless, 2022),
                    (Self::homescreen__title_set, 2038),
                    (Self::inputs__back, 2042),
                    (Self::inputs__cancel, 2048),
                    (Self::inputs__delete, 2054),
                    (Self::inputs__enter, 2059),
                    (Self::inputs__return, 2065),
                    (Self::inputs__show, 2069),
                    (Self::inputs__space, 2074),
                    (Self::joint__title, 2091),
                    (Self::joint__to_the_total_amount, 2111),
                    (Self::joint__you_are_contributing, 2132),
                    (Self::language__change_to_template, 2155),
                    (Self::language__changed, 2184),
                    (Self::language__progress, 2201),
                    (Self::language__title, 2218),
                    (Self::lockscreen__tap_to_connect, 2232),
                    (Self::lockscreen__tap_to_unlock, 2245),
                    (Self::lockscreen__title_locked, 2251),
                    (Self::lockscreen__title_not_connected, 2264),
                    (Self::misc__decrypt_value, 2277),
                    (Self::misc__encrypt_value, 2290),
                    (Self::misc__title_suite_labeling, 2304),
                    (Self::modify_amount__decrease_amount, 2323),
                    (Self::modify_amount__increase_amount, 2342),
                    (Self::modify_amount__new_amount, 2353),
                    (Self::modify_amount__title, 2366),
                    (Self::modify_fee__decrease_fee, 2382),
                    (Self::modify_fee__fee_rate, 2391),
                    (Self::modify_fee__increase_fee, 2407),
                    (Self::modify_fee__new_transaction_fee, 2427),
                    (Self::modify_fee__no_change, 2447),
                    (Self::modify_fee__title, 2457),
                    (Self::modify_fee__transaction_fee, 2473),
                    (Self::passphrase__access_wallet, 2498),
                    (Self::passphrase__always_on_device, 2537),
                    (Self::passphrase__from_host_not_shown, 2631),
                    (Self::passphrase__wallet, 2648),
                    (Self::passphrase__hide, 2681),
                    (Self::passphrase__next_screen_will_show_passphrase, 2719),
                    (Self::passphrase__please_enter, 2748),
                    (Self::passphrase__revoke_on_device, 2803),
                    (Self::passphrase__title_confirm, 2821),
                    (Self::passphrase__title_enter, 2837),
                    (Self::passphrase__title_hide, 2852),
                    (Self::passphrase__title_settings, 2871),
                    (Self::passphrase__title_source, 2888),
                    (Self::passphrase__turn_off, 2919),
                    (Self::passphrase__turn_on, 2949),
                    (Self::pin__change, 2960),
                    (Self::pin__changed, 2972),
                    (Self::pin__cursor_will_change, 3045),
                    (Self::pin__diff_from_wipe_code, 3095),
                    (Self::pin__disabled, 3121),
                    (Self::pin__enabled, 3146),
                    (Self::pin__enter, 3155),
                    (Self::pin__enter_new, 3168),
                    (Self::pin__entered_not_valid, 3206),
                    (Self::pin__info, 3249),
                    (Self::pin__invalid_pin, 3260),
                    (Self::pin__last_attempt, 3272),
                    (Self::pin__mismatch, 3298),
                    (Self::pin__pin_mismatch, 3310),
                    (Self::pin__please_check_again, 3329),
                    (Self::pin__reenter_new, 3345),
                    (Self::pin__reenter_to_confirm, 3376),
                    (Self::pin__should_be_long, 3407),
                    (Self::pin__title_check_pin, 3416),
                    (Self::pin__title_settings, 3428),
                    (Self::pin__title_wrong_pin, 3437),
                    (Self::pin__tries_left, 3447),
                    (Self::pin__turn_off, 3496),
                    (Self::pin__turn_on, 3519),
                    (Self::pin__wrong_pin, 3528),
                    (Self::plurals__contains_x_keys, 3536),
                    (Self::plurals__lock_after_x_hours, 3546),
                    (Self::plurals__lock_after_x_milliseconds, 3570),
                    (Self::plurals__lock_after_x_minutes, 3584),
                    (Self::plurals__lock_after_x_seconds, 3598),
                    (Self::plurals__sign_x_actions, 3612),
                    (Self::plurals__transaction_of_x_operations, 3632),
                    (Self::plurals__x_groups_needed, 3644),
                    (Self::plurals__x_shares_needed, 3656),
                    (Self::progress__authenticity_check, 3680),
                    (Self::progress__done, 3684),
                    (Self::progress__loading_transaction, 3706),
                    (Self::progress__locking_device, 3727),
                    (Self::progress__one_second_left, 3740),
                    (Self::progress__please_wait, 3751),
                    (Self::storage_msg__processing, 3761),
                    (Self::progress__refreshing, 3774),
                    (Self::progress__signing_transaction, 3796),
                    (Self::progress__syncing, 3806),
                    (Self::progress__x_seconds_left_template, 3822),
                    (Self::reboot_to_bootloader__restart, 3861),
                    (Self::reboot_to_bootloader__title, 3877),
                    (Self::reboot_to_bootloader__version_by_template, 3904),
                    (Self::recovery__cancel_dry_run, 3923),
                    (Self::recovery__check_dry_run, 3941),
                    (Self::recovery__cursor_will_change, 4014),
                    (Self::recovery__dry_run_bip39_valid_match, 4084),
                    (Self::recovery__dry_run_bip39_valid_mismatch, 4160),
                    (Self::recovery__dry_run_slip39_valid_match, 4240),
                    (Self::recovery__dry_run_slip39_valid_mismatch, 4327),
                    (Self::recovery__enter_any_share, 4342),
                    (Self::recovery__enter_backup, 4360),
                    (Self::recovery__enter_different_share, 4384),
                    (Self::recovery__enter_share_from_diff_group, 4419),
                    (Self::recovery__group_num_template, 4428),
                    (Self::recovery__group_threshold_reached, 4452),
                    (Self::recovery__invalid_wallet_backup_entered, 4482),
                    (Self::recovery__invalid_share_entered, 4513),
                    (Self::recovery__more_shares_needed, 4531),
                    (Self::recovery__num_of_words, 4573),
                    (Self::recovery__only_first_n_letters, 4635),
                    (Self::recovery__progress_will_be_lost, 4661),
                    (Self::recovery__share_already_entered, 4682),
                    (Self::recovery__share_from_another_multi_share_backup, 4731),
                    ...
                    (Self::recovery__wallet_recovered, 4875),
                    (Self::recovery__wanna_cancel_dry_run, 4924),
                    (Self::recovery__wanna_cancel_recovery, 4977),
                    (Self::recovery__word_count_template, 4988),
                    (Self::recovery__word_x_of_y_template, 5003),
                    (Self::recovery__x_more_items_starting_template_plural, 5033),
                    (Self::recovery__x_more_shares_needed_template_plural, 5061),
                    (Self::recovery__x_of_y_entered_template, 5086),
                    (Self::recovery__you_have_entered, 5102),
                    (Self::reset__advanced_group_threshold_info, 5185),
                    (Self::reset__all_x_of_y_template, 5206),
                    (Self::reset__any_x_of_y_template, 5227),
                    (Self::reset__button_create, 5240),
                    (Self::reset__button_recover, 5254),
                    (Self::reset__by_continuing, 5319),
                    (Self::reset__check_backup_title, 5331),
                    (Self::reset__check_group_share_title_template, 5353),
                    (Self::reset__check_wallet_backup_title, 5372),
                    (Self::reset__check_share_title_template, 5388),
                    (Self::reset__continue_with_next_share, 5417),
                    (Self::reset__continue_with_share_template, 5442),
                    (Self::reset__finished_verifying_group_template, 5505),
                    (Self::reset__finished_verifying_wallet_backup, 5552),
                    (Self::reset__finished_verifying_shares, 5601),
                    (Self::reset__group_description, 5639),
                    (Self::reset__group_info, 5772),
                    (Self::reset__group_share_checked_successfully_template, 5815),
                    (Self::reset__group_share_title_template, 5836),
                    (Self::reset__more_info_at, 5848),
                    (Self::reset__need_all_share_template, 5892),
                    (Self::reset__need_any_share_template, 5936),
                    (Self::reset__needed_to_form_a_group, 5960),
                    (Self::reset__needed_to_recover_your_wallet, 5991),
                    (Self::reset__never_make_digital_copy, 6030),
                    (Self::reset__num_of_share_holders_template, 6079),
                    (Self::reset__num_of_shares_advanced_info_template, 6204),
                    (Self::reset__num_of_shares_basic_info_template, 6321),
                    (Self::reset__num_shares_for_group_template, 6369),
                    (Self::reset__number_of_shares_info, 6428),
                    (Self::reset__one_share, 6435),
                    (Self::reset__only_one_share_will_be_created, 6466),
                    (Self::reset__recovery_wallet_backup_title, 6479),
                    (Self::reset__recovery_share_title_template, 6498),
                    (Self::reset__required_number_of_groups, 6541),
                    (Self::reset__select_correct_word, 6583),
                    (Self::reset__select_word_template, 6598),
                    (Self::reset__select_word_x_of_y_template, 6621),
                    (Self::reset__set_it_to_count_template, 6653),
                    (Self::reset__share_checked_successfully_template, 6685),
                    (Self::reset__share_words_title, 6700),
                    (Self::reset__slip39_checklist_num_groups, 6716),
                    (Self::reset__slip39_checklist_num_shares, 6732),
                    (Self::reset__slip39_checklist_set_num_groups, 6752),
                    (Self::reset__slip39_checklist_set_num_shares, 6772),
                    (Self::reset__slip39_checklist_set_sizes, 6796),
                    (Self::reset__slip39_checklist_set_sizes_longer, 6833),
                    (Self::reset__slip39_checklist_set_threshold, 6846),
                    (Self::reset__slip39_checklist_title, 6862),
                    (Self::reset__slip39_checklist_write_down, 6893),
                    (Self::reset__slip39_checklist_write_down_recovery, 6936),
                    (Self::reset__the_threshold_sets_the_number_of_shares, 6976),
                    (Self::reset__threshold_info, 7032),
                    (Self::reset__title_backup_is_done, 7046),
                    (Self::reset__title_create_wallet, 7059),
                    (Self::reset__title_group_threshold, 7074),
                    (Self::reset__title_number_of_groups, 7090),
                    (Self::reset__title_number_of_shares, 7106),
                    (Self::reset__title_set_group_threshold, 7125),
                    (Self::reset__title_set_number_of_groups, 7145),
                    (Self::reset__title_set_number_of_shares, 7165),
                    (Self::reset__title_set_threshold, 7178),
                    (Self::reset__to_form_group_template, 7196),
                    (Self::reset__tos_link, 7209),
                    (Self::reset__total_number_of_shares_in_group_template, 7253),
                    (Self::reset__use_your_backup, 7306),
                    (Self::reset__write_down_words_template, 7372),
                    (Self::reset__wrong_word_selected, 7392),
                    (Self::reset__you_need_one_share, 7422),
                    (Self::reset__your_backup_is_done, 7442),
                    (Self::rotation__change_template, 7476),
                    (Self::rotation__east, 7480),
                    (Self::rotation__north, 7485),
                    (Self::rotation__south, 7490),
                    (Self::rotation__title_change, 7509),
                    (Self::rotation__west, 7513),
                    (Self::safety_checks__approve_unsafe_always, 7581),
                    (Self::safety_checks__approve_unsafe_temporary, 7661),
                    (Self::safety_checks__enforce_strict, 7726),
                    (Self::safety_checks__title, 7739),
                    (Self::safety_checks__title_safety_override, 7754),
                    (Self::sd_card__all_data_will_be_lost, 7791),
                    (Self::sd_card__card_required, 7808),
                    (Self::sd_card__disable, 7873),
                    (Self::sd_card__disabled, 7918),
                    (Self::sd_card__enable, 7983),
                    (Self::sd_card__enabled, 8027),
                    (Self::sd_card__error, 8040),
                    (Self::sd_card__format_card, 8054),
                    (Self::sd_card__insert_correct_card, 8104),
                    (Self::sd_card__please_insert, 8131),
                    (Self::sd_card__please_unplug_and_insert, 8180),
                    (Self::sd_card__problem_accessing, 8222),
                    (Self::sd_card__refresh, 8306),
                    (Self::sd_card__refreshed, 8352),
                    (Self::sd_card__restart, 8401),
                    (Self::sd_card__title, 8419),
                    (Self::sd_card__title_problem, 8434),
                    (Self::sd_card__unknown_filesystem, 8453),
                    (Self::sd_card__unplug_and_insert_correct, 8509),
                    (Self::sd_card__use_different_card, 8576),
                    (Self::sd_card__wanna_format, 8617),
                    (Self::sd_card__wrong_sd_card, 8631),
                    (Self::send__address_path, 8643),
                    (Self::send__confirm_sending, 8657),
                    (Self::send__from_multiple_accounts, 8688),
                    (Self::send__including_fee, 8702),
                    (Self::send__maximum_fee, 8713),
                    (Self::send__receiving_to_multisig, 8745),
                    (Self::send__title_confirm_sending, 8760),
                    (Self::send__title_joint_transaction, 8777),
                    (Self::send__title_receiving_to, 8789),
                    (Self::send__title_sending, 8796),
                    (Self::send__title_sending_amount, 8810),
                    (Self::send__title_sending_to, 8820),
                    (Self::send__to_the_total_amount, 8840),
                    (Self::send__transaction_id, 8854),
                    (Self::send__you_are_contributing, 8875),
                    (Self::share_words__words_in_order, 8891),
                    (Self::share_words__wrote_down_all, 8908),
                    (Self::sign_message__bytes_template, 8917),
                    (Self::sign_message__confirm_address, 8932),
                    (Self::sign_message__confirm_message, 8947),
                    (Self::sign_message__message_size, 8959),
                    (Self::sign_message__verify_address, 8973),
                    (Self::tutorial__middle_click, 9027),
                    (Self::tutorial__press_and_hold, 9091),
                    (Self::tutorial__ready_to_use, 9118),
                    (Self::tutorial__scroll_down, 9227),
                    (Self::tutorial__sure_you_want_skip, 9270),
                    (Self::tutorial__title_hello, 9275),
                    (Self::tutorial__title_screen_scroll, 9288),
                    (Self::tutorial__title_skip, 9301),
                    (Self::tutorial__title_tutorial_complete, 9318),
                    (Self::tutorial__use_trezor, 9385),
                    (Self::tutorial__welcome_press_right, 9428),
                    (Self::wipe__info, 9452),
                    (Self::wipe__title, 9463),
                    (Self::wipe__want_to_wipe, 9502),
                    (Self::wipe_code__change, 9519),
                    (Self::wipe_code__changed, 9537),
                    (Self::wipe_code__diff_from_pin, 9583),
                    (Self::wipe_code__disabled, 9602),
                    (Self::wipe_code__enabled, 9620),
                    (Self::wipe_code__enter_new, 9639),
                    (Self::wipe_code__info, 9696),
                    (Self::wipe_code__invalid, 9713),
                    (Self::wipe_code__mismatch, 9753),
                    (Self::wipe_code__reenter, 9771),
                    (Self::wipe_code__reenter_to_confirm, 9808),
                    (Self::wipe_code__title_check, 9823),
                    (Self::wipe_code__title_invalid, 9840),
                    (Self::wipe_code__title_settings, 9858),
                    (Self::wipe_code__turn_off, 9888),
                    (Self::wipe_code__turn_on, 9917),
                    (Self::wipe_code__wipe_code_mismatch, 9935),
                    (Self::word_count__title, 9950),
                    (Self::words__account, 9957),
                    (Self::words__account_colon, 9965),
                    (Self::words__address, 9972),
                    (Self::words__amount, 9978),
                    (Self::words__are_you_sure, 9991),
                    (Self::words__array_of, 9999),
                    (Self::words__blockhash, 10008),
                    (Self::words__buying, 10014),
                    (Self::words__confirm, 10021),
                    (Self::words__confirm_fee, 10032),
                    (Self::words__contains, 10040),
                    (Self::words__continue_anyway_question, 10056),
                    (Self::words__continue_with, 10069),
                    (Self::words__error, 10074),
                    (Self::words__fee, 10077),
                    (Self::words__from, 10081),
                    (Self::words__keep_it_safe, 10094),
                    (Self::words__know_what_your_doing, 10139),
                    (Self::words__my_trezor, 10148),
                    (Self::words__no, 10150),
                    (Self::words__outputs, 10157),
                    (Self::words__please_check_again, 10175),
                    (Self::words__please_try_again, 10191),
                    (Self::words__really_wanna, 10212),
                    (Self::words__recipient, 10221),
                    (Self::words__sign, 10225),
                    (Self::words__signer, 10231),
                    (Self::words__title_check, 10236),
                    (Self::words__title_group, 10241),
                    (Self::words__title_information, 10252),
                    (Self::words__title_remember, 10260),
                    (Self::words__title_share, 10265),
                    (Self::words__title_shares, 10271),
                    (Self::words__title_success, 10278),
                    (Self::words__title_summary, 10285),
                    (Self::words__title_threshold, 10294),
                    (Self::words__unknown, 10301),
                    (Self::words__warning, 10308),
                    (Self::words__writable, 10316),
                    (Self::words__yes, 10319),
                    (Self::reboot_to_bootloader__just_a_moment, 10335),
                    (Self::inputs__previous, 10343),
                    (Self::storage_msg__starting, 10354),
                    (Self::storage_msg__verifying_pin, 10367),
                    (Self::storage_msg__wrong_pin, 10376),
                    (Self::reset__create_x_of_y_multi_share_backup_template, 10430),
                    (Self::reset__title_shamir_backup, 10448),
                    (Self::instructions__tap_to_confirm, 10462),
                    (Self::instructions__hold_to_confirm, 10477),
                    (Self::words__important, 10486),
                    (Self::reset__words_written_down_template, 10522),
                    (Self::backup__create_backup_to_prevent_loss, 10574),
                    (Self::reset__check_backup_instructions, 10612),
                    (Self::words__instructions, 10624),
                    (Self::words__not_recommended, 10640),
                    (Self::address_details__account_info, 10652),
                    (Self::address__cancel_contact_support, 10730),
                    (Self::address__cancel_receive, 10744),
                    (Self::address__qr_code, 10751),
                    (Self::address_details__derivation_path, 10766),
                    (Self::instructions__continue_in_app, 10785),
                    (Self::words__cancel_and_exit, 10800),
                    (Self::address__confirmed, 10825),
                    (Self::pin__cancel_description, 10845),
                    (Self::pin__cancel_info, 10890),
                    (Self::pin__cancel_setup, 10906),
                    (Self::send__cancel_sign, 10917),
                    (Self::send__send_from, 10926),
                    (Self::instructions__hold_to_sign, 10938),
                    (Self::confirm_total__fee_rate, 10946),
                    (Self::send__incl_transaction_fee, 10967),
                    (Self::send__total_amount, 10979),
                    (Self::auto_lock__turned_on, 10998),
                    (Self::backup__info_multi_share_backup, 11079),
                    (Self::backup__info_single_share_backup, 11137),
                    (Self::backup__title_backup_completed, 11160),
                    (Self::backup__title_create_wallet_backup, 11180),
                    (Self::haptic_feedback__disable, 11204),
                    (Self::haptic_feedback__enable, 11227),
                    (Self::haptic_feedback__subtitle, 11234),
                    (Self::haptic_feedback__title, 11249),
                    (Self::instructions__continue_holding, 11265),
                    (Self::instructions__enter_next_share, 11281),
                    (Self::instructions__hold_to_continue, 11297),
                    (Self::instructions__hold_to_exit_tutorial, 11318),
                    (Self::instructions__learn_more, 11328),
                    (Self::instructions__shares_continue_with_x_template, 11352),
                    (Self::instructions__shares_start_with_1, 11371),
                    (Self::instructions__tap_to_start, 11383),
                    (Self::passphrase__title_passphrase, 11393),
                    (Self::recovery__dry_run_backup_not_on_this_device, 11425),
                    (Self::recovery__dry_run_invalid_backup_entered, 11454),
                    (Self::recovery__dry_run_slip39_valid_all_shares, 11514),
                    (Self::recovery__dry_run_slip39_valid_share, 11576),
                    (Self::recovery__dry_run_verify_remaining_shares, 11609),
                    (Self::recovery__enter_each_word, 11656),
                    (Self::recovery__info_about_disconnect, 11740),
                    (Self::recovery__share_does_not_match, 11759),
                    (Self::reset__cancel_create_wallet, 11779),
                    (Self::reset__incorrect_word_selected, 11802),
                    (Self::reset__more_at, 11809),
                    (Self::reset__num_of_shares_how_many, 11861),
                    (Self::reset__num_of_shares_long_info_template, 12032),
                    (Self::reset__select_threshold, 12090),
                    (Self::reset__share_completed_template, 12110),
                    (Self::reset__slip39_checklist_num_shares_x_template, 12131),
                    (Self::reset__slip39_checklist_threshold_x_template, 12154),
                    (Self::send__transaction_signed, 12172),
                    (Self::tutorial__continue, 12189),
                    (Self::tutorial__exit, 12202),
                    (Self::tutorial__menu, 12256),
                    (Self::tutorial__ready_to_use_safe5, 12298),
                    (Self::tutorial__swipe_up_and_down, 12369),
                    (Self::tutorial__title_easy_navigation, 12384),
                    (Self::tutorial__welcome_safe5, 12408),
                    (Self::words__good_to_know, 12420),
                    (Self::words__operation_cancelled, 12439),
                    (Self::words__settings, 12447),
                    (Self::words__try_again, 12457),
                    (Self::reset__slip39_checklist_num_groups_x_template, 12478),
                    (Self::brightness__title, 12496),
                    (Self::recovery__title_unlock_repeated_backup, 12514),
                    (Self::recovery__unlock_repeated_backup, 12539),
                    (Self::recovery__unlock_repeated_backup_verb, 12552),
                    (Self::homescreen__set_default, 12586),
                    (Self::reset__words_may_repeat, 12603),
                    (Self::reset__repeat_for_all_shares, 12625),
                    (Self::homescreen__settings_subtitle, 12633),
                    (Self::homescreen__settings_title, 12643),
                    (Self::reset__the_word_is_repeated, 12663),
                    (Self::tutorial__title_lets_begin, 12674),
                    (Self::tutorial__did_you_know, 12687),
                    (Self::tutorial__first_wallet, 12764),
                    (Self::tutorial__restart_tutorial, 12780),
                    (Self::tutorial__title_handy_menu, 12790),
                    (Self::tutorial__title_hold, 12823),
                    (Self::tutorial__title_well_done, 12833),
                    (Self::tutorial__lets_begin, 12885),
                    (Self::tutorial__get_started, 12897),
                    (Self::instructions__swipe_horizontally, 12915),
                    (Self::setting__adjust, 12921),
                    (Self::setting__apply, 12926),
                    (Self::brightness__changed_title, 12952),
                    (Self::brightness__change_title, 12977),
                    (Self::words__title_done, 12981),
                    (Self::reset__slip39_checklist_more_info_threshold, 13059),
                    (Self::reset__slip39_checklist_more_info_threshold_example_template, 13146),
                    (Self::passphrase__continue_with_empty_passphrase, 13177),
                    (Self::instructions__swipe_down, 13187),
                    (Self::address__public_key_confirmed, 13207),
                    (Self::words__continue_anyway, 13222),
                    (Self::buttons__view_all_data, 13235),
                    (Self::instructions__view_all_data, 13261),
                    (Self::misc__enable_labeling, 13277),
                    (Self::sign_message__confirm_without_review, 13299),
                    (Self::instructions__tap_to_continue, 13314),
                    (Self::ble__unpair_all, 13342),
                    (Self::ble__unpair_current, 13365),
                    (Self::ble__unpair_title, 13371),
                    (Self::words__unlocked, 13379),
                    (Self::words__unlimited, 13388),
                    (Self::words__chain, 13393),
                    (Self::words__token, 13398),
                    (Self::instructions__tap, 13401),
                ],
            };
