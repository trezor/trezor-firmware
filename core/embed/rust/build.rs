...
fn main() {
    ...
    if xbuild::rust_analyser_is_running() {
        return;
    }
    ...
    #[cfg(all(test, not(feature = "with_new_crates")))]
    link_core_objects();
...
fn prepare_bindings() -> bindgen::Builder {
    ...
    // !@# not needed in the emulator build
    attrs
    ...
    if cfg!(feature = "bootloader") {
        //TODO!@# hack - needed by trezorhal.h
        attrs.add_include("../projects/bootloader");
    }

    // TODO!@# build fails with these flags, investigate why
