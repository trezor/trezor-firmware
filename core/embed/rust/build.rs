...
fn generate_crypto_bindings() {
    ...
    let bindings = prepare_bindings()
        ...
        // noise_xx
        .allowlist_var("NOISE_XX_MAX_PAYLOAD_LEN")
        .allowlist_type("noise_xx_handshake_context_t")
        .allowlist_type("noise_xx_handshake_step_t")
        .allowlist_type("noise_xx_initiation_request_t")
        .allowlist_type("noise_xx_initiation_response_t")
        .allowlist_type("noise_xx_completion_request_t")
        .allowlist_type("noise_context_t")
        .no_copy("noise_xx_handshake_context_t")
        .no_copy("noise_context_t")
        .allowlist_function("noise_send_message_inplace")
        .allowlist_function("noise_receive_message_inplace")
        .allowlist_function("noise_xx_create_initiation_request")
        .allowlist_function("noise_xx_handle_initiation_request")
        .allowlist_function("noise_xx_create_initiation_response")
        .allowlist_function("noise_xx_handle_initiation_response")
        .allowlist_function("noise_xx_create_completion_request")
        .allowlist_function("noise_xx_handle_completion_request")
        // sha256
