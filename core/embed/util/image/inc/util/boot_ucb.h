 ...
 * @param code_address ddress of the start of the bootloader code in flash
 ...
 * the upgrade process and to ensure that the boardloader will not
 * repeat the upgrade process if it was already done.
 *
