...
typedef struct {
  ...
  secbool header_present; /**< True if a header structure was
                               found and passed basic checks. */

  secbool firmware_present; /**< True if a valid, bootable
firmware image is present. */

  secbool firmware_present_backup; /**< True if a valid, bootable
