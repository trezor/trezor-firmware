...
typedef enum {
  ...
  // === ext-flash (26000–26999) ===
  PRODTEST_ERR_EXT_FLASH_ERASE_SECTOR    = 26010,
  PRODTEST_ERR_EXT_FLASH_ERASE_BLOCK     = 26011,
  PRODTEST_ERR_EXT_FLASH_ERASE_CHIP      = 26012,
  PRODTEST_ERR_EXT_FLASH_ERASE_HALFBLOCK = 26030,
  // 26013 DEPRECATED (was PROGRAM_ADDR: page-alignment check removed)
  PRODTEST_ERR_EXT_FLASH_PROGRAM = 26014,
  PRODTEST_ERR_EXT_FLASH_READ = 26015,
  // 26016 DEPRECATED (was MMAP_ENABLE: mmap always active after init)
  PRODTEST_ERR_EXT_FLASH_TEST_INIT = 26017,
  PRODTEST_ERR_EXT_FLASH_TEST_DRV_STR_WRITE = 26018,
  PRODTEST_ERR_EXT_FLASH_TEST_DRV_STR_RESTORE = 26019,
  PRODTEST_ERR_EXT_FLASH_TEST_ERASE = 26020,
  // 26021 DEPRECATED (was TEST_VERIFY_ERASE_READ: erase verified via mmap now)
  PRODTEST_ERR_EXT_FLASH_TEST_VERIFY_ERASE_DATA = 26022,
  PRODTEST_ERR_EXT_FLASH_TEST_WRITE = 26023,
  PRODTEST_ERR_EXT_FLASH_TEST_PATTERN_INDIRECT = 26024,
  PRODTEST_ERR_EXT_FLASH_TEST_PATTERN_INDIRECT_DATA = 26025,
  PRODTEST_ERR_EXT_FLASH_TEST_PATTERN_MMAP_DATA = 26026,
  // 26027 DEPRECATED (was TEST_READ_MMAP_DATA: folded into 26026)
  PRODTEST_ERR_EXT_FLASH_TEST_READ_SLOW = 26028,
  PRODTEST_ERR_EXT_FLASH_TEST_READ_SLOW_DATA = 26029,
