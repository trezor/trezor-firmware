...
typedef enum {
  ...
  // PRODTEST_ERR_TROPIC_UPDATE_NO_REVISION = 20076,  DEPRECATED
  // PRODTEST_ERR_TROPIC_UPDATE_REBOOT_MAINTENANCE = 20077,  DEPRECATED
  PRODTEST_ERR_TROPIC_UPDATE_FW = 20078,
  // PRODTEST_ERR_TROPIC_UPDATE_REBOOT_APP = 20079,  DEPRECATED
  ...
  PRODTEST_ERR_TROPIC_LOCK_CHECK_FW_READ = 20160,
  PRODTEST_ERR_TROPIC_UPDATE_FW_SESSION = 20161,
  PRODTEST_ERR_TROPIC_UPDATE_FW_SLOT = 20162,
  ...
  PRODTEST_ERR_NFC_BACKUP_PSK_EXCHANGE_FAILED = 26013,
  PRODTEST_ERR_NFC_BACKUP_NOISE_FAILED = 26014,
  PRODTEST_ERR_NFC_BACKUP_HANDSHAKE_FAILED = 26015,
  PRODTEST_ERR_NFC_BACKUP_AUTHENTICATE_FAILED = 26016,
  PRODTEST_ERR_NFC_BACKUP_SET_PIN_FAILED = 26017,
  PRODTEST_ERR_NFC_BACKUP_WIPE_FAILED = 26018,
  PRODTEST_ERR_NFC_BACKUP_READ_PIN_COUNTER_FAILED = 26019,
  PRODTEST_ERR_NFC_BACKUP_READ_SUCCESS_LOG_FAILED = 26020,
  PRODTEST_ERR_NFC_BACKUP_READ_FAILURE_LOGS_FAILED = 26021,
  PRODTEST_ERR_NFC_BACKUP_READ_SEED_METADATA_FAILED = 26022,
  PRODTEST_ERR_NFC_BACKUP_WRITE_SEED_METADATA_FAILED = 26023,
  PRODTEST_ERR_NFC_BACKUP_READ_SEED_FAILED = 26024,
  PRODTEST_ERR_NFC_BACKUP_WRITE_SEED_FAILED = 26025,
  PRODTEST_ERR_NFC_BACKUP_ACTIVATE_FLASHLOADER_FAILED = 26026,
  PRODTEST_ERR_NFC_BACKUP_ENCRYPTION_FAILED = 26027,
