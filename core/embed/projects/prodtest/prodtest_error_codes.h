...
typedef enum {
  ...
  PRODTEST_ERR_NFC_READ_CARD_START = 7011,
  PRODTEST_ERR_NFC_READ_ACTIVATION = 7012,
  PRODTEST_ERR_NFC_READ_CARD_TIMEOUT = 7013,
  PRODTEST_ERR_NFC_READ_CARD_ERROR = 7014,
  PRODTEST_ERR_NFC_UNEXPECTED_TYPE = 7015,
  PRODTEST_ERR_NFC_UNEXPECTED_IF = 7016,
  PRODTEST_ERR_NFC_WRITE_CARD_INIT = 7017,
  PRODTEST_ERR_NFC_WRITE_CARD_START = 7018,
  PRODTEST_ERR_NFC_WRITE_ACTIVATION = 7019,
  PRODTEST_ERR_NFC_WRITE_CARD_TIMEOUT = 7020,
  PRODTEST_ERR_NFC_WRITE_CARD_ERROR = 7021,
  PRODTEST_ERR_NFC_WRITE_TYPE_A_ONLY = 7022,
  PRODTEST_ERR_NFC_CLI_CARD_INIT = 7023,
  PRODTEST_ERR_NFC_CLI_ACTIVATION = 7024,
  PRODTEST_ERR_NFC_CLI_CARD_START = 7025,
  PRODTEST_ERR_NFC_CLI_CARD_ERROR = 7026,
  PRODTEST_ERR_NFC_NOISE_CARD_INIT = 7027,
  PRODTEST_ERR_NFC_NOISE_CARD_START = 7028,
  PRODTEST_ERR_NFC_NOISE_ACTIVATION = 7029,
  PRODTEST_ERR_NFC_NOISE_CARD_TIMEOUT = 7030,
  PRODTEST_ERR_NFC_NOISE_CARD_ERROR = 7031,
  PRODTEST_ERR_NFC_NOISE_HANDSHAKE = 7032,
  PRODTEST_ERR_NFC_NDEF_CARD_INIT = 7033,
  PRODTEST_ERR_NFC_NDEF_ACTIVATION = 7034,
  PRODTEST_ERR_NFC_NDEF_CARD_START = 7035,
  PRODTEST_ERR_NFC_NDEF_CARD_TIMEOUT = 7036,
  PRODTEST_ERR_NFC_NDEF_CARD_ERROR = 7037,
