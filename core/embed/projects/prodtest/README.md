...
### telemetry-read
Retrieves stored telemetry data, including minimum and maximum recorded battery temperatures, battery error flags, battery cycle count, and Tropic alarm count.

Response format:
`OK <min_temp_c> <max_temp_c> <battery_errors> <battery_cycles> <tropic_alarms>`
