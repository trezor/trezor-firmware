...
// Os implementation of the random buffer function defined in rand.h
// and further used in TRZ_Crypto.
...
//   if (len % 4 != 0) {
//     uint32_t last_word;
//     rng_get_word(&last_word);
//     memcpy(buf + full_words * 4, &last_word, len % 4);
//   }
// }
