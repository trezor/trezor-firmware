...
#define st25r500VDDDROn()            st25r500SetRegisterBits( ST25R500_REG_OPERATION, (ST25R500_REG_OPERATION_vdddr_en) )

/*! Disables the VDD_DR regulator                                         */
#define st25r500VDDDROff()           st25r500ClrRegisterBits( ST25R500_REG_OPERATION, (ST25R500_REG_OPERATION_vdddr_en) )
...
/*! Checks if External Field is detected by reading ST25R500 External Field Detector output    */
 ...
 *
 *  \param[out] result:  result of RF measurement (unsigned). Approx 18.4mV/unit
 *
 ...
 *  \brief  Get Ce gain
 *
 *  This function retrieves an RFI indicator
 ...
 *  vectorial angle
 *
 *  \param[out] res: value is between 0 and 255. The inverval of (0;255]
 *  being eqivalent to (0; 2*pi]
 *
 *  \return RFAL_ERR_PARAM : Invalid parameter
 *  \return RFAL_ERR_NONE  : No error
 *
...
/*!
 *****************************************************************************
 * \brief  Diagnostic Measurement Prefix
 *
 * Part of st25r500DiagMeasure(). 
 * Can be called separately to perform each step individually|optimized
 * Sequence: Prefix() -> (multiple) Infix() -> PostFix() 
 *
 * \param[in]   meas: the measurement function to perform, see ST25R500_DIAG_MEAS_*
 *
 * \return RFAL_ERR_WRONG_STATE : Measurement could not be performed (e.g. en=0)
...
ReturnCode st25r500DiagMeasurePrefix( uint8_t meas );
 ...
 /*!
 *****************************************************************************
 * \brief  Diagnostic Measurement Infix
 *
 * Part of st25r500DiagMeasure(). 
 * Can be called separately to perform each step individually|optimized
 * Sequence: Prefix() -> (multiple) Infix() -> PostFix() 
...
ReturnCode st25r500DiagMeasureInfix( uint16_t *res );
 ...
 /*!
 *****************************************************************************
 * \brief  Diagnostic Measurement st25r500DiagMeasurePostfix
 *
 * Part of st25r500DiagMeasure(). 
 * Can be called separately to perform each step individually|optimized
 * Sequence: Prefix() -> (multiple) Infix() -> PostFix() 
