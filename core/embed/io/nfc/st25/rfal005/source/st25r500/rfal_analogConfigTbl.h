...
const uint8_t rfalAnalogConfigDefaultSettings[] = {
    ...
    MODE_ENTRY_17_REG( (RFAL_ANALOG_CONFIG_TECH_CHIP | RFAL_ANALOG_CONFIG_CHIP_INIT)
                        ...
                        , (RFAL_TEST_REG | ST25R500_TEST_REG_OSC_TIMING), ST25R500_TEST_REG_OSC_TIMING_wait_ok_count_set_mask, 0x3E                   /* high wait_ok_count_set for best wake-up stability */
    ...
    , MODE_ENTRY_11_REG( (RFAL_ANALOG_CONFIG_TECH_CHIP | RFAL_ANALOG_CONFIG_CHIP_POLL_COMMON)
