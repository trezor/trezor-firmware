...
void st25r500ledEvtIrq( uint32_t irqs )
{
    ...
    if( (irqs & (ST25R500_IRQ_MASK_RXS | ST25R500_IRQ_MASK_SUBC_START | ST25R500_IRQ_MASK_NFCT) ) != 0U )
    {
        st25r500ledRxOn();
    }
    
    if( ((irqs & (ST25R500_IRQ_MASK_RXE | ST25R500_IRQ_MASK_NRE | ST25R500_IRQ_MASK_RX_REST | ST25R500_IRQ_MASK_RXE_CE) ) != 0U ) ) 
    {
        st25r500ledRxOff();
    }
