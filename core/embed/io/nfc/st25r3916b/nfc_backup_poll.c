...
void nfc_backup_poll_deinit(){
    syshandle_unregister(SYSHANDLE_NFC_BACKUP);
}
...
static bool nfc_backup_fsm_update(nfc_backup_fsm_t* fsm, nfc_backup_state_t* new_state) {
