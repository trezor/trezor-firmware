...
#if ((RFAL_FEATURE_ISO_DEP_IBLOCK_MAX_LEN > 4096) || \
     (RFAL_FEATURE_ISO_DEP_IBLOCK_MAX_LEN < 16))
#error \
...
#error \
    " RFAL: Invalid ISO-DEP APDU Max length. Please change RFAL_FEATURE_ISO_DEP_APDU_MAX_LEN. "
#endif
...
#define ISODEP_PCB_IB_VALID_MASK \
  (ISODEP_PCB_B6_BIT |           \
   ISODEP_PCB_B2_BIT) /*!< Bit mask for the MUST bits on I-Block    */
...
#define ISODEP_PCB_RB_VALID_VAL \
  (ISODEP_PCB_B6_BIT |          \
   ISODEP_PCB_B2_BIT) /*!< Value for the MUST bits on R-Block       */
...
#define ISODEP_PCB_DID_BIT                                                  \
  (0x08U) /*!< Bit mask for the DID presence bit of an ISO DEP I,S,R Blocks \
             PCB.    */
#define ISODEP_PCB_NAD_BIT                                                     \
  (0x04U) /*!< Bit mask for the NAD presence bit of an ISO DEP I,S,R Blocks in \
             PCB  */
#define ISODEP_PCB_BN_MASK \
  (0x01U) /*!< Bit mask for the block number of an ISO DEP I,R Block in PCB */

#define ISODEP_SWTX_PL_MASK                                                \
  (0xC0U) /*!< Bit mask for the Power Level bits of the inf byte of an WTX \
             request or response */
#define ISODEP_SWTX_WTXM_MASK                                                  \
  (0x3FU) /*!< Bit mask for the WTXM bits of the inf byte of an WTX request or \
             response        */

#define ISODEP_RBLOCK_INF_LEN \
  (0U) /*!< INF length of R-Block               Digital 1.1 15.1.3 */
#define ISODEP_SDSL_INF_LEN \
  (0U) /*!< INF length of S(DSL)                Digital 1.1 15.1.3 */
#define ISODEP_SWTX_INF_LEN \
  (1U) /*!< INF length of S(WTX)                Digital 1.1 15.2.2 */

#define ISODEP_WTXM_MIN \
  (1U) /*!< Minimum allowed value for the WTXM, Digital 1.0 13.2.2 */
#define ISODEP_WTXM_MAX \
  (59U) /*!< Maximum allowed value for the WTXM, Digital 1.0 13.2.2 */

#define ISODEP_PCB_Sxx_MASK \
  (0x30U) /*!< Bit mask for the S-Block type                          */
#define ISODEP_PCB_DESELECT \
  (0x00U) /*!< Bit mask for S-Block indicating Deselect               */
#define ISODEP_PCB_WTX \
  (0x30U) /*!< Bit mask for S-Block indicating Waiting Time eXtension */
...
#define ISODEP_CONTROLMSG_BUF_LEN                                    \
  (RFAL_ISODEP_PCB_LEN + RFAL_ISODEP_DID_LEN + RFAL_ISODEP_NAD_LEN + \
   ISODEP_SWTX_PARAM_LEN)

#define ISODEP_FWT_DEACTIVATION \
  (71680U) /*!< FWT used for DESELECT  Digital 2.2 B10  ISO1444-4 7.2 & 8.1 */
#define ISODEP_MAX_RERUNS \
  (0x0FFFFFFFU) /*!< Maximum rerun retrys for a blocking protocol run*/

#define ISODEP_PCBSBLOCK       \
  (0x00U | ISODEP_PCB_SBLOCK | \
   ISODEP_PCB_B2_BIT) /*!< PCB Value of a S-Block                 */
#define ISODEP_PCB_SDSL \
  (ISODEP_PCBSBLOCK |   \
   ISODEP_PCB_DESELECT) /*!< PCB Value of a S-Block with DESELECT   */
#define ISODEP_PCB_SWTX \
  (ISODEP_PCBSBLOCK | ISODEP_PCB_WTX) /*!< PCB Value of a S-Block with WTX */
#define ISODEP_PCB_SPARAMETERS \
  (ISODEP_PCB_SBLOCK |         \
   ISODEP_PCB_WTX) /*!< PCB Value of a S-Block with PARAMETERS */
...
#define RFAL_ISODEP_SPARAM_TVL_HDR_LEN \
  (2U) /*!< S(PARAMETERS) TVL header length: Tag + Len */
#define RFAL_ISODEP_SPARAM_HDR_LEN                                             \
  (RFAL_ISODEP_PCB_LEN +                                                       \
   RFAL_ISODEP_SPARAM_TVL_HDR_LEN) /*!< S(PARAMETERS) header length: PCB + Tag \
                                      + Len */

/**********************************************************************************************************************/
/**********************************************************************************************************************/
#define RFAL_ISODEP_NO_PARAM \
  (0U) /*!< No parameter flag for rfalIsoDepHandleControlMsg() */

#define RFAL_ISODEP_CMD_RATS \
  (0xE0U) /*!< RATS command   Digital 1.1  13.6.1                 */

#define RFAL_ISODEP_ATS_MIN_LEN \
  (1U) /*!< Minimum ATS length   Digital 1.1  13.6.2 */
#define RFAL_ISODEP_ATS_HDR_LEN \
  (5U) /*!< ATS headerlength     Digital 1.1  13.6.2 */
...
#define RFAL_ISODEP_ATS_T0_FSCI_MASK \
  (0x0FU) /*!< ATS T0's FSCI mask   Digital 1.1  13.6.2 */
#define RFAL_ISODEP_ATS_TB_FWI_SHIFT \
  (4U) /*!< ATS TB's FWI shift   Digital 1.1  13.6.2 */
#define RFAL_ISODEP_ATS_FWI_MASK \
  (0x0FU) /*!< ATS TB's FWI shift   Digital 1.1  13.6.2 */
#define RFAL_ISODEP_ATS_TL_POS \
  (0x00U) /*!< ATS TL's position    Digital 1.1  13.6.2 */

#define RFAL_ISODEP_PPS_SB \
  (0xD0U) /*!< PPS REQ PPSS's SB value (no CID)   ISO14443-4  5.3 */
#define RFAL_ISODEP_PPS_MASK \
  (0xF0U) /*!< PPS REQ PPSS's SB mask             ISO14443-4  5.3 */
...
#define RFAL_ISODEP_PPS_PPS1 \
  (0x00U) /*!< PPS REQ PPS1 fixed value           ISO14443-4  5.3 */
...
#define RFAL_ISODEP_PPS_RES_LEN \
  (1U) /*!< PPS Response length                ISO14443-4  5.4 */
#define RFAL_ISODEP_PPS_STARTBYTE_POS \
  (0U) /*!< PPS REQ PPSS's byte position       ISO14443-4  5.4 */
#define RFAL_ISODEP_PPS_PPS0_POS \
  (1U) /*!< PPS REQ PPS0's byte position       ISO14443-4  5.4 */
#define RFAL_ISODEP_PPS_PPS1_POS \
  (2U) /*!< PPS REQ PPS1's byte position       ISO14443-4  5.4 */
#define RFAL_ISODEP_PPS0_VALID_MASK \
  (0xEFU) /*!< PPS REQ PPS0 valid coding mask     ISO14443-4  5.4 */

#define RFAL_ISODEP_CMD_ATTRIB \
  (0x1DU) /*!< ATTRIB command                 Digital 1.1  14.6.1 */
#define RFAL_ISODEP_ATTRIB_PARAM2_DSI_SHIFT \
  (6U) /*!< ATTRIB PARAM2 DSI_dep shift        Digital 1.1  14.6.1 */
...
#define RFAL_ISODEP_ATTRIB_HDR_LEN \
  (9U) /*!< ATTRIB REQ header length       Digital 1.1  14.6.1 */
...
#define RFAL_ISODEP_DID_MASK \
  (0x0FU) /*!< ISODEP's DID mask                                  */
#define RFAL_ISODEP_DID_00 \
  (0U) /*!< ISODEP's DID value 0                               */

#define RFAL_ISODEP_FSDI_MAX_NFC \
  (8U) /*!< Max FSDI value   Digital 2.0  14.6.1.9 & B7 & B8   */
#define RFAL_ISODEP_FSDI_MAX_NFC_21 \
  (0x0CU) /*!< Max FSDI value   Digital 2.1  14.6.1.9 & Table 72  */
#define RFAL_ISODEP_FSDI_MAX_EMV \
  (0x0CU) /*!< Max FSDI value   EMVCo 3.0  5.7.2.5                */
...
#define RFAL_ISODEP_ATS_TC_ADV_FEAT                                            \
  (0x10U) /*!< Bit mask indicating support for Advanced protocol features: DID \
             & NAD */
#define RFAL_ISODEP_ATS_TC_DID \
  (0x02U) /*!< Bit mask indicating support for DID                 */
#define RFAL_ISODEP_ATS_TC_NAD \
  (0x01U) /*!< Bit mask indicating support for NAD                 */
...
#define RFAL_ISODEP_PPS1_DSI_MASK \
  (0x0CU) /*!< PPS1 byte DSI_dep mask bits                              */
#define RFAL_ISODEP_PPS1_DSI_SHIFT \
  (2U) /*!< PPS1 byte DSI_dep shift                                  */
#define RFAL_ISODEP_PPS1_DxI_MASK \
  (0x03U) /*!< PPS1 byte DSI_dep/DRS mask bits                          */

/*! Delta Time for polling during Activation (ATS) : 20ms Digital 1.0 11.7.1.1 &
 * A.7    */
#define RFAL_ISODEP_T4T_DTIME_POLL_10 rfalConvMsTo1fc(20)

/*! Delta Time for polling during Activation (ATS) : 16.4ms Digital 1.1 13.8.1.1
 * & A.6 Use 16 ms as testcase T4AT_BI_10_03 sends a frame exactly at the border
 */
...
#define rfalIsoDep_PCBisIBlock(pcb)                                 \
  (((pcb) & (ISODEP_PCB_xBLOCK_MASK | ISODEP_PCB_IB_VALID_MASK)) == \
   (ISODEP_PCB_IBLOCK |                                             \
    ISODEP_PCB_IB_VALID_VAL)) /*!< Checks if pcb is a I-Block */
#define rfalIsoDep_PCBisRBlock(pcb)                                 \
  (((pcb) & (ISODEP_PCB_xBLOCK_MASK | ISODEP_PCB_RB_VALID_MASK)) == \
   (ISODEP_PCB_RBLOCK |                                             \
    ISODEP_PCB_RB_VALID_VAL)) /*!< Checks if pcb is a R-Block */
#define rfalIsoDep_PCBisSBlock(pcb)                                 \
  (((pcb) & (ISODEP_PCB_xBLOCK_MASK | ISODEP_PCB_SB_VALID_MASK)) == \
   (ISODEP_PCB_SBLOCK |                                             \
    ISODEP_PCB_SB_VALID_VAL)) /*!< Checks if pcb is a S-Block */

#define rfalIsoDep_PCBisChaining(pcb)   \
  (((pcb) & ISODEP_PCB_CHAINING_BIT) == \
   ISODEP_PCB_CHAINING_BIT) /*!< Checks if pcb is indicating chaining */

#define rfalIsoDep_PCBisDeselect(pcb) \
  (((pcb) & ISODEP_PCB_Sxx_MASK) ==   \
   ISODEP_PCB_DESELECT) /*!< Checks if pcb is indicating DESELECT         */
#define rfalIsoDep_PCBisWTX(pcb)    \
  (((pcb) & ISODEP_PCB_Sxx_MASK) == \
   ISODEP_PCB_WTX) /*!< Checks if pcb is indicating WTX              */

#define rfalIsoDep_PCBisACK(pcb)   \
  (((pcb) & ISODEP_PCB_Rx_MASK) == \
   ISODEP_PCB_ACK) /*!< Checks if pcb is indicating ACK              */
#define rfalIsoDep_PCBisNAK(pcb)   \
  (((pcb) & ISODEP_PCB_Rx_MASK) == \
   ISODEP_PCB_NAK) /*!< Checks if pcb is indicating ACK              */

#define rfalIsoDep_PCBhasDID(pcb)  \
  (((pcb) & ISODEP_PCB_DID_BIT) == \
   ISODEP_PCB_DID_BIT) /*!< Checks if pcb is indicating DID              */
#define rfalIsoDep_PCBhasNAD(pcb)  \
  (((pcb) & ISODEP_PCB_NAD_BIT) == \
   ISODEP_PCB_NAD_BIT) /*!< Checks if pcb is indicating NAD              */

#define rfalIsoDep_PCBisIChaining(pcb) \
  (rfalIsoDep_PCBisIBlock(pcb) &&      \
   rfalIsoDep_PCBisChaining(           \
       pcb)) /*!< Checks if pcb is I-Block indicating chaining */

#define rfalIsoDep_PCBisSDeselect(pcb) \
  (rfalIsoDep_PCBisSBlock(pcb) &&      \
   rfalIsoDep_PCBisDeselect(           \
       pcb)) /*!< Checks if pcb is S-Block indicating DESELECT */
#define rfalIsoDep_PCBisSWTX(pcb) \
  (rfalIsoDep_PCBisSBlock(pcb) && \
   rfalIsoDep_PCBisWTX(pcb)) /*!< Checks if pcb is S-Block indicating WTX */

#define rfalIsoDep_PCBisRACK(pcb) \
  (rfalIsoDep_PCBisRBlock(pcb) && \
   rfalIsoDep_PCBisACK(pcb)) /*!< Checks if pcb is R-Block indicating ACK */
#define rfalIsoDep_PCBisRNAK(pcb) \
  (rfalIsoDep_PCBisRBlock(pcb) && \
   rfalIsoDep_PCBisNAK(pcb)) /*!< Checks if pcb is R-Block indicating NAK */

#define rfalIsoDep_PCBIBlock(bn)                                            \
  ((uint8_t)(0x00U | ISODEP_PCB_IBLOCK | ISODEP_PCB_B2_BIT |                \
             ((bn) & ISODEP_PCB_BN_MASK))) /*!< Returns an I-Block with the \
                                              given block number (bn) */
#define rfalIsoDep_PCBIBlockChaining(bn)                                      \
  ((uint8_t)(rfalIsoDep_PCBIBlock(bn) |                                       \
             ISODEP_PCB_CHAINING_BIT)) /*!< Returns an I-Block with the given \
                                          block number (bn) indicating        \
                                          chaining */

#define rfalIsoDep_PCBRBlock(bn)                                            \
  ((uint8_t)(0x00U | ISODEP_PCB_RBLOCK | ISODEP_PCB_B6_BIT |                \
             ISODEP_PCB_B2_BIT |                                            \
             ((bn) & ISODEP_PCB_BN_MASK))) /*!< Returns an R-Block with the \
                                              given block number (bn) */
#define rfalIsoDep_PCBRACK(bn)                                             \
  ((uint8_t)(rfalIsoDep_PCBRBlock(bn) |                                    \
             ISODEP_PCB_ACK)) /*!< Returns an R-Block with the given block \
                                 number (bn) indicating ACK */
#define rfalIsoDep_PCBRNAK(bn)                                             \
  ((uint8_t)(rfalIsoDep_PCBRBlock(bn) |                                    \
             ISODEP_PCB_NAK)) /*!< Returns an R-Block with the given block \
                                 number (bn) indicating NAK */

#define rfalIsoDep_GetBN(pcb)                                                \
  ((uint8_t)((pcb) & ISODEP_PCB_BN_MASK)) /*!< Returns the block number (bn) \
                                             from the given pcb */
#define rfalIsoDep_GetWTXM(inf)                                              \
  ((uint8_t)((inf) & ISODEP_SWTX_WTXM_MASK)) /*!< Returns the WTX value from \
                                                the given inf byte */
#define rfalIsoDep_isWTXMValid(wtxm) \
  (((wtxm) >= ISODEP_WTXM_MIN) &&    \
   ((wtxm) <= ISODEP_WTXM_MAX)) /*!< Checks if the given wtxm is valid */

#define rfalIsoDep_WTXMListenerMax(fwt)                                        \
  (RFAL_MIN((uint8_t)(ISODEP_FWT_LIS_MAX / (fwt)),                             \
            ISODEP_WTXM_MAX)) /*!< Calculates the Max WTXM value for the given \
                                 fwt as a Listener    */

#define rfalIsoDepCalcdSGFT(s)                                             \
  (384U * ((uint32_t)1U << (s))) /*!< Calculates the dSFGT with given SFGI \
                                    Digital 1.1  13.8.2.1 & A.6*/
#define rfalIsoDepCalcSGFT(s) \
  (4096U *                    \
   ((uint32_t)1U              \
    << (s))) /*!< Calculates the SFGT with given SFGI  Digital 1.1  13.8.2 */

#define rfalIsoDep_PCBNextBN(bn)                                             \
  (((uint8_t)(bn) ^ 0x01U) &                                                 \
   ISODEP_PCB_BN_MASK) /*!< Returns the value of the next block number based \
                          on bn           */
#define rfalIsoDep_PCBPrevBN(bn) \
  rfalIsoDep_PCBNextBN(          \
      bn) /*!< Returns the value of the previous block number based on bn   */
#define rfalIsoDep_ToggleBN(bn)                                                \
  ((bn) = (((bn) ^ 0x01U) & ISODEP_PCB_BN_MASK)) /*!< Toggles the block number \
                                                    value of the given bn */

#define rfalIsoDep_WTXAdjust(v)                                                \
  ((v) - ((v) >> 3)) /*!< Adjust WTX timer value to a percentage of the total, \
                        current 88% */

/*! ISO 14443-4 7.5.6.2 & Digital 1.1 - 15.2.6.2  The CE SHALL NOT attempt error
 * recovery and remains in Rx mode upon Transmission or a Protocol Error */
#define rfalIsoDepReEnableRx(rxB, rxBL, rxL)                                 \
  rfalTransceiveBlockingTx(NULL, 0, rxB, rxBL, rxL, RFAL_TXRX_FLAGS_DEFAULT, \
                           RFAL_FWT_NONE)

#define rfalIsoDepTimerStart(timer, time_ms)            \
  do {                                                  \
    platformTimerDestroy(timer);                        \
    (timer) = platformTimerCreate((uint16_t)(time_ms)); \
  } while (0) /*!< Configures and starts the WTX timer  */
#define rfalIsoDepTimerisExpired(timer) \
  platformTimerIsExpired(timer) /*!< Checks WTX timer has expired */
#define rfalIsoDepTimerDestroy(timer) \
...
typedef struct {
  ...
  union { /*  PRQA S 0750 # MISRA 19.2 - Members of the union will not be used
             concurrently, only one frame at a time */
...
static ReturnCode rfalIsoDepTx(uint8_t pcb, const uint8_t *txBuf,
                               uint8_t *infBuf, uint16_t infLen, uint32_t fwt);
static ReturnCode rfalIsoDepHandleControlMsg(rfalIsoDepControlMsg controlMsg,
                                             uint8_t param);
static void rfalIsoDepApdu2IBLockParam(rfalIsoDepApduTxRxParam apduParam,
                                       rfalIsoDepTxRxParam *iBlockParam,
                                       uint16_t txPos, uint16_t rxPos);

#if RFAL_FEATURE_ISO_DEP_POLL
static ReturnCode rfalIsoDepDataExchangePCD(uint16_t *outActRxLen,
                                            bool *outIsChaining);
static void rfalIsoDepCalcBitRate(rfalBitRate maxAllowedBR,
                                  uint8_t piccBRCapability, rfalBitRate *dsi,
                                  rfalBitRate *dri);
static uint32_t rfalIsoDepSFGI2SFGT(uint8_t sfgi);

#if RFAL_FEATURE_NFCA
static ReturnCode rfalIsoDepStartRATS(rfalIsoDepFSxI FSDI, uint8_t DID,
                                      rfalIsoDepAts *ats, uint8_t *atsLen);
static ReturnCode rfalIsoDepGetRATSStatus(void);
static ReturnCode rfalIsoDepStartPPS(uint8_t DID, rfalBitRate DSI_dep,
                                     rfalBitRate DRI, rfalIsoDepPpsRes *ppsRes);
static ReturnCode rfalIsoDepGetPPSSTatus(void);
#endif /* RFAL_FEATURE_NFCA */

#if RFAL_FEATURE_NFCB
static ReturnCode rfalIsoDepStartATTRIB(const uint8_t *nfcid0, uint8_t PARAM1,
                                        rfalBitRate DSI_dep, rfalBitRate DRI,
                                        rfalIsoDepFSxI FSDI, uint8_t PARAM3,
                                        uint8_t DID, const uint8_t *HLInfo,
                                        uint8_t HLInfoLen, uint32_t fwt,
...
static ReturnCode rfalIsoDepTx(uint8_t pcb, const uint8_t *txBuf,
  ...
  if (infLen > 0U) {
    if (((uintptr_t)infBuf - (uintptr_t)txBuf) <
        gIsoDep
            .hdrLen) /* Check that we can fit the header in the given space */
    {
  ...
  if (((gIsoDep.did != RFAL_ISODEP_NO_DID) &&
       (gIsoDep.did != RFAL_ISODEP_DID_00)) ||
  ...
  if ((gIsoDep.isTxChaining) && (rfalIsoDep_PCBisIBlock(computedPcb))) {
    computedPcb |= ISODEP_PCB_CHAINING_BIT;
  }

  /*******************************************************************************/
  /* Compute Payload on the given txBuf, start by the PCB | DID | NAD | before
   * INF */
  ...
  *(--txBlock) = computedPcb; /* PCB always present */
  ...
  txBufLen =
      (infLen +
       (uint16_t)((uintptr_t)infBuf -
                  (uintptr_t)txBlock)); /* Calculate overall buffer size */

  if (txBufLen >
      (gIsoDep.fsx - ISODEP_CRC_LEN)) /* Check if msg length violates the
                                         maximum frame size FSC */
  {
    return RFAL_ERR_NOTSUPP;
  }

  rfalCreateByteFlagsTxRxContext(
      ctx, txBlock, txBufLen, gIsoDep.rxBuf, gIsoDep.rxBufLen, gIsoDep.rxLen,
  ...
  switch (controlMsg) {
    ...
    case ISODEP_R_ACK:
      ...
      if (gIsoDep.cntRRetrys++ > gIsoDep.maxRetriesR) {
        return RFAL_ERR_TIMEOUT; /* NFC Forum mandates timeout or transmission
                                    error depending on previous errors */
      }
    ...
    case ISODEP_R_NAK:
      ...
      if ((gIsoDep.cntRRetrys++ >
           gIsoDep.maxRetriesR) || /* Max R Block retries reached */
          (gIsoDep.cntSWtxNack >=
           gIsoDep.maxRetriesSnWTX)) /* Max number PICC is allowed to respond
                                        with S(WTX) to R(NAK) */
      {
    ...
    case ISODEP_S_WTX:
      ...
      pcb = ISODEP_PCB_SWTX;
      gIsoDep.ctrlBuf[RFAL_ISODEP_PCB_LEN + RFAL_ISODEP_DID_LEN + infLen++] =
          param;
      break;
...
void rfalIsoDepInitializeWithParams(rfalComplianceMode compMode,
                                    ...
                                    uint8_t maxRetriesSDSL, uint8_t maxRetriesI,
...
static ReturnCode rfalIsoDepDataExchangePCD(uint16_t *outActRxLen,
  ...
  *outIsChaining = false;
  ...
  /* Calculate header required and check if the buffers InfPositions are
   * suitable */
  gIsoDep.hdrLen = RFAL_ISODEP_PCB_LEN;
  if ((gIsoDep.did != RFAL_ISODEP_NO_DID) &&
      (gIsoDep.did != RFAL_ISODEP_DID_00)) {
  ...
  /* Check if there is enough space before the infPos to append ISO-DEP headers
   * on rx and tx */
  if ((gIsoDep.rxBufInfPos < gIsoDep.hdrLen) ||
      (gIsoDep.txBufInfPos < gIsoDep.hdrLen)) {
    return RFAL_ERR_PARAM;
  }
  ...
  switch (gIsoDep.state) {
    ...
    case ISODEP_ST_PCD_TX:
      ret = rfalIsoDepTx(rfalIsoDep_PCBIBlock(gIsoDep.blockNumber),
                         gIsoDep.txBuf, &gIsoDep.txBuf[gIsoDep.txBufInfPos],
                         gIsoDep.txBufLen, (gIsoDep.fwt + gIsoDep.dFwt));
      switch (ret) {
        case RFAL_ERR_NONE:
    ...
    /*******************************************************************************/
    case ISODEP_ST_PCD_WAIT_DSL: /*  PRQA S 2003 # MISRA 16.3 - Intentional fall
                                    through */
    case ISODEP_ST_PCD_RX:
      ...
      switch (ret) {
        ...
        case RFAL_ERR_CRC:
        case RFAL_ERR_PAR:
        case RFAL_ERR_FRAMING:         /* added to handle test cases scenario
                                          TC_POL_NFCB_T4AT_BI_82_x_y &
                                          TC_POL_NFCB_T4BT_BI_82_x_y */
        case RFAL_ERR_INCOMPLETE_BYTE: /* added to handle test cases scenario
                                          TC_POL_NFCB_T4AT_BI_82_x_y &
                                          TC_POL_NFCB_T4BT_BI_82_x_y */

          if (gIsoDep.isRxChaining) { /* Rule 5 - In PICC chaining when a
                                         invalid/timeout occurs -> R-ACK */
            RFAL_EXIT_ON_ERR(ret, rfalIsoDepHandleControlMsg(
                                      ISODEP_R_ACK, RFAL_ISODEP_NO_PARAM));
          } else if (gIsoDep.state ==
                     ISODEP_ST_PCD_WAIT_DSL) { /* Rule 8 - If s-Deselect
                                                  response fails MAY retransmit
                                                */
            RFAL_EXIT_ON_ERR(ret, rfalIsoDepHandleControlMsg(
      ...
      if ((gIsoDep.compMode == RFAL_COMPLIANCE_MODE_EMV) &&
          (rfalIsoDep_PCBhasDID(rxPCB) || rfalIsoDep_PCBhasNAD(rxPCB))) {
        return RFAL_ERR_PROTO;
      }

      /* If we are expecting DID, check if PCB signals its presence and if
       * device ID match*/
      if ((gIsoDep.did != RFAL_ISODEP_NO_DID) &&
          (gIsoDep.did != RFAL_ISODEP_DID_00) &&
          ((!rfalIsoDep_PCBhasDID(rxPCB)) ||
           (gIsoDep.did != gIsoDep.rxBuf[ISODEP_DID_POS]))) {
        return RFAL_ERR_PROTO;
      }
      ...
      if (rfalIsoDep_PCBisSBlock(rxPCB)) {
        ...
        if (rfalIsoDep_PCBisSWTX(rxPCB)) {
          /* Check if PICC has requested S(WTX) as response to R(NAK)
           * EMVCo 3.0 10.3.5.5 / Digital 2.0  16.2.6.5 */
          if (rfalIsoDep_PCBisRNAK(gIsoDep.lastPCB)) {
            gIsoDep.cntSWtxNack++; /* Count S(WTX) upon R(NAK) */
            gIsoDep.cntRRetrys =
                0; /* Reset R-Block counter has PICC has responded */
          } else {
           ...
           */
          RFAL_EXIT_ON_ERR(
              ret, rfalIsoDepHandleControlMsg(
                       ISODEP_S_WTX,
                       rfalIsoDep_GetWTXM(gIsoDep.rxBuf[gIsoDep.hdrLen])));
          return RFAL_ERR_BUSY;
        }
      ...
      /*******************************************************************************/
        ...
        {
          if (rfalIsoDep_GetBN(rxPCB) ==
              gIsoDep.blockNumber) /* Expected block number  */
          {
            ...
            /* EMVCo 3.0 10.3.4.3 -  PCD may re-transmit the last I-Block or
             * report error */
            ...
            return RFAL_ERR_TIMEOUT; /* NFC Forum mandates timeout or
                                        transmission error depending on previous
                                        errors */
          }
        ...
        if (rfalIsoDep_PCBisChaining(rxPCB)) {
          ...
          *outIsChaining = true;
          ...
          if (rfalIsoDep_GetBN(rxPCB) == gIsoDep.blockNumber) {
            ...
            rfalIsoDepClearCounters(); /* Clear counters in case R counter is
                                          already at max */
            ...
            /* remove ISO DEP header, check is necessary to move the INF data on
             * the buffer */
            *outActRxLen -= gIsoDep.hdrLen;
            if ((gIsoDep.hdrLen != gIsoDep.rxBufInfPos) &&
                (*outActRxLen > 0U)) {
              RFAL_MEMMOVE(&gIsoDep.rxBuf[gIsoDep.rxBufInfPos],
                           &gIsoDep.rxBuf[gIsoDep.hdrLen], *outActRxLen);
            }

            rfalIsoDepClearCounters();
            return RFAL_ERR_AGAIN; /* Send Again signalling to run again, but
                                      some chaining data has arrived */
          } else {
        ...
        if (rfalIsoDep_GetBN(rxPCB) == gIsoDep.blockNumber) {
          ...
          *outActRxLen -= gIsoDep.hdrLen;
          ...
          if ((gIsoDep.compMode != RFAL_COMPLIANCE_MODE_ISO)) {
            /* Invalid Block (not chaining) -> Raise error Digital 1.1  15.2.6.4
             * EMVCo 2.6  10.3.5.4 */
            return RFAL_ERR_PROTO;
          }
...
ReturnCode rfalIsoDepStartDeselect(void) {
  ...
  gIsoDep.rxBufLen =
      ISODEP_CONTROLMSG_BUF_LEN - (RFAL_ISODEP_PCB_LEN + RFAL_ISODEP_DID_LEN);
...
uint32_t rfalIsoDepFWI2FWT(uint8_t fwi) {
  ...
  result = RFAL_MIN(RFAL_ISODEP_MAX_FWT,
                    result); /* Maximum Frame Waiting Time must be fulfilled */
...
uint16_t rfalIsoDepFSxI2FSx(uint8_t FSxI) {
  ...
  fsi = ((gIsoDep.compMode == RFAL_COMPLIANCE_MODE_EMV)
             ? RFAL_MIN(FSxI, RFAL_ISODEP_FSDI_MAX_EMV)
             : RFAL_MIN(FSxI, RFAL_ISODEP_FSDI_MAX_NFC));
...
bool rfalIsoDepIsRats(const uint8_t *buf, uint8_t bufLen) {
  if (buf != NULL) {
    if ((RFAL_ISODEP_CMD_RATS == (uint8_t)*buf) &&
        (sizeof(rfalIsoDepRats) == bufLen)) {
      return true;
    }
  }
  return false;
...
bool rfalIsoDepIsAttrib(const uint8_t *buf, uint8_t bufLen) {
  if (buf != NULL) {
    if ((RFAL_ISODEP_CMD_ATTRIB == (uint8_t)*buf) &&
        ...
        ((RFAL_ISODEP_ATTRIB_REQ_MIN_LEN + RFAL_ISODEP_ATTRIB_HLINFO_LEN) >=
         bufLen)) {
      return true;
    }
  }
...
ReturnCode rfalIsoDepListenStartActivation(
    ...
    const rfalIsoDepAttribResParam *attribResParam, const uint8_t *buf,
    uint16_t bufLen, rfalIsoDepListenActvParam actParam) {
  uint8_t *txBuf;
  uint8_t bufIt;
  ...
  bufIt = 0;
  txBuf = (uint8_t *)
              actParam.rxBuf; /* Use the rxBuf as TxBuf as well, the struct
                                 enforces a size enough RFAL_MAX(
                                 NFCA_ATS_MAX_LEN, NFCB_ATTRIB_RES_MAX_LEN ) */
  ...
  if (*buffer == RFAL_ISODEP_CMD_RATS) {
    ...
    if (actParam.isoDepDev != NULL) {
      RFAL_MEMCPY((uint8_t *)&actParam.isoDepDev->activation.A.Poller.RATS,
                  buffer, sizeof(rfalIsoDepRats)); /* Copy RATS' CMD + PARAM */
    }
    ...
    buffer++;
    gIsoDep.fsx =
        rfalIsoDepFSxI2FSx((((*buffer) & RFAL_ISODEP_RATS_PARAM_FSDI_MASK) >>
    ...
    if (!atsParam->didSupport) {
      gIsoDep.did =
          RFAL_ISODEP_NO_DID; /* Even if requested by PCD to use a certain DID,
                                 the ATS setting prevails */
    }
    ...
    txBuf[bufIt++] = ((RFAL_ISODEP_ATS_T0_TA_PRESENCE_MASK |
                       RFAL_ISODEP_ATS_T0_TB_PRESENCE_MASK |
    ...
    txBuf[bufIt++] = (uint8_t)((atsParam->didSupport) ? RFAL_ISODEP_ATS_TC_DID
                                                      : 0U); /* TC */
  ...
  if (actParam.isoDepDev != NULL) {
    ...
    actParam.isoDepDev->info.DSI_dep = gIsoDep.txBR;
    actParam.isoDepDev->info.DRI = gIsoDep.rxBR;
  }

  return rfalTransceiveBlockingTx(txBuf, bufIt, (uint8_t *)actParam.rxBuf,
                                  sizeof(rfalIsoDepBufFormat), actParam.rxLen,
                                  RFAL_TXRX_FLAGS_DEFAULT, RFAL_FWT_NONE);
}
...
ReturnCode rfalIsoDepListenGetActivationStatus(void) {
  ...
  switch (err) {
    ...
    case RFAL_ERR_BUSY:
    case RFAL_ERR_SLEEP_REQ: /* S(DSL) handled by lower layer should cause an
                                error reported */
      return err;
    ...
    case RFAL_ERR_FRAMING:
      ...
      /* ISO14443 4  5.6.2.2 2  If ATS has been replied upon a invalid block,
       * PICC disables the PPS responses */
      if (gIsoDep.state == ISODEP_ST_PICC_ACT_ATS) {
    ...
    default: /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through */
      ...
      rfalIsoDepReEnableRx((uint8_t *)gIsoDep.actvParam.rxBuf,
  ...
  txBuf =
      (uint8_t *)gIsoDep.actvParam
          .rxBuf; /* Use the rxBuf as TxBuf as well, the struct enforces a size
                     enough  RFAL_MAX(NFCA_PPS_RES_LEN, ISODEP_DSL_MAX_LEN) */
  dri = RFAL_BR_KEEP; /* The RFAL_BR_KEEP is used to check if PPS with BR change
                         was requested */
  ...
  if (gIsoDep.state == ISODEP_ST_PICC_ACT_ATS) {
    ...
    if ((((uint8_t *)gIsoDep.actvParam.rxBuf)[RFAL_ISODEP_PPS_STARTBYTE_POS] &
      ...
      if (((((uint8_t *)
                 gIsoDep.actvParam.rxBuf)[RFAL_ISODEP_PPS_STARTBYTE_POS] &
            RFAL_ISODEP_DID_MASK) != gIsoDep.did) ||
          ((((uint8_t *)gIsoDep.actvParam.rxBuf)[RFAL_ISODEP_PPS_PPS0_POS] &
            RFAL_ISODEP_PPS0_VALID_MASK) !=
           RFAL_ISODEP_PPS0_PPS1_NOT_PRESENT)) {
        /* Invalid DID on PPS request or Invalid PPS0, reEnable the receiver and
         * wait another frame */
        rfalIsoDepReEnableRx((uint8_t *)gIsoDep.actvParam.rxBuf,
                             sizeof(rfalIsoDepBufFormat),
                             gIsoDep.actvParam.rxLen);
      ...
      if (((uint8_t *)gIsoDep.actvParam.rxBuf)[RFAL_ISODEP_PPS_PPS0_POS] ==
        ...
        uint8_t newdsi =
            ...
            RFAL_ISODEP_PPS1_DxI_MASK; /* MISRA 10.8 */
        /* PRQA S 4342 2 # MISRA 10.5 - Layout of enum rfalBitRate and above
         * masks guarantee no invalid enum values to be created */
      ...
      txBuf[bufIt++] =
          ((uint8_t *)gIsoDep.actvParam.rxBuf)[RFAL_ISODEP_PPS_STARTBYTE_POS];

      rfalTransceiveBlockingTx(txBuf, bufIt, (uint8_t *)gIsoDep.actvParam.rxBuf,
                               sizeof(rfalIsoDepBufFormat),
                               gIsoDep.actvParam.rxLen, RFAL_TXRX_FLAGS_DEFAULT,
                               RFAL_FWT_NONE);
      ...
      if (dri != RFAL_BR_KEEP) {
        ...
        gIsoDep.txBR = dsi; /* DSI_dep codes the divisor from PICC to PCD */
        gIsoDep.rxBR = dri; /* DRI codes the divisor from PCD to PICC */

        if (gIsoDep.actvParam.isoDepDev != NULL) {
          gIsoDep.actvParam.isoDepDev->info.DSI_dep = dsi;
  ...
  /*******************************************************************************/
  gIsoDep.hdrLen = RFAL_ISODEP_PCB_LEN;
  gIsoDep.hdrLen += RFAL_ISODEP_DID_LEN; /* Always assume DID to be aligned with
                                            Digital 1.1  15.1.2 and ISO14443
                                            4 5.6.3    #454 */
  gIsoDep.hdrLen +=
      (uint8_t)((gIsoDep.nad != RFAL_ISODEP_NO_NAD) ? RFAL_ISODEP_NAD_LEN : 0U);

  /*******************************************************************************/
  /* Rule C - The PICC block number shall be initialized to 1 at activation */
  gIsoDep.blockNumber = 1;

  /* Activation done, keep the rcvd data in, reMap the activation buffer to the
   * global to be retrieved by the DEP method */
...
uint16_t rfalIsoDepGetMaxInfLen(void) {
  /* Check whether all parameters are valid, otherwise return minimum default
   * value */
  if ((gIsoDep.fsx < (uint16_t)RFAL_ISODEP_FSX_16) ||
      (gIsoDep.fsx > (uint16_t)RFAL_ISODEP_FSX_4096) ||
      (gIsoDep.hdrLen > ISODEP_HDR_MAX_LEN)) {
...
ReturnCode rfalIsoDepStartTransceive(rfalIsoDepTxRxParam param) {
  ...
  gIsoDep.txBufInfPos =
      (uint8_t)((uintptr_t)param.txBuf->inf - (uintptr_t)param.txBuf->prologue);
  gIsoDep.txBufLen = param.txBufLen;
  gIsoDep.isTxChaining = param.isTxChaining;

  gIsoDep.rxBuf = param.rxBuf->prologue;
  gIsoDep.rxBufInfPos =
      (uint8_t)((uintptr_t)param.rxBuf->inf - (uintptr_t)param.rxBuf->prologue);
  gIsoDep.rxBufLen = sizeof(rfalIsoDepBufFormat);
  ...
  gIsoDep.ourFsx =
      ((param.ourFSx != RFAL_ISODEP_FSX_KEEP) ? param.ourFSx : gIsoDep.ourFsx);
  ...
  if (gIsoDep.role == ISODEP_ROLE_PICC) {
    if (gIsoDep.txBufLen > 0U) {
      ...
      if (!gIsoDep.isWait4WTX) {
        ...
        /* If RTOX Ack is expected, signal a pending Tx to be transmitted right
         * after */
...
static ReturnCode rfalIsoDepDataExchangePICC(void) {
  ...
  switch (gIsoDep.state) {
    ...
    case ISODEP_ST_PICC_TX:
      ...
      ret = rfalIsoDepTx(rfalIsoDep_PCBIBlock(gIsoDep.blockNumber),
                         gIsoDep.txBuf, &gIsoDep.txBuf[gIsoDep.txBufInfPos],
                         gIsoDep.txBufLen, RFAL_FWT_NONE);
    ...
    case ISODEP_ST_PICC_RX:
      ...
      switch (ret) {
        ...
        case RFAL_ERR_FRAMING:
          ...
          /* Digital 1.1 - 15.2.6.2  The CE SHALL NOT attempt error recovery and
           * remains in Rx mode upon Transmission or a Protocol Error */
          rfalIsoDepReEnableRx((uint8_t *)gIsoDep.rxBuf,
                               sizeof(rfalIsoDepBufFormat), gIsoDep.rxLen);
    ...
    case ISODEP_ST_PICC_SWTX:
      ...
      if (!rfalIsoDepTimerisExpired(
              gIsoDep.WTXTimer)) /* Do nothing until WTX timer has expired */
      {
        return RFAL_ERR_BUSY;
      }
    ...
    case ISODEP_ST_PICC_SDSL:
      ...
      {
        rfalIsoDepInitialize();    /* Session finished reInit vars, go back to
                                      ISODEP_ST_IDLE */
  ...
  /*******************************************************************************/
  /* When DID=0 PCD may or may not use DID, therefore check whether current PCD
   * request has DID present to be reflected on max INF length #454  */

  /* ReCalculate Header Length */
  gIsoDep.hdrLen = RFAL_ISODEP_PCB_LEN;
  gIsoDep.hdrLen +=
      (uint8_t)((rfalIsoDep_PCBhasDID(rxPCB)) ? RFAL_ISODEP_DID_LEN : 0U);
  gIsoDep.hdrLen +=
      (uint8_t)((rfalIsoDep_PCBhasNAD(rxPCB)) ? RFAL_ISODEP_NAD_LEN : 0U);
  ...
  /*******************************************************************************/
  /* Check rcvd msg length, cannot be less then the expected header    OR * if
   * the rcvd msg exceeds our announced frame size (FSD)                      */
  if (((*gIsoDep.rxLen) < gIsoDep.hdrLen) ||
      ((*gIsoDep.rxLen) > (gIsoDep.ourFsx - ISODEP_CRC_LEN))) {
    rfalIsoDepReEnableRx((uint8_t *)gIsoDep.rxBuf, sizeof(rfalIsoDepBufFormat),
                         gIsoDep.rxLen);
    return RFAL_ERR_BUSY; /* RFAL_ERR_PROTO Ignore this protocol request */
  }
  /* If we are not supporting DID, but we receive one OR
   * If we are expecting DID, check if PCB signals its presence and if device ID
   * match OR If our DID=0 and DID is sent but with an incorrect value */
  if (((gIsoDep.did == RFAL_ISODEP_NO_DID) && (rfalIsoDep_PCBhasDID(rxPCB))) ||
      ((gIsoDep.did != RFAL_ISODEP_NO_DID) &&
       (gIsoDep.did != RFAL_ISODEP_DID_00) &&
       ((!rfalIsoDep_PCBhasDID(rxPCB)) ||
        (gIsoDep.did != gIsoDep.rxBuf[ISODEP_DID_POS]))) ||
      ((gIsoDep.did == RFAL_ISODEP_DID_00) && rfalIsoDep_PCBhasDID(rxPCB) &&
  ...
  if (rfalIsoDep_PCBisSBlock(rxPCB)) {
    ...
    if (rfalIsoDep_PCBisSWTX(rxPCB)) {
      ...
      if (rfalIsoDep_PCBisWTX(gIsoDep.lastPCB)) {
        /* Digital 1.1  15.2.2.11 S(WTX) Ack with different WTXM -> Protocol
         * Error  * Power level indication also should be set to 0 */
        if ((gIsoDep.rxBuf[gIsoDep.hdrLen] == gIsoDep.lastWTXM) &&
          ...
          /* Set WTX timer */
          rfalIsoDepTimerStart(
              gIsoDep.WTXTimer,
              rfalIsoDep_WTXAdjust(
                  (gIsoDep.lastWTXM * rfalConv1fcToMs(gIsoDep.fwt))));
    ...
    if (rfalIsoDep_PCBisSDeselect(rxPCB) &&
      ...
      RFAL_EXIT_ON_ERR(
          ret, rfalIsoDepHandleControlMsg(ISODEP_S_DSL, RFAL_ISODEP_NO_PARAM));
  ...
  /*******************************************************************************/
           ...
           ((*gIsoDep.rxLen - gIsoDep.hdrLen) == ISODEP_RBLOCK_INF_LEN)) {
    if (rfalIsoDep_PCBisRACK(rxPCB)) /* Check if is a R-ACK */
    {
      if (rfalIsoDep_GetBN(rxPCB) ==
          gIsoDep.blockNumber) /* Check block number  */
      {
        ...
        /* This block has been transmitted and acknowledged, perform WTX until
         * next data is provided  */

        /* Rule 9 - PICC is allowed to send an S(WTX) instead of an I-block or
         * an R(ACK) */
        rfalIsoDepTimerStart(
            gIsoDep.WTXTimer,
            rfalIsoDep_WTXAdjust(rfalConv1fcToMs(gIsoDep.fwt)));
        gIsoDep.state = ISODEP_ST_PICC_SWTX;
    ...
    } else if (rfalIsoDep_PCBisRNAK(rxPCB)) /* Check if is a R-NACK */
    {
          ...
          gIsoDep.blockNumber) /* Check block number  */
      {
        ...
        RFAL_EXIT_ON_ERR(ret, rfalIsoDepHandleControlMsg(ISODEP_R_ACK,
                                                         RFAL_ISODEP_NO_PARAM));
  ...
  /*******************************************************************************/
    ...
    /* Rule D - When an I-block is received, the PICC shall toggle its block
    ...
    if ((rfalIsoDep_GetBN(rxPCB) != gIsoDep.blockNumber) ||
        (gIsoDep.isTxChaining)) {
      /* Remain in the same Block Number */
      rfalIsoDep_ToggleBN(gIsoDep.blockNumber);

      /* ISO 14443-4 7.5.6.2 & Digital 1.1 - 15.2.6.2  The CE SHALL NOT attempt
       * error recovery and remains in Rx mode upon Transmission or a Protocol
       * Error */
      rfalIsoDepReEnableRx((uint8_t *)gIsoDep.rxBuf,
                           sizeof(rfalIsoDepBufFormat), gIsoDep.rxLen);
      return RFAL_ERR_BUSY;
    ...
    if (rfalIsoDep_PCBisChaining(rxPCB)) {
      ...
      *gIsoDep.rxChaining = true; /* Output Parameter*/
      ...
      RFAL_EXIT_ON_ERR(
          ret, rfalIsoDepHandleControlMsg(ISODEP_R_ACK, RFAL_ISODEP_NO_PARAM));

      /* Received I-Block with chaining, send current data to DH */

      /* remove ISO DEP header, check is necessary to move the INF data on the
       * buffer */
      *gIsoDep.rxLen -= gIsoDep.hdrLen;
      if ((gIsoDep.hdrLen != gIsoDep.rxBufInfPos) && (*gIsoDep.rxLen > 0U)) {
        RFAL_MEMMOVE(&gIsoDep.rxBuf[gIsoDep.rxBufInfPos],
                     &gIsoDep.rxBuf[gIsoDep.hdrLen], *gIsoDep.rxLen);
      }
      return RFAL_ERR_AGAIN; /* Send Again signalling to run again, but some
                                chaining data has arrived*/
    }
    ...
    *gIsoDep.rxLen -= gIsoDep.hdrLen;
    ...
    rfalIsoDepTimerStart(gIsoDep.WTXTimer,
                         rfalIsoDep_WTXAdjust(rfalConv1fcToMs(gIsoDep.fwt)));
  ...
  /* ISO 14443-4 7.5.6.2 & Digital 1.1 - 15.2.6.2  The CE SHALL NOT attempt
   * error recovery and remains in Rx mode upon Transmission or a Protocol Error
   */
  rfalIsoDepReEnableRx((uint8_t *)gIsoDep.rxBuf, sizeof(rfalIsoDepBufFormat),
                       gIsoDep.rxLen);
...
static ReturnCode rfalIsoDepStartRATS(rfalIsoDepFSxI FSDI, uint8_t DID,
  ...
  gIsoDep.actv.ratsReq.PARAM =
      (((uint8_t)FSDI << RFAL_ISODEP_RATS_PARAM_FSDI_SHIFT) &
       RFAL_ISODEP_RATS_PARAM_FSDI_MASK) |
      (DID & RFAL_ISODEP_RATS_PARAM_DID_MASK);

  rfalCreateByteFlagsTxRxContext(
      ctx, (uint8_t *)&gIsoDep.actv.ratsReq, sizeof(rfalIsoDepRats),
      (uint8_t *)ats, sizeof(rfalIsoDepAts), &gIsoDep.rxBufLen,
      RFAL_TXRX_FLAGS_DEFAULT, RFAL_ISODEP_T4T_FWT_ACTIVATION);
  return rfalStartTransceive(&ctx);
}
...
static ReturnCode rfalIsoDepGetRATSStatus(void) {
  ...
  if (ret == RFAL_ERR_NONE) {
    ...
    gIsoDep.ourFsx =
        rfalIsoDepFSxI2FSx((uint8_t)(gIsoDep.actv.ratsReq.PARAM >>
                                     RFAL_ISODEP_RATS_PARAM_FSDI_SHIFT));

    /* Check and assign if ATS length was requested (length also available on
     * TL) */
...
/*******************************************************************************/
ReturnCode rfalIsoDepRATS(rfalIsoDepFSxI FSDI, uint8_t DID, rfalIsoDepAts *ats,
                          uint8_t *atsLen) {
  ReturnCode ret;
...
static ReturnCode rfalIsoDepStartPPS(uint8_t DID, rfalBitRate DSI_dep,
  ...
  if ((ppsRes == NULL) || (DSI_dep > RFAL_BR_848) || (DRI > RFAL_BR_848) ||
      ((DID > RFAL_ISODEP_DID_MAX) && (DID != RFAL_ISODEP_NO_DID))) {
    return RFAL_ERR_PARAM;
  }
  ...
  /*******************************************************************************/
  /* Compose PPS Request */
  gIsoDep.actv.ppsReq.PPSS =
      (RFAL_ISODEP_PPS_SB | (DID & RFAL_ISODEP_PPS_SB_DID_MASK));
  gIsoDep.actv.ppsReq.PPS0 = RFAL_ISODEP_PPS_PPS0_PPS1_PRESENT;
  gIsoDep.actv.ppsReq.PPS1 =
      (RFAL_ISODEP_PPS_PPS1 |
       ((((uint8_t)DSI_dep << RFAL_ISODEP_PPS_PPS1_DSI_SHIFT) | (uint8_t)DRI) &
        RFAL_ISODEP_PPS_PPS1_DXI_MASK));

  rfalCreateByteFlagsTxRxContext(
      ctx, (uint8_t *)&gIsoDep.actv.ppsReq, sizeof(rfalIsoDepPpsReq),
      (uint8_t *)ppsRes, sizeof(rfalIsoDepPpsRes), &gIsoDep.rxBufLen,
      RFAL_TXRX_FLAGS_DEFAULT, RFAL_ISODEP_T4T_FWT_ACTIVATION);
  return rfalStartTransceive(&ctx);
}
...
ReturnCode rfalIsoDepPPS(uint8_t DID, rfalBitRate DSI_dep, rfalBitRate DRI,
  ...
  RFAL_EXIT_ON_ERR(ret, rfalIsoDepStartPPS(DID, DSI_dep, DRI, ppsRes));
...
static ReturnCode rfalIsoDepStartATTRIB(const uint8_t *nfcid0, uint8_t PARAM1,
  ...
  if ((attribRes == NULL) || (attribResLen == NULL) ||
      (DSI_dep > RFAL_BR_848) || (DRI > RFAL_BR_848) ||
      ((DID > RFAL_ISODEP_DID_MAX) && (DID != RFAL_ISODEP_NO_DID))) {
    return RFAL_ERR_NONE;
  }
  ...
  gIsoDep.actv.attribReq.Param.PARAM2 =
      (((((uint8_t)DSI_dep << RFAL_ISODEP_ATTRIB_PARAM2_DSI_SHIFT) |
  ...
  gIsoDep.actv.attribReq.Param.PARAM4 =
      (DID & RFAL_ISODEP_ATTRIB_PARAM4_DID_MASK);
  ...
  if ((HLInfo != NULL) && (HLInfoLen > 0U)) {
    RFAL_MEMCPY(gIsoDep.actv.attribReq.HLInfo, HLInfo,
                RFAL_MIN(HLInfoLen, RFAL_ISODEP_ATTRIB_HLINFO_LEN));
  }

  rfalCreateByteFlagsTxRxContext(
      ctx, (uint8_t *)&gIsoDep.actv.attribReq,
      (uint16_t)(RFAL_ISODEP_ATTRIB_HDR_LEN +
                 RFAL_MIN((uint16_t)HLInfoLen, RFAL_ISODEP_ATTRIB_HLINFO_LEN)),
      (uint8_t *)gIsoDep.rxBuf, sizeof(rfalIsoDepAttribRes), &gIsoDep.rxBufLen,
      RFAL_TXRX_FLAGS_DEFAULT, fwt);
  return rfalStartTransceive(&ctx);
}
...
static ReturnCode rfalIsoDepGetATTRIBStatus(void) {
  ...
  if (ret == RFAL_ERR_NONE) {
    ...
    gIsoDep.ourFsx =
        rfalIsoDepFSxI2FSx((uint8_t)(gIsoDep.actv.attribReq.Param.PARAM2 &
                                     RFAL_ISODEP_ATTRIB_PARAM2_FSDI_MASK));
  }
...
ReturnCode rfalIsoDepATTRIB(const uint8_t *nfcid0, uint8_t PARAM1,
  ...
  RFAL_EXIT_ON_ERR(ret, rfalIsoDepStartATTRIB(
                            nfcid0, PARAM1, DSI_dep, DRI, FSDI, PARAM3, DID,
                            HLInfo, HLInfoLen, fwt, attribRes, attribResLen));
...
/*******************************************************************************/
ReturnCode rfalIsoDepPollAHandleActivation(rfalIsoDepFSxI FSDI, uint8_t DID,
                                           rfalBitRate maxBR,
                                           rfalIsoDepDevice *rfalIsoDepDev) {
  ReturnCode ret;

  RFAL_EXIT_ON_ERR(
      ret, rfalIsoDepPollAStartActivation(FSDI, DID, maxBR, rfalIsoDepDev));
...
/*******************************************************************************/
ReturnCode rfalIsoDepPollAStartActivation(rfalIsoDepFSxI FSDI, uint8_t DID,
                                          rfalBitRate maxBR,
                                          rfalIsoDepDevice *rfalIsoDepDev) {
  ReturnCode ret;
  ...
  /* Enable EMD suppresssion|handling according to  Digital 2.1  4.1.1.1 ;
   * EMVCo 3.0  4.9.2 ; ISO 14443-3  8.3 */
  rfalSetErrorHandling(RFAL_ERRORHANDLING_EMD);

  /* Start RATS Transceive */
  RFAL_EXIT_ON_ERR(
      ret,
      rfalIsoDepStartRATS(FSDI, DID, &rfalIsoDepDev->activation.A.Listener.ATS,
                          &rfalIsoDepDev->activation.A.Listener.ATSLen));

  rfalIsoDepDev->info.DSI_dep = maxBR;
  ...
  switch (gIsoDep.state) {
    ...
    case ISODEP_ST_PCD_ACT_RATS:
      ...
      if (ret != RFAL_ERR_BUSY) {
        if (ret != RFAL_ERR_NONE) {
          /* EMVCo 2.6  9.6.1.1 & 9.6.1.2  If a timeout error is detected
           * retransmit, on transmission error abort */
          if ((gIsoDep.compMode == RFAL_COMPLIANCE_MODE_EMV) &&
              (ret != RFAL_ERR_TIMEOUT)) {
            break;
          }
          ...
          if (gIsoDep.cntRRetrys != 0U) {
            ...
            /* Send RATS retransmission */ /* PRQA S 4342 1 # MISRA 10.5 -
                                              Layout of enum rfalIsoDepFSxI is
                                              guaranteed whithin 4bit range */
            RFAL_EXIT_ON_ERR(
                ret,
                rfalIsoDepStartRATS(
                    (rfalIsoDepFSxI)(uint8_t)(gIsoDep.actv.ratsReq.PARAM >>
                                              RFAL_ISODEP_RATS_PARAM_FSDI_SHIFT),
                    gIsoDep.did, &gIsoDep.actvDev->activation.A.Listener.ATS,
                    &gIsoDep.actvDev->activation.A.Listener.ATSLen));
            gIsoDep.cntRRetrys--;
            ret = RFAL_ERR_BUSY;
          }
          /* Switch between NFC Forum and ISO14443-4 behaviour #595
           *   ISO14443-4  5.6.1  If RATS fails, a Deactivation sequence should
           * be performed as defined on clause 8  (ISO10373-6 Scenario H.2.5)
           *   Activity 1.1  9.6  Device Deactivation Activity is to be only
           * performed when there's an active device */
          else if (gIsoDep.compMode == RFAL_COMPLIANCE_MODE_ISO) {
            RFAL_EXIT_ON_ERR(ret, rfalIsoDepStartDeselect());

            /* State ISODEP_ST_PCD_WAIT_DSL already set by
             * rfalIsoDepHandleControlMsg DSL */
            return RFAL_ERR_BUSY;
          } else {
            /* MISRA 15.7 - Empty else */
          }
        ...
        {
          maxBR = gIsoDep.actvDev->info
                      .DSI_dep; /* Retrieve requested max bitrate */
          ...
          gIsoDep.actvDev->info.DSI_dep = RFAL_BR_106;
          gIsoDep.actvDev->info.DRI = RFAL_BR_106;
          gIsoDep.actvDev->info.FSxI =
              (uint8_t)RFAL_ISODEP_FSXI_32; /* FSC default value is 32 bytes
                                               ISO14443-A  5.2.3 */

          /*******************************************************************************/
          /* Check for ATS optional fields */
          if (gIsoDep.actvDev->activation.A.Listener.ATS.TL >
              RFAL_ISODEP_ATS_MIN_LEN) {
            ...
            if ((gIsoDep.actvDev->activation.A.Listener.ATS.T0 &
              ...
              rfalIsoDepCalcBitRate(maxBR,
                                    ((uint8_t *)&gIsoDep.actvDev->activation.A
                                         .Listener.ATS)[msgIt++],
                                    &gIsoDep.actvDev->info.DSI_dep,
            ...
            if ((gIsoDep.actvDev->activation.A.Listener.ATS.T0 &
              ...
              gIsoDep.actvDev->info.SFGI =
                  ((uint8_t *)&gIsoDep.actvDev->activation.A.Listener
                       .ATS)[msgIt++];
              gIsoDep.actvDev->info.FWI =
                  (uint8_t)((gIsoDep.actvDev->info.SFGI >>
            ...
            if ((gIsoDep.actvDev->activation.A.Listener.ATS.T0 &
              ...
              /* Advanced protocol features defined on Digital 1.0 Table 69,
               * removed after */
          ...
          gIsoDep.actvDev->info.FSx =
              rfalIsoDepFSxI2FSx(gIsoDep.actvDev->info.FSxI);
          ...
          gIsoDep.actvDev->info.FWT =
              rfalIsoDepFWI2FWT(gIsoDep.actvDev->info.FWI);
          gIsoDep.actvDev->info.dFWT = RFAL_ISODEP_DFWT_20;

          gIsoDep.actvDev->info.DID =
              ((gIsoDep.actvDev->info.supDID) ? gIsoDep.did
                                              : RFAL_ISODEP_NO_DID);
          gIsoDep.actvDev->info.NAD = RFAL_ISODEP_NO_NAD;

          /*******************************************************************************/
          /* If higher bit rates are supported by both devices, send PPS */
          if ((gIsoDep.actvDev->info.DSI_dep != RFAL_BR_106) ||
              (gIsoDep.actvDev->info.DRI != RFAL_BR_106)) {
            /* Send PPS */ /*  PRQA S 0310 1 # MISRA 11.3 - Intentional safe
                              cast to avoiding buffer duplication */
            RFAL_EXIT_ON_ERR(
                ret, rfalIsoDepStartPPS(gIsoDep.actvDev->info.DID,
                                        gIsoDep.actvDev->info.DSI_dep,
                                        gIsoDep.actvDev->info.DRI,
    ...
    case ISODEP_ST_PCD_ACT_PPS:
      ...
      if (ret != RFAL_ERR_BUSY) {
        ...
        if (ret == RFAL_ERR_NONE) {
          /* DSI_dep code the divisor from PICC to PCD */
          /* DRI code the divisor from PCD to PICC */
          rfalSetBitRate(gIsoDep.actvDev->info.DRI,
                         gIsoDep.actvDev->info.DSI_dep);
        } else {
...
/*******************************************************************************/
ReturnCode rfalIsoDepPollBHandleActivation(rfalIsoDepFSxI FSDI, uint8_t DID,
                                           rfalBitRate maxBR, uint8_t PARAM1,
  ...
  RFAL_EXIT_ON_ERR(
      ret, rfalIsoDepPollBStartActivation(FSDI, DID, maxBR, PARAM1, nfcbDev,
                                          HLInfo, HLInfoLen, rfalIsoDepDev));
...
/*******************************************************************************/
ReturnCode rfalIsoDepPollBStartActivation(rfalIsoDepFSxI FSDI, uint8_t DID,
                                          rfalBitRate maxBR, uint8_t PARAM1,
                                          const rfalNfcbListenDevice *nfcbDev,
                                          const uint8_t *HLInfo,
                                          uint8_t HLInfoLen,
  ...
  rfalIsoDepDev->info.SFGI = (((uint32_t)nfcbDev->sensbRes.protInfo.SFGI >>
                               RFAL_NFCB_SENSB_RES_SFGI_SHIFT) &
                              RFAL_NFCB_SENSB_RES_SFGI_MASK);
  rfalIsoDepDev->info.SFGT =
      rfalIsoDepSFGI2SFGT((uint8_t)rfalIsoDepDev->info.SFGI);
  rfalIsoDepDev->info.FSxI = ((nfcbDev->sensbRes.protInfo.FsciProType >>
  ...
  rfalIsoDepDev->info.supDID = (((nfcbDev->sensbRes.protInfo.FwiAdcFo &
                                  RFAL_NFCB_SENSB_RES_FO_DID_MASK) != 0U)
                                    ? true
                                    : false);
  rfalIsoDepDev->info.supNAD = (((nfcbDev->sensbRes.protInfo.FwiAdcFo &
  ...
  if (gIsoDep.compMode == RFAL_COMPLIANCE_MODE_EMV) {
    /* Disregard Minimum TR2 returned by PICC, always use FDTb MIN
     * EMVCo 3.0  6.3.2.10  */
    rfalSetFDTPoll(RFAL_FDT_POLL_NFCB_POLLER);
  } else {
    tr2 = rfalNfcbTR2ToFDT(((nfcbDev->sensbRes.protInfo.FsciProType >>
                             RFAL_NFCB_SENSB_RES_PROTO_TR2_SHIFT) &
                            RFAL_NFCB_SENSB_RES_PROTO_TR2_MASK));
    if (rfalGetFDTPoll() < tr2) {
      /* In case TR2 is longer than the one currently running, ensure it's
       * fulfilled (max: 9472/fc => 700us)  */
      platformDelay(1);
    }
  ...
  rfalIsoDepCalcBitRate(maxBR, nfcbDev->sensbRes.protInfo.BRC,
                        &rfalIsoDepDev->info.DSI_dep, &rfalIsoDepDev->info.DRI);
  ...
  RFAL_EXIT_ON_ERR(
      ...
      rfalIsoDepStartATTRIB(
          ...
          rfalIsoDepDev->info.DSI_dep, rfalIsoDepDev->info.DRI, FSDI,
          (gIsoDep.compMode == RFAL_COMPLIANCE_MODE_EMV)
...
ReturnCode rfalIsoDepPollBGetActivationStatus(void) {
  ...
  if (ret != RFAL_ERR_BUSY) {
    if (ret == RFAL_ERR_NONE) {
      ...
      uint8_t expected_did =
          ((RFAL_ISODEP_NO_DID == gIsoDep.did) ? RFAL_ISODEP_DID_00
                                               : gIsoDep.did);
      if ((gIsoDep.actvDev->activation.B.Listener.ATTRIB_RES.mbliDid &
           RFAL_ISODEP_ATTRIB_RES_DID_MASK) != expected_did) {
        return RFAL_ERR_PROTO;
      }

      /* Retrieve MBLI and calculate new FDS/MBL (Maximum Buffer Length) */
      mbli = ((gIsoDep.actvDev->activation.B.Listener.ATTRIB_RES.mbliDid >>
               RFAL_ISODEP_ATTRIB_RES_MBLI_SHIFT) &
              RFAL_ISODEP_ATTRIB_RES_MBLI_MASK);
      if (mbli > 0U) {
        /* Digital 1.1  14.6.2  Calculate Maximum Buffer Length MBL = FSC x
         * 2^(MBLI-1) */
      ...
      /* DSI_dep code the divisor from PICC to PCD */
      /* DRI code the divisor from PCD to PICC */
      rfalSetBitRate(gIsoDep.actvDev->info.DRI, gIsoDep.actvDev->info.DSI_dep);
    ...
    /*******************************************************************************/
    /* Store already FS info,  rfalIsoDepGetMaxInfLen() may be called before
     * setting TxRx params */
    gIsoDep.fsx = gIsoDep.actvDev->info.FSx;
  }
...
/*******************************************************************************/
ReturnCode rfalIsoDepPollHandleSParameters(rfalIsoDepDevice *rfalIsoDepDev,
                                           rfalBitRate maxTxBR,
                                           rfalBitRate maxRxBR) {
  uint8_t it;
  uint8_t supPCD2PICC;
  ...
  if ((rfalIsoDepDev == NULL) || (maxTxBR > RFAL_BR_13560) ||
      (maxRxBR > RFAL_BR_13560)) {
    return RFAL_ERR_PARAM;
  }
  ...
  RFAL_EXIT_ON_ERR(
      ret, rfalTransceiveBlockingTxRx(
               (uint8_t *)&sParam, (RFAL_ISODEP_SPARAM_HDR_LEN + (uint16_t)it),
               (uint8_t *)&sParam, sizeof(rfalIsoDepControlMsgSParam), &rcvLen,
               RFAL_TXRX_FLAGS_DEFAULT, ISODEP_FWT_DEACTIVATION));
  ...
  if ((sParam.pcb != ISODEP_PCB_SPARAMETERS) ||
      ...
      (rcvLen !=
       ((uint16_t)sParam.sParam.length + RFAL_ISODEP_SPARAM_HDR_LEN))) {
    return RFAL_ERR_PROTO;
  }
  ...
  for (it = 0; it <= (uint8_t)maxTxBR; it++) {
    if ((supPCD2PICC & (0x01U << it)) != 0U) {
      txBR =
          (rfalBitRate)it; /* PRQA S 4342 # MISRA 10.5 - Layout of enum
                              rfalBitRate and above clamping of maxTxBR
                              guarantee no invalid enum values to be created */
    }
  }
  ...
  rfalIsoDepDev->info.DSI_dep = rxBR;
...
static void rfalIsoDepCalcBitRate(rfalBitRate maxAllowedBR,
  ...
  do {
    ...
    /* Digital 1.0  5.6.2.5 & 11.6.2.14: A received RFU value of b4 = 1b MUST be
     * interpreted as if b7 to b1 ? 0000000b (only 106 kbits/s in both
     * direction) */
    if (((RFAL_ISODEP_BITRATE_RFU_MASK & piccBRCapability) != 0U) ||
        (curMaxBR > RFAL_BR_848) || (curMaxBR == RFAL_BR_KEEP)) {
      return;
    }
    ...
    for (i = 2; i >= 0; i--) /* Check supported bit rate from the highest */
    {
      if (((dsiMask & (0x10U << (uint8_t)i)) != 0U) &&
        ...
        (*dsi) = (rfalBitRate)
            newdsi; /* PRQA S 4342 # MISRA 10.5 - Layout of enum rfalBitRate and
                       range of loop variable guarantee no invalid enum values
                       to be created */
        break;
      }
    }
    ...
    for (i = 2; i >= 0; i--) /* Check supported bit rate from the highest */
    {
      if (((driMask & (0x01U << (uint8_t)i)) != 0U) &&
        ...
        (*dri) = (rfalBitRate)
            newdri; /* PRQA S 4342 # MISRA 10.5 - Layout of enum rfalBitRate and
                       range of loop variable guarantee no invalid enum values
                       to be created */
        break;
      }
    ...
    /* Digital 1.0 Table 67: if b8=1b, then only the same bit rate divisor for
    ...
    if ((piccBRCapability & RFAL_ISODEP_SAME_BITRATE_MASK) != 0U) {
      ...
      if ((RFAL_BR_106 != (*dsi)) &&
        ...
        bitrateFound = false;
        curMaxBR = (*dsi); /* set allowed bitrate to be lowest and determine bit
                              rate again */
      }
    }
  } while (!(bitrateFound));
...
static void rfalIsoDepApdu2IBLockParam(rfalIsoDepApduTxRxParam apduParam,
  ...
  iBlockParam->txBuf =
      (rfalIsoDepBufFormat *)
          apduParam.txBuf; /*  PRQA S 0310 # MISRA 11.3 - Intentional safe cast
                              to avoiding large buffer duplication */
  iBlockParam->rxBuf =
      apduParam.tmpBuf; /* Simply using the apdu buffer is not possible because
                           of current ACK handling */
...
ReturnCode rfalIsoDepStartApduTransceive(rfalIsoDepApduTxRxParam param) {
  ...
  /* Assign current FSx to calculate INF length (only change the FSx from
   * activation if no to Keep) */
  gIsoDep.ourFsx =
      ((param.ourFSx != RFAL_ISODEP_FSX_KEEP) ? param.ourFSx : gIsoDep.ourFsx);
  gIsoDep.fsx = param.FSx;

  /* Convert APDU TxRxParams to I-Block TxRxParams */
  rfalIsoDepApdu2IBLockParam(gIsoDep.APDUParam, &txRxParam, gIsoDep.APDUTxPos,
                             gIsoDep.APDURxPos);
  ...
  switch (ret) {
    ...
    case RFAL_ERR_NONE:
      ...
      if (gIsoDep.isTxChaining) {
        ...
        /* Convert APDU TxRxParams to I-Block TxRxParams */
        rfalIsoDepApdu2IBLockParam(gIsoDep.APDUParam, &txRxParam,
                                   gIsoDep.APDUTxPos, gIsoDep.APDURxPos);

        if (txRxParam.txBufLen > 0U) /* MISRA 21.18 */
        {
          /* Move next I-Block to beginning of APDU Tx buffer */
          RFAL_MEMCPY(gIsoDep.APDUParam.txBuf->apdu,
    ...
    case RFAL_ERR_AGAIN: /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through
      ...
      /* Check if no APDU transceive has been started before (data from
       * rfalIsoDepListenStartActivation) */
      if (gIsoDep.APDUParam.rxLen == NULL) {
        if (ret == RFAL_ERR_AGAIN) {
          /* In Listen mode first chained packet cannot be retrieved via APDU
           * interface */
          return RFAL_ERR_NOTSUPP;
        }
      ...
      if (*gIsoDep.APDUParam.rxLen > 0U) /* MISRA 21.18 */
      {
        ...
        RFAL_MEMCPY(&gIsoDep.APDUParam.rxBuf->apdu[gIsoDep.APDURxPos],
                    gIsoDep.APDUParam.tmpBuf->inf, *gIsoDep.APDUParam.rxLen);
