...
#define RFAL_NFC_T_FIELD_OFF \
  5U /*!< tFIELD_OFF minimal duration  Activity 2.2  Table 26 */
...
#define rfalNfcpCbPollerInitialize()                       \
  ((gNfcDev.disc.propNfc.rfalNfcpPollerInitialize != NULL) \
       ? gNfcDev.disc.propNfc.rfalNfcpPollerInitialize()   \
       : RFAL_ERR_NOTSUPP)
#define rfalNfcpCbPollerTechnologyDetection()                       \
  ((gNfcDev.disc.propNfc.rfalNfcpPollerTechnologyDetection != NULL) \
       ? gNfcDev.disc.propNfc.rfalNfcpPollerTechnologyDetection()   \
       : RFAL_ERR_TIMEOUT)
#define rfalNfcpCbPollerStartCollisionResolution()                       \
  ((gNfcDev.disc.propNfc.rfalNfcpPollerStartCollisionResolution != NULL) \
       ? gNfcDev.disc.propNfc.rfalNfcpPollerStartCollisionResolution()   \
       : RFAL_ERR_NOTSUPP)
#define rfalNfcpCbPollerGetCollisionResolutionStatus()                       \
  ((gNfcDev.disc.propNfc.rfalNfcpPollerGetCollisionResolutionStatus != NULL) \
       ? gNfcDev.disc.propNfc.rfalNfcpPollerGetCollisionResolutionStatus()   \
       : RFAL_ERR_NOTSUPP)
#define rfalNfcpCbStartActivation()                       \
  ((gNfcDev.disc.propNfc.rfalNfcpStartActivation != NULL) \
       ? gNfcDev.disc.propNfc.rfalNfcpStartActivation()   \
       : RFAL_ERR_NOTSUPP)
#define rfalNfcpCbGetActivationStatus()                       \
  ((gNfcDev.disc.propNfc.rfalNfcpGetActivationStatus != NULL) \
       ? gNfcDev.disc.propNfc.rfalNfcpGetActivationStatus()   \
       : RFAL_ERR_NOTSUPP)

#define rfalNfcHasPollerTechs()                                           \
  ((gNfcDev.disc.techs2Find &                                             \
    (RFAL_NFC_POLL_TECH_A | RFAL_NFC_POLL_TECH_B | RFAL_NFC_POLL_TECH_F | \
     RFAL_NFC_POLL_TECH_V | RFAL_NFC_POLL_TECH_AP2P |                     \
     RFAL_NFC_POLL_TECH_ST25TB | RFAL_NFC_POLL_TECH_PROP)) != 0U)
...
typedef struct {
  ...
  rfalNfcbSensbRes
      sensbRes;        /*!< SENSB_RES during card detection and activation  */
...
static ReturnCode rfalNfcNfcDepActivate(rfalNfcDevice *device,
...
ReturnCode rfalNfcDiscover(const rfalNfcDiscoverParam *disParams) {
  ...
  if ((disParams == NULL) || (disParams->devLimit > RFAL_NFC_MAX_DEVICES) ||
      ...
      ((disParams->maxBR > RFAL_BR_1695) &&
       (disParams->maxBR != RFAL_BR_KEEP)) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_F) != 0U) &&
       (disParams->nfcfBR != RFAL_BR_212) &&
       (disParams->nfcfBR != RFAL_BR_424)) ||
  ...
  if ((((disParams->techs2Find & RFAL_NFC_POLL_TECH_A) != 0U) &&
       (!((bool)RFAL_FEATURE_NFCA))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_B) != 0U) &&
       (!((bool)RFAL_FEATURE_NFCB))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_F) != 0U) &&
       (!((bool)RFAL_FEATURE_NFCF))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_V) != 0U) &&
       (!((bool)RFAL_FEATURE_NFCV))) ||
      ...
      (((disParams->techs2Find & RFAL_NFC_LISTEN_TECH_AP2P) != 0U) &&
       (!((bool)RFAL_FEATURE_NFC_DEP)))) {
    return RFAL_ERR_DISABLED; /*  PRQA S  2880 # MISRA 2.1 - Unreachable code
                                 due to configuration option being set/unset  */
  }

  if ((((disParams->techs2Find & RFAL_NFC_POLL_TECH_A) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_POLL_NFCA))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_B) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_POLL_NFCB))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_F) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_POLL_NFCF))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_V) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_POLL_NFCV))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_ST25TB) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_POLL_NFCB))) ||
      (((disParams->techs2Find & RFAL_NFC_POLL_TECH_AP2P) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_POLL_ACTIVE_P2P))) ||
      (((disParams->techs2Find & RFAL_NFC_LISTEN_TECH_A) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_LISTEN_NFCA))) ||
      (((disParams->techs2Find & RFAL_NFC_LISTEN_TECH_B) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_LISTEN_NFCB))) ||
      (((disParams->techs2Find & RFAL_NFC_LISTEN_TECH_F) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_LISTEN_NFCF))) ||
      (((disParams->techs2Find & RFAL_NFC_LISTEN_TECH_AP2P) != 0U) &&
       (!((bool)RFAL_SUPPORT_MODE_LISTEN_ACTIVE_P2P)))) {
    return RFAL_ERR_NOTSUPP; /*  PRQA S  2880 # MISRA 2.1 - Unreachable code due
  ...
  gNfcDev.lmMask = 0U;
  gNfcDev.lmMask |= (((gNfcDev.disc.techs2Find & RFAL_NFC_LISTEN_TECH_A) != 0U)
                         ? RFAL_LM_MASK_NFCA
                         : 0U);
  gNfcDev.lmMask |= (((gNfcDev.disc.techs2Find & RFAL_NFC_LISTEN_TECH_B) != 0U)
                         ? RFAL_LM_MASK_NFCB
                         : 0U);
  gNfcDev.lmMask |= (((gNfcDev.disc.techs2Find & RFAL_NFC_LISTEN_TECH_F) != 0U)
                         ? RFAL_LM_MASK_NFCF
                         : 0U);
  gNfcDev.lmMask |=
      (((gNfcDev.disc.techs2Find & RFAL_NFC_LISTEN_TECH_AP2P) != 0U)
           ? RFAL_LM_MASK_ACTIVE_P2P
           : 0U);
...
ReturnCode rfalNfcDeactivate(rfalNfcDeactivateType deactType) {
  ...
  if ((gNfcDev.state <= RFAL_NFC_STATE_IDLE) ||
      ((deactType == RFAL_NFC_DEACTIVATE_SLEEP) &&
  ...
  if (((deactType == RFAL_NFC_DEACTIVATE_SLEEP) &&
       rfalNfcIsRemDevPoller(gNfcDev.activeDev->type)) ||
      ((deactType == RFAL_NFC_DEACTIVATE_DISCOVERY) &&
       (gNfcDev.disc.techs2Find == RFAL_NFC_TECH_NONE))) {
    return RFAL_ERR_PARAM;
  }
  ...
  if ((deactType == RFAL_NFC_DEACTIVATE_DISCOVERY) ||
      (deactType == RFAL_NFC_DEACTIVATE_SLEEP)) {
...
/*******************************************************************************/
rfalNfcState rfalNfcGetState(void) { return gNfcDev.state; }
...
void rfalNfcWorker(void) {
  ...
  switch (gNfcDev.state) {
    ...
    case RFAL_NFC_STATE_START_DISCOVERY:
      ...
      gNfcDev.discTmr =
          (uint32_t)platformTimerCreate(gNfcDev.disc.totalDuration);

#if RFAL_FEATURE_WAKEUP_MODE
      /* Check if Low power Wake-Up is to be performed */
      if ((gNfcDev.disc.wakeupEnabled) &&
          (((gNfcDev.techDctCnt == 0U) &&
            (gNfcDev.disc.wakeupPollBefore == false)) ||
           (gNfcDev.techDctCnt >= gNfcDev.disc.wakeupNPolls))) {
        /* Initialize Low power Wake-up mode and wait */
        err = rfalWakeUpModeStart((gNfcDev.disc.wakeupConfigDefault
                                       ? NULL
                                       : &gNfcDev.disc.wakeupConfig));
      ...
      rfalNfcNfcNotify(gNfcDev.state); /* Notify caller that WU or Technology
    ...
    case RFAL_NFC_STATE_WAKEUP_MODE:
      ...
      if (rfalWakeUpModeHasWoke()) {
        ...
        gNfcDev.state =
            RFAL_NFC_STATE_POLL_TECHDETECT; /* Go to Technology detection     */
    ...
    case RFAL_NFC_STATE_POLL_TECHDETECT:
      ...
      if (err != RFAL_ERR_BUSY) /* Wait until all technologies are performed */
      {
        if ((err != RFAL_ERR_NONE) ||
            (gNfcDev.techsFound ==
             RFAL_NFC_TECH_NONE)) /* Check if any error occurred or no techs
                                     were found   */
        {
          rfalFieldOff();
          gNfcDev.isFieldOn = false;
          gNfcDev.state =
              RFAL_NFC_STATE_LISTEN_TECHDETECT; /* Nothing found as poller, go
                                                   to listener */
          break;
        }

        gNfcDev.techs2do = gNfcDev.techsFound; /* Store the found technologies
                                                  for collision resolution */
        gNfcDev.state =
            RFAL_NFC_STATE_POLL_COLAVOIDANCE; /* One or more devices found, go
    ...
    case RFAL_NFC_STATE_POLL_COLAVOIDANCE:
      ...
      if (err != RFAL_ERR_BUSY) /* Wait until all technologies are performed */
      {
        if ((err != RFAL_ERR_NONE) ||
            (gNfcDev.devCnt ==
             0U)) /* Check if any error occurred or no devices were found */
        {
          gNfcDev.deactType = RFAL_NFC_DEACTIVATE_DISCOVERY;
          gNfcDev.state = RFAL_NFC_STATE_DEACTIVATION;
        ...
        if (gNfcDev.devCnt > 1U) {
          /* If more than one device was found inform upper layer to choose
        ...
        /* If only one device or no callback has been set, activate the first
         * device found */
    ...
    case RFAL_NFC_STATE_POLL_ACTIVATION:
      ...
      if (err != RFAL_ERR_BUSY) /* Wait until all Activation is complete */
      {
        if (err != RFAL_ERR_NONE) /* Check if activation has failed        */
        {
          ...
          gNfcDev.deactType =
              RFAL_NFC_DEACTIVATE_DISCOVERY; /* Ensure deactivation, not Sleep
                                              */
          gNfcDev.state = RFAL_NFC_STATE_DEACTIVATION; /* If Activation failed,
                                                          restart loop    */
          break;
        }

        gNfcDev.state =
            RFAL_NFC_STATE_ACTIVATED; /* Device has been properly activated */
        rfalNfcNfcNotify(gNfcDev.state); /* Inform upper layer that a device has
                                            been activated */
      }
      break;
    ...
    case RFAL_NFC_STATE_DATAEXCHANGE:
      ...
      if (gNfcDev.dataExErr !=
          RFAL_ERR_BUSY) /* If Dataexchange has terminated */
      {
        gNfcDev.state = RFAL_NFC_STATE_DATAEXCHANGE_DONE; /* Go to done state */
        rfalNfcNfcNotify(gNfcDev.state); /* And notify caller              */
      }
      if (gNfcDev.dataExErr ==
          RFAL_ERR_SLEEP_REQ) /* Check if Listen mode has to go to Sleep */
      {
        gNfcDev.state =
            RFAL_NFC_STATE_LISTEN_SLEEP; /* Go to Listen Sleep state       */
        rfalNfcNfcNotify(gNfcDev.state); /* And notify caller              */
      }
      break;
    ...
    case RFAL_NFC_STATE_DEACTIVATION:
      ...
      if (err != RFAL_ERR_BUSY) {
        if (gNfcDev.deactType == RFAL_NFC_DEACTIVATE_SLEEP) {
          ...
          gNfcDev.state = ((gNfcDev.deactType == RFAL_NFC_DEACTIVATE_DISCOVERY)
    ...
    case RFAL_NFC_STATE_LISTEN_TECHDETECT:
      ...
      if (platformTimerIsExpired(gNfcDev.discTmr)) {
        ...
        gNfcDev.state =
            RFAL_NFC_STATE_START_DISCOVERY; /* Restart the discovery loop */
        rfalNfcNfcNotify(gNfcDev.state);    /* Notify caller             */
        break;
      }
      ...
      {
        err = rfalListenStart(
            gNfcDev.lmMask, &gNfcDev.disc.lmConfigPA, NULL,
            &gNfcDev.disc.lmConfigPF, (uint8_t *)&gNfcDev.rxBuf.rfBuf,
            (uint16_t)rfalConvBytesToBits(sizeof(gNfcDev.rxBuf.rfBuf)),
            &gNfcDev.rxLen);
        if (err == RFAL_ERR_NONE) {
          gNfcDev.state =
              RFAL_NFC_STATE_LISTEN_COLAVOIDANCE; /* Wait for listen mode to be
                                                     activated */
        }
      }
      break;
    ...
    case RFAL_NFC_STATE_LISTEN_COLAVOIDANCE:
      ...
      if (platformTimerIsExpired(
              gNfcDev
                  .discTmr)) /* Check if the total duration has been reached */
      {
        rfalListenStop();
        gNfcDev.state =
            RFAL_NFC_STATE_START_DISCOVERY; /* Restart the discovery loop */
      ...
      if (rfalListenGetState(NULL, NULL) >= RFAL_LM_STATE_IDLE) {
        gNfcDev.state =
            RFAL_NFC_STATE_LISTEN_ACTIVATION; /* Wait for listen mode to be
                                                 activated */
      }
      break;
    ...
    case RFAL_NFC_STATE_LISTEN_SLEEP:
      ...
      if (err != RFAL_ERR_BUSY) {
        if (err == RFAL_ERR_NONE) {
          gNfcDev.activeDev =
              gNfcDev
                  .devList; /* Assign the active device to be used further on */
          gNfcDev.devCnt++;

          gNfcDev.state =
              RFAL_NFC_STATE_ACTIVATED; /* Device has been properly activated */
          rfalNfcNfcNotify(gNfcDev.state); /* Inform upper layer that a device
                                              has been activated */
        } else if ((!platformTimerIsExpired(gNfcDev.discTmr)) &&
                   (err == RFAL_ERR_LINK_LOSS) &&
                   (gNfcDev.state == RFAL_NFC_STATE_LISTEN_ACTIVATION)) {
          break; /* Field|Link broken during activation, keep in Listen the
...
ReturnCode rfalNfcDataExchangeStart(uint8_t *txData, uint16_t txDataLen,
  ...
  if ((gNfcDev.state >= RFAL_NFC_STATE_ACTIVATED) &&
    ...
    if ((gNfcDev.state == RFAL_NFC_STATE_ACTIVATED) &&
      ...
      *rxData = (uint8_t *)((gNfcDev.activeDev->rfInterface ==
                             RFAL_NFC_INTERFACE_ISODEP)
                                ? gNfcDev.rxBuf.isoDepBuf.apdu
                                : ((gNfcDev.activeDev->rfInterface ==
                                    RFAL_NFC_INTERFACE_NFCDEP)
    ...
    /*******************************************************************************/
    switch (gNfcDev.activeDev->rfInterface) /* Check which RF interface shall be
                                               used/has been activated */
    {
      /*******************************************************************************/
      case RFAL_NFC_INTERFACE_RF:

        rfalCreateByteFlagsTxRxContext(
            ctx, (uint8_t *)txData, txDataLen, gNfcDev.rxBuf.rfBuf,
            sizeof(gNfcDev.rxBuf.rfBuf), &gNfcDev.rxLen,
      ...
      case RFAL_NFC_INTERFACE_ISODEP: {
        ...
        if (txDataLen > 0U) {
          RFAL_MEMCPY((uint8_t *)gNfcDev.txBuf.isoDepBuf.apdu, txData,
                      txDataLen);
        }
      ...
      case RFAL_NFC_INTERFACE_NFCDEP: {
        ...
        if (txDataLen > 0U) {
          RFAL_MEMCPY((uint8_t *)gNfcDev.txBuf.nfcDepBuf.pdu, txData,
                      txDataLen);
        }
        ...
        rfalNfcDepTxRx.FSx = rfalNfcIsRemDevListener(gNfcDev.activeDev->type)
                                 ? rfalNfcDepLR2FS((uint8_t)rfalNfcDepPP2LR(
                                       gNfcDev.activeDev->proto.nfcDep
                                           .activation.Target.ATR_RES.PPt))
                                 : rfalNfcDepLR2FS((uint8_t)rfalNfcDepPP2LR(
                                       gNfcDev.activeDev->proto.nfcDep
                                           .activation.Initiator.ATR_REQ.PPi));
...
ReturnCode rfalNfcDataExchangeGetStatus(void) {
  ...
  if (gNfcDev.state == RFAL_NFC_STATE_ACTIVATED) {
    ...
    if ((gNfcDev.activeDev->type == RFAL_NFC_POLL_TYPE_NFCF) &&
      ...
      /* The first frame has been retrieved by rfalListenMode, flag data
       * immediately                  */
      /* Can only call rfalGetTransceiveStatus() after starting a transceive
       * with rfalStartTransceive */
...
#if RFAL_FEATURE_LISTEN_MODE
    /*******************************************************************************/
    /* If a Sleep request has been received (Listen Mode) go to sleep
     * immediately  */
    if (gNfcDev.dataExErr == RFAL_ERR_SLEEP_REQ) {
      RFAL_EXIT_ON_ERR(
          gNfcDev.dataExErr,
          rfalListenSleepStart(RFAL_LM_STATE_SLEEP_A, gNfcDev.rxBuf.rfBuf,
                               sizeof(gNfcDev.rxBuf.rfBuf), &gNfcDev.rxLen));
...
static ReturnCode rfalNfcPollTechDetection(void) {
  ...
  if (((gNfcDev.disc.techs2Find & RFAL_NFC_POLL_TECH_AP2P) != 0U) &&
    ...
    if (!gNfcDev.isTechInit) {
      RFAL_EXIT_ON_ERR(
          err, rfalSetMode(RFAL_MODE_POLL_ACTIVE_P2P, gNfcDev.disc.ap2pBR,
                           gNfcDev.disc.ap2pBR));
    ...
    if (rfalIsGTExpired()) /* Wait until Guard Time is fulfilled */
    {
      ...
      err = rfalNfcNfcDepActivate(gNfcDev.devList, RFAL_NFCDEP_COMM_ACTIVE,
                                  NULL, 0); /* Poll for AP2P devices */
      if (err == RFAL_ERR_NONE) {
  ...
  /*******************************************************************************/
  if ((!gNfcDev.isFieldOn) &&
      ((gNfcDev.disc.techs2Find &
        (RFAL_NFC_POLL_TECH_A | RFAL_NFC_POLL_TECH_B | RFAL_NFC_POLL_TECH_F |
         RFAL_NFC_POLL_TECH_V | RFAL_NFC_POLL_TECH_ST25TB |
         RFAL_NFC_POLL_TECH_PROP)) != 0U)) {
  ...
  if (((gNfcDev.disc.techs2Find & RFAL_NFC_POLL_TECH_A) != 0U) &&
    ...
    if (!gNfcDev.isTechInit) {
      ...
      RFAL_EXIT_ON_ERR(err, rfalFieldOnAndStartGT()); /* As field is already On
                                                         only starts GT timer */
      gNfcDev.isTechInit = true;
    ...
    if (rfalIsGTExpired()) /* Wait until Guard Time is fulfilled */
    {
      if (!gNfcDev.isOperOngoing) {
        rfalNfcaPollerStartTechnologyDetection(
            ...
            &gNfcDev.sensRes); /* Poll for NFC-A devices */
      ...
      if (((gNfcDev.disc.techs2Bail & RFAL_NFC_POLL_TECH_A) != 0U) &&
          (gNfcDev.techsFound != 0U)) {
        return RFAL_ERR_NONE;
      }
    }
  ...
  if (((gNfcDev.disc.techs2Find & RFAL_NFC_POLL_TECH_B) != 0U) &&
    ...
    {
      if (!gNfcDev.isOperOngoing) {
        rfalNfcbPollerStartTechnologyDetection(
            gNfcDev.disc.compMode, &gNfcDev.sensbRes,
            &gNfcDev.sensbResLen); /* Poll for NFC-B devices */
      ...
      if (((gNfcDev.disc.techs2Bail & RFAL_NFC_POLL_TECH_B) != 0U) &&
          (gNfcDev.techsFound != 0U)) {
        return RFAL_ERR_NONE;
      }
    }
  ...
  if (((gNfcDev.disc.techs2Find & RFAL_NFC_POLL_TECH_F) != 0U) &&
    ...
    if (!gNfcDev.isTechInit) {
      RFAL_EXIT_ON_ERR(
          err, rfalNfcfPollerInitialize(
                   gNfcDev.disc.nfcfBR)); /* Initialize RFAL for NFC-F */
      RFAL_EXIT_ON_ERR(err, rfalFieldOnAndStartGT()); /* As field is already On
                                                         only starts GT timer */
    ...
    if (rfalIsGTExpired()) /* Wait until Guard Time is fulfilled */
    {
      ...
      if (((gNfcDev.disc.techs2Bail & RFAL_NFC_POLL_TECH_F) != 0U) &&
          (gNfcDev.techsFound != 0U)) {
        return RFAL_ERR_NONE;
      }
    }
  ...
  if (((gNfcDev.disc.techs2Find & RFAL_NFC_POLL_TECH_ST25TB) != 0U) &&
    ...
    if (!gNfcDev.isTechInit) {
      RFAL_EXIT_ON_ERR(
          err, rfalSt25tbPollerInitialize()); /* Initialize RFAL for NFC-V */
      RFAL_EXIT_ON_ERR(err, rfalFieldOnAndStartGT()); /* As field is already On
                                                         only starts GT timer */
      gNfcDev.isTechInit = true;
    }
  ...
  /*******************************************************************************/
  if (((gNfcDev.disc.techs2Find & RFAL_NFC_POLL_TECH_PROP) != 0U) &&
      ((gNfcDev.techs2do & RFAL_NFC_POLL_TECH_PROP) != 0U)) {
    if (!gNfcDev.isTechInit) {
      RFAL_EXIT_ON_ERR(err,
                       rfalNfcpCbPollerInitialize()); /* Initialize RFAL for
                                                         Proprietary NFC */
      RFAL_EXIT_ON_ERR(err,
                       rfalFieldOnAndStartGT()); /* As field may already be On
                                                    only starts GT timer */
      gNfcDev.isTechInit = true;
    }
...
static ReturnCode rfalNfcPollCollResolution(void) {
  ...
  if (((gNfcDev.techsFound & RFAL_NFC_POLL_TECH_A) != 0U) &&
      ((gNfcDev.techs2do & RFAL_NFC_POLL_TECH_A) !=
       0U)) /* If a NFC-A device was found/detected, perform Collision
               Resolution */
  {
    ...
    if (!gNfcDev.isOperOngoing) {
      RFAL_EXIT_ON_ERR(err, rfalNfcaPollerStartFullCollisionResolution(
                                gNfcDev.disc.compMode,
    ...
    if (err != RFAL_ERR_BUSY) {
      ...
      if ((err == RFAL_ERR_NONE) && (devCnt != 0U)) {
        for (i = 0; i < devCnt; i++) /* Copy devices found form local Nfca list
                                        into global device list */
        {
  ...
  if (((gNfcDev.techsFound & RFAL_NFC_POLL_TECH_B) != 0U) &&
      ((gNfcDev.techs2do & RFAL_NFC_POLL_TECH_B) !=
       0U)) /* If a NFC-B device was found/detected, perform Collision
               Resolution */
  {
    ...
    if (!gNfcDev.isTechInit) {
      ...
      RFAL_EXIT_ON_ERR(
          err,
          rfalFieldOnAndStartGT()); /* Ensure GT again as other technologies
                                       have also been polled */
    ...
    if (!gNfcDev.isOperOngoing) {
      RFAL_EXIT_ON_ERR(err, rfalNfcbPollerStartCollisionResolution(
                                gNfcDev.disc.compMode,
                                (gNfcDev.disc.devLimit - gNfcDev.devCnt),
                                nfcbDevList, &devCnt));
    ...
    if (err != RFAL_ERR_BUSY) {
      ...
      if ((err == RFAL_ERR_NONE) && (devCnt != 0U)) {
        for (i = 0; i < devCnt; i++) /* Copy devices found form local Nfcb list
                                        into global device list */
        {
  ...
  if (((gNfcDev.techsFound & RFAL_NFC_POLL_TECH_F) != 0U) &&
      ((gNfcDev.techs2do & RFAL_NFC_POLL_TECH_F) !=
       0U)) /* If a NFC-F device was found/detected, perform Collision
               Resolution */
  {
    ...
    if (!gNfcDev.isOperOngoing) {
      RFAL_EXIT_ON_ERR(err, rfalNfcfPollerStartCollisionResolution(
                                gNfcDev.disc.compMode,
                                (gNfcDev.disc.devLimit - gNfcDev.devCnt),
                                nfcfDevList, &devCnt));
    ...
    if (err != RFAL_ERR_BUSY) {
      ...
      if ((err == RFAL_ERR_NONE) && (devCnt != 0U)) {
        for (i = 0; i < devCnt; i++) /* Copy devices found form local Nfcf list
                                        into global device list */
        {
  ...
  if (((gNfcDev.techsFound & RFAL_NFC_POLL_TECH_V) != 0U) &&
      ((gNfcDev.techs2do & RFAL_NFC_POLL_TECH_V) !=
       0U)) /* If a NFC-V device was found/detected, perform Collision
               Resolution */
  {
    ...
    err = rfalNfcvPollerCollisionResolution(
        RFAL_COMPLIANCE_MODE_NFC, (gNfcDev.disc.devLimit - gNfcDev.devCnt),
        nfcvDevList, &devCnt);
    if ((err == RFAL_ERR_NONE) && (devCnt != 0U)) {
      for (i = 0; i < devCnt; i++) /* Copy devices found form local Nfcf list
                                      into global device list */
  ...
  if (((gNfcDev.techsFound & RFAL_NFC_POLL_TECH_ST25TB) != 0U) &&
      ((gNfcDev.techs2do & RFAL_NFC_POLL_TECH_ST25TB) !=
       0U)) /* If a ST25TB device was found/detected, perform Collision
               Resolution */
  {
    ...
    if (!gNfcDev.isTechInit) {
      RFAL_EXIT_ON_ERR(
          err, rfalSt25tbPollerInitialize()); /* Initialize RFAL for ST25TB */
      RFAL_EXIT_ON_ERR(
          err,
          rfalFieldOnAndStartGT()); /* Ensure GT again as other technologies
                                       have also been polled */
  ...
  /*******************************************************************************/
  if (((gNfcDev.techsFound & RFAL_NFC_POLL_TECH_PROP) != 0U) &&
      ((gNfcDev.techs2do & RFAL_NFC_POLL_TECH_PROP) !=
       0U)) /* If a device was found/detected, perform Collision Resolution */
  {
    if (!gNfcDev.isTechInit) {
      RFAL_EXIT_ON_ERR(err,
                       rfalNfcpCbPollerInitialize()); /* Initialize RFAL for
...
static ReturnCode rfalNfcPollActivation(uint8_t devIt) {
  ...
  switch (gNfcDev.devList[devIt].type) {
    ...
    case RFAL_NFC_LISTEN_TYPE_NFCA:
      ...
      if (gNfcDev.devList[devIt]
              .dev.nfca.isSleep) /* Check if desired device is in Sleep */
      {
        if (!gNfcDev.isOperOngoing) {
          /* Wake up all cards  */
          RFAL_EXIT_ON_ERR(
          ...
          RFAL_EXIT_ON_ERR(err, rfalNfcaPollerStartSelect(
                                    gNfcDev.devList[devIt].dev.nfca.nfcId1,
                                    gNfcDev.devList[devIt].dev.nfca.nfcId1Len,
                                    &gNfcDev.devList[devIt].dev.nfca.selRes));

          gNfcDev.isOperOngoing = true;
        } else {
          RFAL_EXIT_ON_ERR(err, rfalNfcaPollerGetSelectStatus());

          /* In case multiple NFC-A devices are present, when activating/waking
             a device that is sleeping (not the last one) will make the active
             one to go back to IDLE. Marking it as in sleep (Activity 2.2  9.4.4
             Optional Symbol 2) will ensure that gets correctly activated
             afterwards                                              */
      ...
      gNfcDev.devList[devIt].nfcidLen =
          gNfcDev.devList[devIt].dev.nfca.nfcId1Len;
      ...
      if (nfcaType == RFAL_NFCA_T4T_NFCDEP) {
        nfcaType =
            ((gNfcDev.disc.p2pNfcaPrio) ? RFAL_NFCA_NFCDEP : RFAL_NFCA_T4T);
      }
      ...
      switch (nfcaType) {
        ...
        case RFAL_NFCA_T1T:
          ...
          gNfcDev.devList[devIt].nfcid =
              gNfcDev.devList[devIt].dev.nfca.ridRes.uid;
        ...
        case RFAL_NFCA_T4T: /* Device supports ISO-DEP */
          ...
          if (!gNfcDev.isOperOngoing) {
            /* Perform ISO-DEP (ISO14443-4) activation: RATS and PPS if
             * supported */
            rfalIsoDepInitializeWithParams(
                gNfcDev.disc.compMode, RFAL_ISODEP_MAX_R_RETRYS,
                RFAL_ISODEP_MAX_WTX_NACK_RETRYS, RFAL_ISODEP_MAX_WTX_RETRYS,
                RFAL_ISODEP_MAX_DSL_RETRYS, RFAL_ISODEP_MAX_I_RETRYS,
                RFAL_ISODEP_RATS_RETRIES);
            RFAL_EXIT_ON_ERR(err, rfalIsoDepPollAStartActivation(
                                      gNfcDev.disc.isoDepFS, RFAL_ISODEP_NO_DID,
                                      gNfcDev.disc.maxBR,
...
#else
          gNfcDev.devList[devIt].rfInterface =
              RFAL_NFC_INTERFACE_RF; /* No ISO-DEP supported activate using RF
                                        interface */
        ...
        case RFAL_NFCA_NFCDEP: /* Device supports NFC-DEP */
          ...
          RFAL_EXIT_ON_ERR(
              err, rfalNfcNfcDepActivate(&gNfcDev.devList[devIt],
                                         RFAL_NFCDEP_COMM_PASSIVE, NULL, 0));

          gNfcDev.devList[devIt].nfcid =
              gNfcDev.devList[devIt]
                  .proto.nfcDep.activation.Target.ATR_RES.NFCID3;
          gNfcDev.devList[devIt].nfcidLen = RFAL_NFCDEP_NFCID3_LEN;
...
#else
          gNfcDev.devList[devIt].rfInterface =
              RFAL_NFC_INTERFACE_RF; /* No NFC-DEP supported activate using RF
                                        interface */
#endif /* RFAL_FEATURE_NFC_DEP */
          break;

        /*******************************************************************************/
        case RFAL_NFCA_T4T_NFCDEP: /* Multiple proto resolved based on NFCA P2P
                                      Prio config */
        default:
          return RFAL_ERR_WRONG_STATE;
      }
    ...
    case RFAL_NFC_LISTEN_TYPE_NFCB:
      ...
      if (!gNfcDev.isTechInit) {
        ...
        if (gNfcDev.devList[devIt]
                .dev.nfcb.isSleep) /* Check if desired device is in Sleep */
        {
          /* Wake up all cards. SENSB_RES may return collision but the NFCID0 is
           * available to explicitly select NFC-B card via ATTRIB; so error will
           * be ignored here */
          rfalNfcbPollerStartCheckPresence(
              RFAL_NFCB_SENS_CMD_ALLB_REQ, RFAL_NFCB_SLOT_NUM_1,
              &gNfcDev.sensbRes, &gNfcDev.sensbResLen);
        }
      ...
      if (gNfcDev.devList[devIt]
              .dev.nfcb.isSleep) /* Check if desired device is still in Sleep */
      {
        /* Wake up all cards. SENSB_RES may return collision but the NFCID0 is
         * available to explicitly select NFC-B card via ATTRIB; so error will
         * be ignored here */
      ...
      /* Set NFCID */
      gNfcDev.devList[devIt].nfcid =
          gNfcDev.devList[devIt].dev.nfcb.sensbRes.nfcid0;
      ...
      if ((gNfcDev.devList[devIt].dev.nfcb.sensbRes.protInfo.FsciProType &
        ...
        if (!gNfcDev.isOperOngoing) {
          ...
          RFAL_EXIT_ON_ERR(err, rfalIsoDepPollBStartActivation(
                                    gNfcDev.disc.isoDepFS, RFAL_ISODEP_NO_DID,
                                    gNfcDev.disc.maxBR, 0x00,
                                    &gNfcDev.devList[devIt].dev.nfcb, NULL, 0,
                                    &gNfcDev.devList[devIt].proto.isoDep));
    ...
    case RFAL_NFC_LISTEN_TYPE_NFCF:
      ...
      /* Set NFCID */
      gNfcDev.devList[devIt].nfcid =
          gNfcDev.devList[devIt].dev.nfcf.sensfRes.NFCID2;
    ...
    case RFAL_NFC_LISTEN_TYPE_ST25TB:
      ...
      gNfcDev.devList[devIt].rfInterface =
          RFAL_NFC_INTERFACE_RF; /* ST25TB device activated */
      break;
#endif /* RFAL_FEATURE_ST25TB */
  ...
  gNfcDev.activeDev =
      &gNfcDev.devList[devIt]; /* Assign active device to be used further on */
  gNfcDev.isOperOngoing = false;
  return RFAL_ERR_NONE;
}
...
static ReturnCode rfalNfcListenActivation(void) {
  ...
  switch (lmSt) {
    ...
    case RFAL_LM_STATE_ACTIVE_Ax:
      ...
      if (isDataRcvd) /* Check if Reader/Initator has sent some data */
      {
        ...
        if (rfalNfcaListenerIsSleepReq(
                gNfcDev.rxBuf.rfBuf,
                rfalConvBitsToBytes(
                    gNfcDev.rxLen))) /* Check if received data is a SLP_REQ */
        {
          /* Set the Listen Mode in Sleep state */
          RFAL_EXIT_ON_ERR(ret,
                           rfalListenSleepStart(
                               RFAL_LM_STATE_SLEEP_A, gNfcDev.rxBuf.rfBuf,
                               sizeof(gNfcDev.rxBuf.rfBuf), &gNfcDev.rxLen));
        }
        ...
        /* Check if received data is a valid RATS */
                     ...
                     gNfcDev.rxBuf.rfBuf,
                     (uint8_t)rfalConvBitsToBytes(gNfcDev.rxLen))) {
          ...
          rxParam.rxBuf =
              (rfalIsoDepBufFormat *)&gNfcDev.rxBuf
                  .isoDepBuf; /*  PRQA S 0310 # MISRA 11.3 - Intentional safe
                                 cast to avoiding large buffer duplication */
          rxParam.rxLen = &gNfcDev.rxLen;
          rxParam.isoDepDev = &gNfcDev.devList->proto.isoDep;
          rxParam.isRxChaining = &gNfcDev.isRxChaining;

          rfalListenSetState(
              RFAL_LM_STATE_CARDEMU_4A); /* Set next state CE T4T */
          rfalIsoDepInitialize();        /* Initialize ISO-DEP layer to handle
                                            ISO14443-a activation / RATS */

          /* Set ISO-DEP layer to digest RATS and handle activation */
          RFAL_EXIT_ON_ERR(ret, rfalIsoDepListenStartActivation(
                                    &atsParam, NULL, gNfcDev.rxBuf.rfBuf,
                                    gNfcDev.rxLen, rxParam));
        }
        ...
        /* Check if received data is a valid ATR_REQ */
          ...
          RFAL_EXIT_ON_ERR(ret,
                           rfalNfcNfcDepActivate(
                               gNfcDev.devList, RFAL_NFCDEP_COMM_PASSIVE,
                               &gNfcDev.rxBuf.rfBuf[hdrLen],
                               (rfalConvBitsToBytes(gNfcDev.rxLen) - hdrLen)));
        }
#endif /* RFAL_FEATURE_NFC_DEP */
    ...
    case RFAL_LM_STATE_CARDEMU_4A: /* T4T ISO-DEP activation */
      ...
      return (
          (ret == RFAL_ERR_LINK_LOSS)
              ? RFAL_ERR_PROTO
              : ret); /* Link loss during protocol activation, reMap error */
    ...
    case RFAL_LM_STATE_READY_F: /* NFC-F CE activation */
      ...
      if (isDataRcvd) /* Wait for the first received data */
      {
        ...
        if (rfalNfcDepIsAtrReq(&gNfcDev.rxBuf.rfBuf[hdrLen],
                               (rfalConvBitsToBytes(gNfcDev.rxLen) - hdrLen),
                               gNfcDev.devList->nfcid)) {
        ...
        {
          rfalListenSetState(
              RFAL_LM_STATE_CARDEMU_3); /* First data already received - set T3T
                                           CE */
        }
      }
      return RFAL_ERR_BUSY;
    ...
    case RFAL_LM_STATE_TARGET_F:
      ...
      if (ret == RFAL_ERR_NONE) {
        gNfcDev.devList->rfInterface = RFAL_NFC_INTERFACE_NFCDEP;
        gNfcDev.devList->nfcid =
            gNfcDev.devList->proto.nfcDep.activation.Initiator.ATR_REQ.NFCID3;
    ...
    case RFAL_LM_STATE_IDLE: /* AP2P activation */
      if (isDataRcvd)        /* Check if Reader/Initator has sent some data */
      {
        if ((gNfcDev.lmMask & RFAL_LM_MASK_ACTIVE_P2P) !=
            0U) /* Check if AP2P is enabled */
        {
#if RFAL_FEATURE_NFC_DEP
          /* Calculate the header length in NFC-A or NFC-F mode*/
          hdrLen = ((bitRate == RFAL_BR_106)
          ...
          if (rfalNfcDepIsAtrReq(&gNfcDev.rxBuf.rfBuf[hdrLen],
            ...
            RFAL_EXIT_ON_ERR(
                ret, rfalNfcNfcDepActivate(
                         gNfcDev.devList, RFAL_NFCDEP_COMM_ACTIVE,
                         &gNfcDev.rxBuf.rfBuf[hdrLen],
                         (rfalConvBitsToBytes(gNfcDev.rxLen) - hdrLen)));
          } else
#endif /* RFAL_FEATURE_NFC_DEP */
...
static ReturnCode rfalNfcNfcDepActivate(rfalNfcDevice *device,
  ...
  if (gNfcDev.state < RFAL_NFC_STATE_LISTEN_TECHDETECT) {
    ...
    /* Perform NFC-DEP (P2P) activation: ATR and PSL if supported */
    return rfalNfcDepInitiatorHandleActivation(&initParam, gNfcDev.disc.maxBR,
                                               &device->proto.nfcDep);
  }
  /* If we are in Listen mode */
#if RFAL_FEATURE_LISTEN_MODE
  else if (rfalNfcIsRemDevPoller(device->type) &&
           (gNfcDev.state >= RFAL_NFC_STATE_LISTEN_TECHDETECT)) {
    rfalNfcDepListenActvParam actvParams;
    rfalNfcDepTargetParam targetParam;

    RFAL_MEMCPY(targetParam.nfcid3, (uint8_t *)gNfcDev.disc.nfcid3,
    ...
    actvParams.rxBuf =
        (rfalNfcDepBufFormat *)&gNfcDev.rxBuf
            .nfcDepBuf; /*  PRQA S 0310 # MISRA 11.3 - Intentional safe cast to
                           avoiding large buffer duplication */
    ...
    rfalListenSetState(((device->type == RFAL_NFC_POLL_TYPE_NFCA)
                            ? RFAL_LM_STATE_TARGET_A
                            : RFAL_LM_STATE_TARGET_F));

    rfalNfcDepInitialize();
    /* Perform NFC-DEP (P2P) activation: send ATR_RES and handle activation */
    return rfalNfcDepListenStartActivation(&targetParam, atrReq, atrReqLen,
                                           actvParams);
  }
#endif /* RFAL_FEATURE_LISTEN_MODE */
...
static ReturnCode rfalNfcDeactivation(void) {
  ...
  if (gNfcDev.activeDev != NULL) {
    if (rfalNfcIsRemDevListener(
            gNfcDev.activeDev->type)) /* Listen mode no additional deactivation
                                         to be performed*/
    {
      switch (gNfcDev.activeDev->rfInterface) {
        /*******************************************************************************/
        ...
        case RFAL_NFC_INTERFACE_ISODEP:
          ...
          if (!gNfcDev.isOperOngoing) {
            ...
            RFAL_EXIT_ON_BUSY(
                ret, rfalIsoDepGetDeselectStatus()); /* Check if deselection has
                                                        finished */
  ...
  if ((gNfcDev.deactType == RFAL_NFC_DEACTIVATE_SLEEP) &&
    ...
    if (!gNfcDev.isDeactivating) /* Check if the Field deactivation has not
                                    started */
    {
#if RFAL_FEATURE_WAKEUP_MODE
      rfalWakeUpModeStop();
      ...
      if ((gNfcDev.isFieldOn) &&
          rfalNfcHasPollerTechs()) /* Check if configured to Poll modes and the
                                      Field is On */
      {
        aux = platformTimerIsExpired(
            gNfcDev
                .discTmr); /* Check total duration timer is already expired */
        if (((platformGetSysTick() + RFAL_NFC_T_FIELD_OFF) > gNfcDev.discTmr) ||
            (aux)) /* In case Total Duration has expired or expring in less than
                      tFIELD_OFF */
        {
          platformTimerDestroy(gNfcDev.discTmr);
          gNfcDev.discTmr = (uint32_t)platformTimerCreate(
              RFAL_NFC_T_FIELD_OFF); /* Ensure that Operating Field is in Off
                                        condition at least tFIELD_OFF */
        }
    ...
    {
      if (!platformTimerIsExpired(gNfcDev.discTmr)) {
        return RFAL_ERR_BUSY; /* Ensure Operating Field in Off condition for the
                                 time remaining */
      }
    }
  }
