...
******************************************************************************
*/
#define ST25R3916_SPACE_B \
  0x40U /*!< ST25R3916 Space-B indicator                          */
#ifdef ST25R3916B
#define ST25R3916_SPACE_B_REG_LEN \
  24U /*!< Number of register in the space B                    */
#else
#define ST25R3916_SPACE_B_REG_LEN \
  16U  /*!< Number of register in the space B                    */
#endif /* ST25R3916B */

#define ST25R3916_FIFO_STATUS_LEN \
  2 /*!< Number of FIFO Status Register                       */

#define ST25R3916_PTM_A_LEN \
  15U /*!< Passive target memory A config length                */
#define ST25R3916_PTM_B_LEN \
  0U /*!< Passive target memory B config length                */
#define ST25R3916_PTM_F_LEN \
  21U /*!< Passive target memory F config length                */
#define ST25R3916_PTM_TSN_LEN \
  12U /*!< Passive target memory TSN data length                */

/*! Full Passive target memory length */
#define ST25R3916_PTM_LEN                                            \
  (ST25R3916_PTM_A_LEN + ST25R3916_PTM_B_LEN + ST25R3916_PTM_F_LEN + \
   ST25R3916_PTM_TSN_LEN)

/* IO configuration registers */
#define ST25R3916_REG_IO_CONF1 \
  0x00U /*!< RW IO Configuration Register 1                       */
#define ST25R3916_REG_IO_CONF2 \
  0x01U /*!< RW IO Configuration Register 2                       */

/* Operation control and mode definition registers */
#define ST25R3916_REG_OP_CONTROL \
  0x02U /*!< RW Operation Control Register                        */
#define ST25R3916_REG_MODE \
  0x03U /*!< RW Mode Definition Register                          */
#define ST25R3916_REG_BIT_RATE \
  0x04U /*!< RW Bit Rate Definition Register                      */
...
#define ST25R3916_REG_EMD_SUP_CONF \
  (ST25R3916_SPACE_B |             \
   0x05U) /*!< RW EMD Suppression Configuration Register            */
...
#define ST25R3916_REG_AUX \
  0x0AU /*!< RW Auxiliary Definition Register                     */

/* Receiver Configuration registers */
#define ST25R3916_REG_RX_CONF1 \
  0x0BU /*!< RW Receiver Configuration Register 1                 */
#define ST25R3916_REG_RX_CONF2 \
  0x0CU /*!< RW Receiver Configuration Register 2                 */
#define ST25R3916_REG_RX_CONF3 \
  0x0DU /*!< RW Receiver Configuration Register 3                 */
#define ST25R3916_REG_RX_CONF4 \
  0x0EU /*!< RW Receiver Configuration Register 4                 */
...
#define ST25R3916_REG_GPT1 \
  0x13U /*!< RW General Purpose Timer Register 1                  */
#define ST25R3916_REG_GPT2 \
  0x14U /*!< RW General Purpose Timer Register 2                  */
#define ST25R3916_REG_PPON2 \
  0x15U /*!< RW PPON2 Field waiting Timer Register                */
...
#define ST25R3916_REG_IRQ_MAIN \
  0x1AU /*!< R  Main Interrupt Register                           */
...
#define ST25R3916_REG_IRQ_TARGET \
  0x1DU /*!< R  ST25R3916 Target Interrupt Register               */
...
#define ST25R3916_REG_AD_RESULT \
  0x25U /*!< R  A/D Converter Output Register                     */

/* Antenna tuning registers */
#define ST25R3916_REG_ANT_TUNE_A \
  0x26U /*!< RW Antenna Tuning Control (AAT-A) Register 1         */
#define ST25R3916_REG_ANT_TUNE_B \
  0x27U /*!< RW Antenna Tuning Control (AAT-B) Register 2         */

/* Antenna Driver and Modulation registers */
#define ST25R3916_REG_TX_DRIVER \
  0x28U /*!< RW TX driver register                                */
#define ST25R3916_REG_PT_MOD \
  0x29U /*!< RW PT modulation Register                            */
...
#define ST25R3916_REG_OVERSHOOT_CONF1 \
  (ST25R3916_SPACE_B |                \
   0x30U) /*!< RW  Overshoot Protection Configuration Register 1    */
#define ST25R3916_REG_OVERSHOOT_CONF2 \
  (ST25R3916_SPACE_B |                \
   0x31U) /*!< RW  Overshoot Protection Configuration Register 2    */
#define ST25R3916_REG_UNDERSHOOT_CONF1 \
  (ST25R3916_SPACE_B |                 \
   0x32U) /*!< RW  Undershoot Protection Configuration Register 1   */
#define ST25R3916_REG_UNDERSHOOT_CONF2 \
  (ST25R3916_SPACE_B |                 \
   0x33U) /*!< RW  Undershoot Protection Configuration Register 2   */

#ifdef ST25R3916B
/* AWS Configuration Registers */
#define ST25R3916_REG_AWS_CONF1 \
  (ST25R3916_SPACE_B | 0x2EU) /*!< RW  AWS Configuration Register 1 */
#define ST25R3916_REG_AWS_CONF2 \
  (ST25R3916_SPACE_B | 0x2FU) /*!< RW  AWS Configuration Register 2 */
#define ST25R3916_REG_AWS_TIME1 \
  (ST25R3916_SPACE_B | 0x34U) /*!< RW  AWS Time Register 1 */
#define ST25R3916_REG_AWS_TIME2 \
  (ST25R3916_SPACE_B | 0x35U) /*!< RW  AWS Time Register 2 */
#define ST25R3916_REG_AWS_TIME3 \
  (ST25R3916_SPACE_B | 0x36U) /*!< RW  AWS Time Register 1 */
#define ST25R3916_REG_AWS_TIME4 \
  (ST25R3916_SPACE_B | 0x37U) /*!< RW  AWS Time Register 2 */
#define ST25R3916_REG_AWS_TIME5 \
  (ST25R3916_SPACE_B | 0x38U) /*!< RW  AWS Time Register 1 */
#define ST25R3916_REG_AWS_RC_CAL \
  (ST25R3916_SPACE_B | 0x39U) /*!< RW  AWS Time Register 2 */
#endif                        /* ST25R3916B */
...
#define ST25R3916_REG_MEAS_TX_DELAY \
  0x3BU /*!< RW Capacitance Measurement Configuration Register    */
#endif  /* ST25R3916 */
 ...
 *  \param[in]  values: pointer to a buffer where the result shall be written
 *to. \param[in]  length: Number of registers to be read out.
 *
 *  \return RFAL_ERR_NONE  : Operation successful
 *  \return RFAL_ERR_PARAM : Invalid parameter
 *  \return RFAL_ERR_SEND  : Transmission error or acknowledge not received
 ...
 *
 *  This function is used to write \a val to address \a reg within the
 *ST25R3916.
 *
 ...
 *
 *  Accesses ST25R3916 Passive Target Memory F config and writes the given
 *values
 *
 *  \param[in]  values: pointer to a buffer containing the values to be written
 *                      to the Passive Target Memory
 ...
 *
 *  Accesses ST25R3916 Passive Target Memory TSN data and writes the given
 *values
 *
 *  \param[in]  values: pointer to a buffer containing the values to be written
 *                      to the Passive Target Memory.
 ...
 *
 *  This function is used to read the content of test address \a reg within the
 *ST25R3916
 *
 ...
 *
 *  This function is used to write \a val to test address \a reg within the
 *ST25R3916
 *
 *  \param[in]  reg: Address of the register to write
 *  \param[in]  val: Value to be written
