...
// The power latch has no charger or buck regulator, so it does not implement
// the charger extension (pmic/pmic_charger.h). The `simple` power-manager
// policy that pairs with it never calls that surface.
