...
static bool display_dsi_init(display_driver_t *drv) {
  ...
  drv->DSIVidCfg.HorizontalSyncActive = (uint32_t)(HSYNC * LANE_BYTE_2_PIXEL_CLK_RATIO);
  drv->DSIVidCfg.HorizontalBackPorch = (uint32_t)(HBP * LANE_BYTE_2_PIXEL_CLK_RATIO);
