...
// Monitor mode switch. Allow entry into monitor mode? 0x01: Allow 0x00: Disable
#define FT3168_REG_ID_G_CTRL 0x86
...
#define FT3168_REG_ID_G_TIMEENTERMONITOR 0x87
...
// Chip operating modes. Power consumption mode 0x00: P_ACTIVE 0x01: P_MONITOR
// 0x03: P_HIBERNATE
#define FT3168_REG_ID_G_PMODE 0xA5
...
// ------------------------------------------------------------
// Power modes (see FT3168_REG_ID_G_PMODE)
// ------------------------------------------------------------
typedef enum {
  P_ACTIVE_MODE = 0x00,
  P_MONITOR_MODE = 0x01,
