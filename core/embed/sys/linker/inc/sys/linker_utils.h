...
//
// Current implementation does not merge overlapping or adjacent blocks.
// Such a behaviour is not required for the current use case and at
// worst case it will result in a few more blocks in the region.
