...
typedef enum {
  ...
  SYSCALL_REBOOT_AND_UNLOCK_BOOTLOADER,
  ...
  SYSCALL_NFC_START_DISCOVERY,
  SYSCALL_NFC_STOP_DISCOVERY,
  SYSCALL_NFC_GET_EVENT,
  SYSCALL_NFC_GET_DEVICE_INFO,
  SYSCALL_NFC_TRANSCEIVE,
