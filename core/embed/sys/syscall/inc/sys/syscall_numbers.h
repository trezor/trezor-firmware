...
typedef enum {
  ...
  SYSCALL_NFC_BACKUP_START_DISCOVERY,
  SYSCALL_NFC_BACKUP_STOP_DISCOVERY,
  SYSCALL_NFC_BACKUP_GET_EVENTS,
  SYSCALL_NFC_BACKUP_GET_STATE,
  SYSCALL_NFC_BACKUP_READ_SYSTEM_INFO,
  SYSCALL_NFC_BACKUP_READ_DATA,
  SYSCALL_NFC_BACKUP_WRITE_DATA,
  SYSCALL_NFC_BACKUP_WIPE_MEMORY,
