...
typedef enum {
  ...
  SYSCALL_NFC_STORAGE_START_DISCOVERY,
  SYSCALL_NFC_STORAGE_STOP_DISCOVERY,
  SYSCALL_NFC_STORAGE_GET_EVENTS,
  SYSCALL_NFC_STORAGE_GET_STATE,
  SYSCALL_NFC_STORAGE_READ_SYSTEM_INFO,
  SYSCALL_NFC_STORAGE_READ_DATA,
  SYSCALL_NFC_STORAGE_WRITE_DATA,
  SYSCALL_NFC_STORAGE_WIPE_MEMORY,
