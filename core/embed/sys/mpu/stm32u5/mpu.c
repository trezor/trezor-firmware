...
#define COREAPP_RAM1_START AUX_RAM_START
#define COREAPP_RAM1_SIZE AUX_RAM_SIZE
...
static void mpu_init_fixed_regions(void) {
  ...
  SET_REGION( 4, AUX_RAM_START,            AUX_RAM_SIZE,        SRAM,        YES,    NO );
#endif
...
#ifdef KERNEL
    case MPU_MODE_SAES:
      SET_REGION( 7, KERNEL_URAM_START,        KERNEL_URAM_SIZE,   SRAM,        YES,   YES ); // Unprivileged kernel SRAM
      break;
#endif
    case MPU_MODE_APP:
