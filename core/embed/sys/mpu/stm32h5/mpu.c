...
// STM32H5F5xx has no STM32U585-style "FMC follows the peripherals" special
// case. TODO(H5): once the FMC display is wired, extend the peripheral region
// (or add a dedicated one) to cover the FMC bank at 0x60000000.
#ifdef SECURE_MODE
