...
fn add_crypto(lib: &mut xbuild::CLibrary) {
    ...
    lib.add_sources_from_folder_with_attrs(
        ...
        [
            ...
            "aes/aesccm.c",
            "aes/aescrypt.c",
            "aes/gf128mul.c", // !@# optional (only in prodtest)
            "aes/aesgcm.c",   // !@# optional (only in prodtest)
            "aes/aeskey.c",
            "aes/aestab.c",
            "base32.c",
            "base58.c",
            ...
            "hmac_drbg.c",
            "memzero.c",
            "noise.c", // !@# used only in prodtest (need aesgcm)
            "nem.c",
            "nist256p1.c",
            "pbkdf2.c",
            "rand.c",
