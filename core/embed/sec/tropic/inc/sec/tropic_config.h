...
// TODO: When the canonical config definition is moved out of prodtest, replace
// the two structs below with an #include of that header and remove this file.
...
// This must match g_irreversible_configuration in prodtest_tropic.c.
static const struct lt_config_t TROPIC_I_CONFIG = {
    .obj = {
        // # CFG_START_UP (0x00)
        // | Setting                 | Value                   |
        // |-------------------------|-------------------------|
...
// This must match g_reversible_configuration in prodtest_tropic.c.
static const struct lt_config_t TROPIC_R_CONFIG = {
    .obj = {
        // # CFG_START_UP (0x00)
        // | Setting                 | Value                     |
        // |-------------------------|---------------------------|
