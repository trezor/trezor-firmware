...
if __name__ == "__main__":
    file_name = "core/embed/sec/tropic/inc/sec/tropic_configs.h"
    output_name = "core/embed/sec/tropic/inc/sec/tropic_configs_generated.json"
    manual_filename = "core/embed/sec/tropic/inc/sec/tropic_configs_manual.json"
    make_save(file_name, output_name)
    check_save(output_name, manual_filename)
