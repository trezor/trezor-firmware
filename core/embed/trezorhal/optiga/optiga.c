...
optiga_pin_result optiga_pin_verify_v4(
  ...
  optiga_result ret = optiga_auth_strethed_pin(stretched_pin);
...
static optiga_pin_result optiga_pin_verify_common(
  ...
  // optiga_pin_change(). The caller MUST clear OID_STRETCHED_PIN and
  // OID_PIN_SECRET authorisations.
...
optiga_pin_result optiga_pin_change(
  ...
  // Stretch the new PIN more with the counter-protected PIN secret.
