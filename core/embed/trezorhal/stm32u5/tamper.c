...
HAL_StatusTypeDef lsi_init(void)
{
    ...
    if ((bdcr_temp != RCC_RTCCLKSOURCE_NO_CLK) && (bdcr_temp != RCC_RTCCLKSOURCE_LSI)) {
...
void tamper_init(void)
{
    ...
    TAMP->SCR = TAMP_SCR_CTAMP2F | TAMP_SCR_CITAMP1F | TAMP_SCR_CITAMP2F | TAMP_SCR_CITAMP3F |
                TAMP_SCR_CITAMP5F | TAMP_SCR_CITAMP6F | TAMP_SCR_CITAMP7F | TAMP_SCR_CITAMP8F |
                TAMP_SCR_CITAMP9F | TAMP_SCR_CITAMP11F | TAMP_SCR_CITAMP12F | TAMP_SCR_CITAMP13F;
    ...
    TAMP->CR1 = TAMP_CR1_ITAMP1E |   // backup domain voltage monitoring
    ...
    TAMP->IER = TAMP_IER_TAMP2IE | TAMP_IER_ITAMP1IE | TAMP_IER_ITAMP2IE | TAMP_IER_ITAMP3IE |
                TAMP_IER_ITAMP5IE | TAMP_IER_ITAMP6IE | TAMP_IER_ITAMP7IE | TAMP_IER_ITAMP8IE |
                TAMP_IER_ITAMP9IE | TAMP_IER_ITAMP11IE | TAMP_IER_ITAMP12IE | TAMP_IER_ITAMP13IE;
