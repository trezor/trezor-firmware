...
secbool usb_hid_add(const usb_hid_info_t *info)
{
    ...
    usb_hid_descriptor_block_t *d = usb_alloc_class_descriptors(sizeof(usb_hid_descriptor_block_t));
...
static uint8_t usb_hid_class_setup(USBD_HandleTypeDef *dev, USBD_SetupReqTypedef *req)
{
    usb_hid_state_t *state = (usb_hid_state_t *)dev->pUserData;
