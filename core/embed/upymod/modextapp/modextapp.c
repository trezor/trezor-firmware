...
static MP_DEFINE_CONST_FUN_OBJ_0(mod_extapp_images_obj, mod_extapp_images);
...
static const mp_rom_map_elem_t mod_module_extapp_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_AppRootState),
     MP_ROM_PTR(&mod_extapp_AppRootState_type)},
    ...
    {MP_ROM_QSTR(MP_QSTR_mem_free), MP_ROM_PTR(&mod_extapp_arena_mem_free_obj)},
    {MP_ROM_QSTR(MP_QSTR_root_update), MP_ROM_PTR(&mod_extapp_root_update_obj)},
