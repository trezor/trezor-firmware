...
static const mp_rom_map_elem_t mod_extapp_AppImage_locals_dict_table[] = {
    {MP_ROM_QSTR(MP_QSTR_handle), MP_ROM_PTR(&mod_extapp_AppImage_handle_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_vendor), MP_ROM_PTR(&mod_extapp_AppImage_vendor_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_delete), MP_ROM_PTR(&mod_extapp_AppImage_delete_obj)},
