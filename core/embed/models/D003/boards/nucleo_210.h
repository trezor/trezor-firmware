...
#define ST25R500
#define NFC_SPI_INSTANCE SPI1
#define NFC_SPI_PIN_AF GPIO_AF5_SPI1
#define NFC_SPI_CLK_EN __HAL_RCC_SPI1_CLK_ENABLE
#define NFC_SPI_CLK_DIS __HAL_RCC_SPI1_CLK_DISABLE
#define NFC_SPI_FORCE_RESET __HAL_RCC_SPI1_FORCE_RESET
#define NFC_SPI_RELEASE_RESET __HAL_RCC_SPI1_RELEASE_RESET
#define NFC_SPI_MISO_PORT GPIOA
#define NFC_SPI_MISO_PIN GPIO_PIN_6
#define NFC_SPI_MISO_CLK_EN __HAL_RCC_GPIOA_CLK_ENABLE
#define NFC_SPI_MOSI_PORT GPIOA
#define NFC_SPI_MOSI_PIN GPIO_PIN_7
#define NFC_SPI_MOSI_CLK_EN __HAL_RCC_GPIOA_CLK_ENABLE
#define NFC_SPI_SCK_PORT GPIOA
#define NFC_SPI_SCK_PIN GPIO_PIN_5
#define NFC_SPI_SCK_CLK_EN __HAL_RCC_GPIOA_CLK_ENABLE
#define NFC_SPI_NSS_PORT GPIOC
#define NFC_SPI_NSS_PIN GPIO_PIN_9
#define NFC_SPI_NSS_CLK_EN __HAL_RCC_GPIOC_CLK_ENABLE

#define NFC_INT_PIN GPIO_PIN_0
#define NFC_INT_PORT GPIOA
#define NFC_INT_PIN_CLK_ENA __HAL_RCC_GPIOA_CLK_ENABLE
#define NFC_EXTI_INTERRUPT_GPIOSEL EXTI_GPIOA
#define NFC_EXTI_INTERRUPT_LINE EXTI_LINE_0
#define NFC_EXTI_INTERRUPT_NUM EXTI0_IRQn
#define NFC_EXTI_INTERRUPT_HANDLER EXTI0_IRQHandler
