...
// MCU_CCMRAM + KERNEL_STACK_SIZE
#define AUX_RAM_START (0x10000000 + 8 * 1024)
// MCU_CCMRAM_SIZE - KERNEL_STACK_SIZE  - KERNEL_CCMRAM_SIZE -
// KERNEL_FRAMEBUFFER_SIZE
#define AUX_RAM_SIZE (64 * 1024 - 8 * 1024 - 16 * 1024 - 8 * 1024)
// MCU_SRAM + KERNEL_SRAM_SIZE
#define COREAPP_RAM2_START (0x20000000 + 1 * 1024)
// MCU_SRAM_SIZE - KERNEL_SRAM_SIZE
#define COREAPP_RAM2_SIZE (192 * 1024 - 1 * 1024)
