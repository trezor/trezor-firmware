...
#define TROPIC01_INT_PORT GPIOD
#define TROPIC01_INT_PIN GPIO_PIN_8
#define TROPIC01_INT_CLK_EN __HAL_RCC_GPIOD_CLK_ENABLE
...
#define NRF_SPI_SCK_PIN GPIO_PIN_1
...
#define NRF_UART_INSTANCE USART3
#define NRF_UART_CLK_EN __HAL_RCC_USART3_CLK_ENABLE
#define NRF_UART_CLK_DIS __HAL_RCC_USART3_CLK_DISABLE
#define NRF_UART_FORCE_RESET __HAL_RCC_USART3_FORCE_RESET
#define NRF_UART_RELEASE_RESET __HAL_RCC_USART3_RELEASE_RESET
#define NRF_UART_INTERRUPT_HANDLER USART3_IRQHandler
#define NRF_UART_IRQN USART3_IRQn
#define NRF_UART_PIN_AF GPIO_AF7_USART3
#define NRF_UART_TX_PORT GPIOB
#define NRF_UART_TX_PIN GPIO_PIN_10
#define NRF_UART_TX_CLK_EN __HAL_RCC_GPIOB_CLK_ENABLE
#define NRF_UART_RX_PORT GPIOB
#define NRF_UART_RX_PIN GPIO_PIN_1
#define NRF_UART_RX_CLK_EN __HAL_RCC_GPIOB_CLK_ENABLE
#define NRF_UART_RTS_PORT GPIOD
#define NRF_UART_RTS_PIN GPIO_PIN_11
#define NRF_UART_RTS_CLK_EN __HAL_RCC_GPIOD_CLK_ENABLE
#define NRF_UART_CTS_PORT GPIOA
#define NRF_UART_CTS_PIN GPIO_PIN_5
#define NRF_UART_CTS_CLK_EN __HAL_RCC_GPIOA_CLK_ENABLE
