...
#define HAPTIC_I2C_INSTANCE 2
#define HAPTIC_ACTUATOR "actuators/ld0625bc.h"
#define HAPTIC_TRIG_PIN GPIO_PIN_2
#define HAPTIC_TRIG_PORT GPIOA
#define HAPTIC_TRIG_CLK_ENA __HAL_RCC_GPIOA_CLK_ENABLE
#define HAPTIC_TRIG_AF GPIO_AF14_TIM15
#define HAPTIC_TRIG_TIM TIM15
#define HAPTIC_TRIG_TIM_CLK_ENA __HAL_RCC_TIM15_CLK_ENABLE
#define HAPTIC_TRIG_TIM_CLK_DIS __HAL_RCC_TIM15_CLK_DISABLE
#define HAPTIC_TRIG_TIM_FORCE_RESET __HAL_RCC_TIM15_FORCE_RESET
#define HAPTIC_TRIG_TIM_RELEASE_RESET __HAL_RCC_TIM15_RELEASE_RESET
#define HAPTIC_RESET_PIN GPIO_PIN_3
#define HAPTIC_RESET_PORT GPIOA
#define HAPTIC_RESET_CLK_ENA __HAL_RCC_GPIOA_CLK_ENABLE
