...
#define SECRET_MCU_DEVCE_CERT_SIZE 0x400
...
#define SECRET_KEY_SLOT_3_OFFSET 0x870
#define SECRET_KEY_SLOT_3_LEN SECRET_MCU_DEVCE_CERT_SIZE
#define SECRET_KEY_SLOT_3_PUBLIC 1
...
#define SECRET_MCU_DEVCE_CERT_SLOT 3
