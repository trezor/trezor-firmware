...
#define SIGNATURE_BLOCK_START (0x0C004000)
#define SIGNATURE_BLOCK_MAXSIZE (2 * 8 * 1024)  // 16 kB
#define SIGNATURE_BLOCK_SECTOR_START 0x2
#define SIGNATURE_BLOCK_SECTOR_END 0x3

#define BOARDLOADER_START (0x0C008000)
#define BOARDLOADER_MAXSIZE (12 * 8 * 1024)  // 96 kB
#define BOARDLOADER_SECTOR_START 0x4
#define BOARDLOADER_SECTOR_END 0xF

#define BOARDCAPS_START (0x0C01FF00)
...
#define UPGRADE_BLOCK_START (0x0C3FC000)
#define UPGRADE_BLOCK_MAXSIZE (2 * 8 * 1024)  // 16 kB
#define UPGRADE_BLOCK_SECTOR_START 0x1FE
#define UPGRADE_BLOCK_SECTOR_END 0x1FF
