...
#define BOOTLOADER_START (0x0C01C000)
#define BOOTLOADER_MAXSIZE (32 * 8 * 1024)  // 256 kB
#define BOOTLOADER_SECTOR_START 0xE
#define BOOTLOADER_SECTOR_END 0x2D

#define FIRMWARE_START (0x0805C000)
#define FIRMWARE_START_S (0x0C05C000)
#define FIRMWARE_MAXSIZE (417 * 8 * 1024)  // 3336 kB
#define FIRMWARE_SECTOR_START 0x2E
#define FIRMWARE_SECTOR_END 0x1CE

#define ASSETS_START (0x0839E000)
#define ASSETS_MAXSIZE (16 * 8 * 1024)  // 128 kB
#define ASSETS_SECTOR_START 0x1CF
#define ASSETS_SECTOR_END 0x1DE

#define STORAGE_1_START (0x0C3BE000)
#define STORAGE_1_MAXSIZE (16 * 8 * 1024)  // 128 kB
#define STORAGE_1_SECTOR_START 0x1DF
#define STORAGE_1_SECTOR_END 0x1EE

#define STORAGE_2_START (0x0C3DE000)
#define STORAGE_2_MAXSIZE (16 * 8 * 1024)  // 128 kB
#define STORAGE_2_SECTOR_START 0x1EF
#define STORAGE_2_SECTOR_END 0x1FE

// BOOTAREA overlaps bootloader, firmware, assets and storage
#define NONBLDR_START (0x0C01C000)
#define NONBLDR_MAXSIZE (497 * 8 * 1024)  // 3976 kB
#define NONBLDR_SECTOR_START 0xE
#define NONBLDR_SECTOR_END 0x1FE

#define BOOTUCB_START (0x0C3FE000)
#define BOOTUCB_MAXSIZE (1 * 8 * 1024)  // 8 kB
#define BOOTUCB_SECTOR_START 0x1FF
#define BOOTUCB_SECTOR_END 0x1FF
