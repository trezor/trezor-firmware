...
#define BOOTLOADER_MAXSIZE (40 * 8 * 1024)  // 320 kB
#define BOOTLOADER_SECTOR_START 0xF
#define BOOTLOADER_SECTOR_END 0x36

#define FIRMWARE_START (0x0806E000)
#define FIRMWARE_START_S (0x0C06E000)
#define FIRMWARE_MAXSIZE (409 * 8 * 1024)  // 3272 kB
#define FIRMWARE_SECTOR_START 0x37
...
#define AUX1_RAM_SIZE (416 * 1024)

#define APP_ARENA_RAM_START (0x20200000)
#define APP_ARENA_RAM_SIZE (384 * 1024)
