...
#define FIRMWARE_START (0x08044000)
#define FIRMWARE_MAXSIZE (430 * 8 * 1024)  // 3440 kB
#define FIRMWARE_SECTOR_START 0x22
#define FIRMWARE_SECTOR_END 0x1CF

#define SECMON_START (0x0C044000)
#define SECMON_MAXSIZE (128 * 1024)  // 128 kB
#define SECMON_SECTOR_START 0x22
#define SECMON_SECTOR_END 0x31

#define KERNEL_START (0x08064000)
#define KERNEL_MAXSIZE (3312 * 1024)  // 3312 kB
#define KERNEL_SECTOR_START 0x32
#define KERNEL_SECTOR_END 0x1CF
...
#define ASSETS_START (0x083E0000)
