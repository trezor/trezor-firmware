...
// ---------------------------------------------------------------------------
// External NvM: AT25SF161B (U12) connected via OCTOSPI1 in Quad-SPI mode.
// Pin assignments from PICO schematic (PICO_NVM.SchDoc / PICO_MCU.SchDoc,
// Rev A, 2026-06-25). AF numbers from STM32U585 datasheet Table 17.
// ---------------------------------------------------------------------------

// Route OSPI kernel clock to PLL2Q (100 MHz) instead of the default SYSCLK.
// Handled in startup_init.c under #ifdef USE_PLL2_FOR_OSPI.
#define USE_PLL2_FOR_OSPI 1

#define EXT_FLASH_OSPI_INSTANCE OCTOSPI1
#define EXT_FLASH_OSPI_CLK_ENABLE() __HAL_RCC_OSPI1_CLK_ENABLE()
#define EXT_FLASH_OSPI_CLK_DISABLE() __HAL_RCC_OSPI1_CLK_DISABLE()
#define EXT_FLASH_OSPI_FORCE_RESET() __HAL_RCC_OSPI1_FORCE_RESET()
#define EXT_FLASH_OSPI_RELEASE_RESET() __HAL_RCC_OSPI1_RELEASE_RESET()

// CLK — PB10, AF10 (OCTOSPIM_P1_CLK)
#define EXT_FLASH_CLK_PORT GPIOB
#define EXT_FLASH_CLK_PIN GPIO_PIN_10
#define EXT_FLASH_CLK_AF GPIO_AF10_OCTOSPI1
#define EXT_FLASH_CLK_CLK_EN() __HAL_RCC_GPIOB_CLK_ENABLE()

// NCS — PA4, AF3 (OCTOSPIM_P1_NCS)
#define EXT_FLASH_NCS_PORT GPIOA
#define EXT_FLASH_NCS_PIN GPIO_PIN_4
#define EXT_FLASH_NCS_AF GPIO_AF3_OCTOSPI1
#define EXT_FLASH_NCS_CLK_EN() __HAL_RCC_GPIOA_CLK_ENABLE()

// IO0 (SI) — PB1, AF10 (OCTOSPI1_IO0)
#define EXT_FLASH_IO0_PORT GPIOB
#define EXT_FLASH_IO0_PIN GPIO_PIN_1
#define EXT_FLASH_IO0_AF GPIO_AF10_OCTOSPI1
#define EXT_FLASH_IO0_CLK_EN() __HAL_RCC_GPIOB_CLK_ENABLE()

// IO1 (SO) — PB0, AF10 (OCTOSPI1_IO1)
#define EXT_FLASH_IO1_PORT GPIOB
#define EXT_FLASH_IO1_PIN GPIO_PIN_0
#define EXT_FLASH_IO1_AF GPIO_AF10_OCTOSPI1
#define EXT_FLASH_IO1_CLK_EN() __HAL_RCC_GPIOB_CLK_ENABLE()

// IO2 (WP#) — PA7, AF10 (OCTOSPI1_IO2)
#define EXT_FLASH_IO2_PORT GPIOA
#define EXT_FLASH_IO2_PIN GPIO_PIN_7
#define EXT_FLASH_IO2_AF GPIO_AF10_OCTOSPI1
#define EXT_FLASH_IO2_CLK_EN() __HAL_RCC_GPIOA_CLK_ENABLE()

// IO3 (HOLD#) — PA6, AF10 (OCTOSPI1_IO3)
#define EXT_FLASH_IO3_PORT GPIOA
#define EXT_FLASH_IO3_PIN GPIO_PIN_6
#define EXT_FLASH_IO3_AF GPIO_AF10_OCTOSPI1
#define EXT_FLASH_IO3_CLK_EN() __HAL_RCC_GPIOA_CLK_ENABLE()

// DQS — PB2 (not used in SDR Quad-SPI mode; listed for reference)
