...
// GC9307C (LX240D4508CTP05A/B) over i8080 FMC bus (see DISPLAY_IM0-2 below).
// Pinout, resolution and init sequence are identical to the LX200B4501CTP03A/B
// module (see display/i8080/panels/lx200b4501ctp03.c), still supported as an
// alternate display_panel_lx200b4501ctp03 build option. Same reset/DC/
// power-enable wiring is also used by the ST7789-based DEM240320B1 panel (see
...
// TROPIC01 secure element over SPI3.
// NOTE: PG9 (SCK) is in the VDDIO2 power domain (shared with the nRF GPIOG
// pins), so VDDIO2 must be supplied/enabled for the bus to work.
// NOTE: on STM32U585 SPI3 is AF6 on PG9/PC11, but SPI3_MOSI on PD6 is AF5 --
// the MOSI alternate function is therefore overridden below. Verify pins and
// AFs against the schematic / STM32U585 datasheet alternate-function table.
#define TROPIC01_PWR_PORT GPIOC
#define TROPIC01_PWR_PIN GPIO_PIN_4
#define TROPIC01_PWR_CLK_EN __HAL_RCC_GPIOC_CLK_ENABLE
#define TROPIC01_INT_PORT GPIOH
#define TROPIC01_INT_PIN GPIO_PIN_1
#define TROPIC01_INT_CLK_EN __HAL_RCC_GPIOH_CLK_ENABLE
#define TROPIC01_SPI SPI3
#define TROPIC01_SPI_GTZC_PERIPH GTZC_PERIPH_SPI3
#define TROPIC01_SPI_CLK_EN __HAL_RCC_SPI3_CLK_ENABLE
#define TROPIC01_SPI_CLK_DIS __HAL_RCC_SPI3_CLK_DISABLE
#define TROPIC01_SPI_FORCE_RESET __HAL_RCC_SPI3_FORCE_RESET
#define TROPIC01_SPI_RELEASE_RESET __HAL_RCC_SPI3_RELEASE_RESET
#define TROPIC01_SPI_PIN_AF GPIO_AF6_SPI3
#define TROPIC01_SPI_MOSI_AF GPIO_AF5_SPI3
#define TROPIC01_SPI_SCK_PORT GPIOG
#define TROPIC01_SPI_SCK_PIN GPIO_PIN_9
#define TROPIC01_SPI_SCK_EN __HAL_RCC_GPIOG_CLK_ENABLE
#define TROPIC01_SPI_MISO_PORT GPIOC
#define TROPIC01_SPI_MISO_PIN GPIO_PIN_11
#define TROPIC01_SPI_MISO_EN __HAL_RCC_GPIOC_CLK_ENABLE
#define TROPIC01_SPI_MOSI_PORT GPIOD
#define TROPIC01_SPI_MOSI_PIN GPIO_PIN_6
#define TROPIC01_SPI_MOSI_EN __HAL_RCC_GPIOD_CLK_ENABLE
#define TROPIC01_SPI_NSS_PORT GPIOF
#define TROPIC01_SPI_NSS_PIN GPIO_PIN_5
#define TROPIC01_SPI_NSS_EN __HAL_RCC_GPIOF_CLK_ENABLE
