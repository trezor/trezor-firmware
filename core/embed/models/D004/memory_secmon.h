...
//
// PRELIMINARY H5F5 secmon memory map (D004 / STM32H5F5J-DK bring-up).
...
// H5F5 SRAM bank map (total 1.5 MB, secure/non-secure split) before this model
// links with the secure monitor.
