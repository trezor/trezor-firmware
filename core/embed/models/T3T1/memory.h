...
#define BOARDLOADER_MAXSIZE (9 * 8 * 1024)  // 72 kB
#define BOARDLOADER_SECTOR_START 0x2
#define BOARDLOADER_SECTOR_END 0x0A

#define BOARDCAPS_START 0x0C015F00
#define BOARDCAPS_MAXSIZE 0x100

#define BOOTLOADER_START 0x0C016000
#define BOOTLOADER_MAXSIZE (16 * 8 * 1024)  // 128 kB
#define BOOTLOADER_SECTOR_START 0x0B
#define BOOTLOADER_SECTOR_END 0x1A

#define STORAGE_1_START 0x0C036000
#define STORAGE_1_MAXSIZE (8 * 8 * 1024)  // 64 kB
#define STORAGE_1_SECTOR_START 0x1B
#define STORAGE_1_SECTOR_END 0x22

#define STORAGE_2_START 0x0C046000
#define STORAGE_2_MAXSIZE (8 * 8 * 1024)  // 64 kB
#define STORAGE_2_SECTOR_START 0x23
#define STORAGE_2_SECTOR_END 0x2A

#define FIRMWARE_START 0x0C056000
#define FIRMWARE_MAXSIZE (205 * 8 * 1024)  // 1640 kB
#define FIRMWARE_SECTOR_START 0x2B
...
#define AUX2_RAM_START 0x30040000
#define AUX2_RAM_SIZE (287 * 1024)
