...
#define AUX2_RAM_SIZE (220 * 1024)

#define APPDATA_RAM_START (0x3006E000)
#define APPDATA_RAM_SIZE (215 * 1024)

// #define FB2_RAM_START 0x30087C00
// #define FB2_RAM_SIZE (115200)

#define FB1_RAM_START 0x300A3E00
#define FB1_RAM_SIZE (115200)

#define APPCODE_START (0)
#define APPCODE_MAXSIZE (0)
