...
80 MHz PLLCLK is used as system clock SYSCLK, which is not divided further, so HCLK is also 80 MHz.

APB1, APB2 and APB3 are also not divided, so PCLK1, PCLK2 and PCLK3 are all 80 MHz
...
### I2C1
I2C1 is clocked from PCLK1, 80 MHz

### I2C2
I2C2 is clocked from PCLK1, 80 MHz

### I2C3
I2C3 is clocked from PCLK3, 80 MHz
