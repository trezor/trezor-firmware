    ...
    .subarea[0] =
        {
            ...
            .num_sectors = BOARDLOADER_SECTOR_END - BOARDLOADER_SECTOR_START + 1,
        },
};
    ...
    .subarea[1] =
        {
            ...
            .num_sectors = FIRMWARE_P2_SECTOR_END - FIRMWARE_P2_SECTOR_START + 1,
        },
};
...
const flash_area_t WIPE_AREA = {
    ...
    .subarea[1] =
        {
            .first_sector = 6,
            .num_sectors = 9,  // sector 15 skipped due to bootloader MPU settings
        },
    .subarea[2] =
        {
            .first_sector = 16,
