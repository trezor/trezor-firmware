...
///     """
STATIC mp_obj_t mod_trezorui_Display_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorui_Display_bar_obj, 6, 6, mod_trezorui_Display_bar);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorui_Display_backlight_obj, 1, 2, mod_trezorui_Display_backlight);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorui_Display_clear_save_obj, mod_trezorui_Display_clear_save);
...
STATIC const mp_rom_map_elem_t mod_trezorui_Display_locals_dict_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_clear_save), MP_ROM_PTR(&mod_trezorui_Display_clear_save_obj)},
...
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorui_Display_locals_dict, mod_trezorui_Display_locals_dict_table);
