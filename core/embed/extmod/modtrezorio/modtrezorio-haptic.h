...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorio_haptic_set_enabled_obj, mod_trezorio_haptic_set_enabled);

STATIC const mp_rom_map_elem_t mod_trezorio_haptic_globals_table[] = {
    {MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_haptic)},
    {MP_ROM_QSTR(MP_QSTR_haptic_set_enabled), MP_ROM_PTR(&mod_trezorio_haptic_set_enabled_obj)},

};
STATIC MP_DEFINE_CONST_DICT(mod_trezorio_haptic_globals, mod_trezorio_haptic_globals_table);
