...
///     """
///     """
STATIC mp_obj_t mod_trezorio_FlashOTP_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorio_FlashOTP_write_obj, 4, 4, mod_trezorio_FlashOTP_write);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorio_FlashOTP_read_obj, 4, 4, mod_trezorio_FlashOTP_read);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorio_FlashOTP_is_locked_obj, mod_trezorio_FlashOTP_is_locked);
...
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorio_FlashOTP_locals_dict, mod_trezorio_FlashOTP_locals_dict_table);
