...
static secbool wrapped_ui_wait_callback(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorconfig_is_unlocked_obj, mod_trezorconfig_is_unlocked);
...
///     """
STATIC mp_obj_t mod_trezorconfig_change_pin(size_t n_args, const mp_obj_t *args)
{
    ...
    if (sectrue !=
        storage_change_pin(
            oldpin.buf, oldpin.len, newpin.buf, newpin.len, old_ext_salt, new_ext_salt)) {
        return mp_const_false;
    }
    return mp_const_true;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorconfig_change_pin_obj, 4, 4, mod_trezorconfig_change_pin);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorconfig_ensure_not_wipe_code_obj, mod_trezorconfig_ensure_not_wipe_code);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorconfig_has_wipe_code_obj, mod_trezorconfig_has_wipe_code);
...
///     """
STATIC mp_obj_t mod_trezorconfig_change_wipe_code(size_t n_args, const mp_obj_t *args)
{
    mp_buffer_info_t pin_b = {0};
    ...
    if (sectrue != storage_change_wipe_code(
                       pin_b.buf, pin_b.len, ext_salt, wipe_code_b.buf, wipe_code_b.len)) {
        return mp_const_false;
    }
    return mp_const_true;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorconfig_change_wipe_code_obj, 3, 3, mod_trezorconfig_change_wipe_code);
...
STATIC mp_obj_t mod_trezorconfig_set(size_t n_args, const mp_obj_t *args)
{
    ...
    if (value.len > UINT16_MAX || sectrue != storage_set(appkey, value.buf, value.len)) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorconfig_delete_obj, 2, 4, mod_trezorconfig_delete);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorconfig_set_counter_obj, 3, 4, mod_trezorconfig_set_counter);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorconfig_next_counter_obj, 2, 3, mod_trezorconfig_next_counter);
...
STATIC const qstr mod_trezorconfig_StorageMessage_fields[] = {
    MP_QSTR_NO_MSG, MP_QSTR_VERIFYING_PIN_MSG, MP_QSTR_PROCESSING_MSG, MP_QSTR_STARTING_MSG,
    MP_QSTR_WRONG_PIN_MSG};
STATIC MP_DEFINE_ATTRTUPLE(
    mod_trezorconfig_StorageMessage_obj, mod_trezorconfig_StorageMessage_fields,
    (sizeof(mod_trezorconfig_StorageMessage_fields) / sizeof(qstr)), MP_ROM_INT(0), MP_ROM_INT(1),
    MP_ROM_INT(2), MP_ROM_INT(3), MP_ROM_INT(4));
...
STATIC const mp_rom_map_elem_t mp_module_trezorconfig_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_is_unlocked), MP_ROM_PTR(&mod_trezorconfig_is_unlocked_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_has_wipe_code), MP_ROM_PTR(&mod_trezorconfig_has_wipe_code_obj)},
    {MP_ROM_QSTR(MP_QSTR_change_wipe_code), MP_ROM_PTR(&mod_trezorconfig_change_wipe_code_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_StorageMessage), MP_ROM_PTR(&mod_trezorconfig_StorageMessage_obj)},
};
