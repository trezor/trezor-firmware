...
///     """
STATIC mp_obj_t mod_trezorcrypto_Ripemd160_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_Ripemd160_update_obj, mod_trezorcrypto_Ripemd160_update);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Ripemd160_digest_obj, mod_trezorcrypto_Ripemd160_digest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Ripemd160___del___obj, mod_trezorcrypto_Ripemd160___del__);
...
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorcrypto_Ripemd160_locals_dict, mod_trezorcrypto_Ripemd160_locals_dict_table);
