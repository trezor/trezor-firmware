...
///     """
STATIC mp_obj_t mod_trezorcrypto_Blake256_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_Blake256_update_obj, mod_trezorcrypto_Blake256_update);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Blake256_digest_obj, mod_trezorcrypto_Blake256_digest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Blake256___del___obj, mod_trezorcrypto_Blake256___del__);
...
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorcrypto_Blake256_locals_dict, mod_trezorcrypto_Blake256_locals_dict_table);
