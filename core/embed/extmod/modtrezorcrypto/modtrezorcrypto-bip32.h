...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_HDNode_derive_obj, 2, 3, mod_trezorcrypto_HDNode_derive);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_HDNode_derive_path_obj, mod_trezorcrypto_HDNode_derive_path);
...
STATIC mp_obj_t mod_trezorcrypto_HDNode_serialize_public(mp_obj_t self, mp_obj_t version)
{
    ...
    int written = hdnode_serialize_public(&o->hdnode, o->fingerprint, ver, xpub.buf, xpub.alloc);
    if (written <= 0) {
        vstr_clear(&xpub);
        mp_raise_ValueError("Failed to serialize");
    }
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_HDNode_serialize_public_obj, mod_trezorcrypto_HDNode_serialize_public);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode_fingerprint_obj, mod_trezorcrypto_HDNode_fingerprint);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode_child_num_obj, mod_trezorcrypto_HDNode_child_num);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode_chain_code_obj, mod_trezorcrypto_HDNode_chain_code);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode_private_key_obj, mod_trezorcrypto_HDNode_private_key);
...
STATIC mp_obj_t mod_trezorcrypto_HDNode_private_key_ext(mp_obj_t self)
{
    ...
    return mp_obj_new_bytes(
        o->hdnode.private_key_extension, sizeof(o->hdnode.private_key_extension));
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode_private_key_ext_obj, mod_trezorcrypto_HDNode_private_key_ext);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode_public_key_obj, mod_trezorcrypto_HDNode_public_key);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_HDNode_address_obj, mod_trezorcrypto_HDNode_address);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_HDNode_nem_address_obj, mod_trezorcrypto_HDNode_nem_address);
...
STATIC mp_obj_t mod_trezorcrypto_HDNode_nem_encrypt(size_t n_args, const mp_obj_t *args)
{
    ...
    if (!hdnode_nem_encrypt(
            &o->hdnode, *(const ed25519_public_key *)transfer_pk.buf, iv.buf, salt.buf, payload.buf,
            payload.len, (uint8_t *)vstr.buf)) {
        mp_raise_ValueError("HDNode nem encrypt failed");
    }
    return mp_obj_new_str_from_vstr(&mp_type_bytes, &vstr);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_HDNode_nem_encrypt_obj, 5, 5, mod_trezorcrypto_HDNode_nem_encrypt);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode_ethereum_pubkeyhash_obj, mod_trezorcrypto_HDNode_ethereum_pubkeyhash);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_HDNode___del___obj, mod_trezorcrypto_HDNode___del__);
...
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorcrypto_HDNode_locals_dict, mod_trezorcrypto_HDNode_locals_dict_table);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_bip32_from_seed_obj, mod_trezorcrypto_bip32_from_seed);
