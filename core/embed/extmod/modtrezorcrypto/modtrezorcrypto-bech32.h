...
///     """
STATIC mp_obj_t mod_trezorcrypto_bech32_decode(size_t n_args, const mp_obj_t *args)
{
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_bech32_decode_obj, 1, 2, mod_trezorcrypto_bech32_decode);
...
STATIC const mp_rom_map_elem_t mod_trezorcrypto_bech32_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_decode), MP_ROM_PTR(&mod_trezorcrypto_bech32_decode_obj)},
...
STATIC MP_DEFINE_CONST_DICT(mod_trezorcrypto_bech32_globals, mod_trezorcrypto_bech32_globals_table);
