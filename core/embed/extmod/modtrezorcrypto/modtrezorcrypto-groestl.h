...
///     """
STATIC mp_obj_t mod_trezorcrypto_Groestl512_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_Groestl512_update_obj, mod_trezorcrypto_Groestl512_update);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Groestl512_digest_obj, mod_trezorcrypto_Groestl512_digest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Groestl512___del___obj, mod_trezorcrypto_Groestl512___del__);
...
STATIC const mp_rom_map_elem_t mod_trezorcrypto_Groestl512_locals_dict_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_digest_size), MP_ROM_INT(GROESTL512_DIGEST_LENGTH)},
};
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorcrypto_Groestl512_locals_dict, mod_trezorcrypto_Groestl512_locals_dict_table);
