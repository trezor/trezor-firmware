...
///     """
STATIC mp_obj_t mod_trezorcrypto_Blake2s_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_Blake2s_update_obj, mod_trezorcrypto_Blake2s_update);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Blake2s_digest_obj, mod_trezorcrypto_Blake2s_digest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Blake2s___del___obj, mod_trezorcrypto_Blake2s___del__);
...
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorcrypto_Blake2s_locals_dict, mod_trezorcrypto_Blake2s_locals_dict_table);
