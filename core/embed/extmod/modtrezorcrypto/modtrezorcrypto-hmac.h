...
///     """
STATIC mp_obj_t mod_trezorcrypto_Hmac_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_trezorcrypto_Hmac_update_obj, mod_trezorcrypto_Hmac_update);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorcrypto_Hmac_digest_obj, mod_trezorcrypto_Hmac_digest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorcrypto_Hmac___del___obj, mod_trezorcrypto_Hmac___del__);

STATIC const mp_rom_map_elem_t mod_trezorcrypto_Hmac_locals_dict_table[] = {
    {MP_ROM_QSTR(MP_QSTR_update), MP_ROM_PTR(&mod_trezorcrypto_Hmac_update_obj)},
    {MP_ROM_QSTR(MP_QSTR_digest), MP_ROM_PTR(&mod_trezorcrypto_Hmac_digest_obj)},
    {MP_ROM_QSTR(MP_QSTR___del__), MP_ROM_PTR(&mod_trezorcrypto_Hmac___del___obj)},
    {MP_ROM_QSTR(MP_QSTR_SHA256), MP_ROM_INT(SHA256)},
    {MP_ROM_QSTR(MP_QSTR_SHA512), MP_ROM_INT(SHA512)},
};
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorcrypto_Hmac_locals_dict, mod_trezorcrypto_Hmac_locals_dict_table);
