...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorcrypto_bip340_generate_secret_obj, mod_trezorcrypto_bip340_generate_secret);
...
STATIC mp_obj_t mod_trezorcrypto_bip340_publickey(mp_obj_t secret_key)
{
    ...
    vstr_t pk = {0};
    vstr_init_len(&pk, 32);
    int ret = zkp_bip340_get_public_key((const uint8_t *)sk.buf, (uint8_t *)pk.buf);
    if (0 != ret) {
        vstr_clear(&pk);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_bip340_publickey_obj, mod_trezorcrypto_bip340_publickey);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_bip340_sign(mp_obj_t secret_key, mp_obj_t digest)
{
    ...
    int ret = zkp_bip340_sign_digest(
        (const uint8_t *)sk.buf, (const uint8_t *)dig.buf, (uint8_t *)sig.buf, NULL);
    if (0 != ret) {
        vstr_clear(&sig);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_trezorcrypto_bip340_sign_obj, mod_trezorcrypto_bip340_sign);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_bip340_verify_publickey_obj, mod_trezorcrypto_bip340_verify_publickey);
...
///     """
STATIC mp_obj_t
mod_trezorcrypto_bip340_verify(mp_obj_t public_key, mp_obj_t signature, mp_obj_t digest)
{
    ...
    int ret = zkp_bip340_verify_digest(
        (const uint8_t *)pk.buf, (const uint8_t *)sig.buf, (const uint8_t *)dig.buf);
    return mp_obj_new_bool(ret == 0);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_trezorcrypto_bip340_verify_obj, mod_trezorcrypto_bip340_verify);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_bip340_tweak_public_key(size_t n_args, const mp_obj_t *args)
{
    mp_buffer_info_t pk = {0};
    ...
    int ret = zkp_bip340_tweak_public_key((const uint8_t *)pk.buf, rh_ptr, (uint8_t *)tpk.buf);
    if (ret != 0) {
        vstr_clear(&tpk);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_bip340_tweak_public_key_obj, 1, 2, mod_trezorcrypto_bip340_tweak_public_key);
...
///     """
STATIC mp_obj_t mod_trezorcrypto_bip340_tweak_secret_key(size_t n_args, const mp_obj_t *args)
{
    mp_buffer_info_t sk = {0};
    ...
    int ret = zkp_bip340_tweak_private_key((const uint8_t *)sk.buf, rh_ptr, (uint8_t *)tsk.buf);
    if (ret != 0) {
        vstr_clear(&tsk);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorcrypto_bip340_tweak_secret_key_obj, 1, 2, mod_trezorcrypto_bip340_tweak_secret_key);
...
STATIC const mp_rom_map_elem_t mod_trezorcrypto_bip340_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_publickey), MP_ROM_PTR(&mod_trezorcrypto_bip340_publickey_obj)},
...
STATIC MP_DEFINE_CONST_DICT(mod_trezorcrypto_bip340_globals, mod_trezorcrypto_bip340_globals_table);
