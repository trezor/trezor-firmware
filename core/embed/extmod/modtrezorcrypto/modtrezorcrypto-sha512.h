...
///     """
STATIC mp_obj_t mod_trezorcrypto_Sha512_make_new(
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorcrypto_Sha512_update_obj, mod_trezorcrypto_Sha512_update);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Sha512_digest_obj, mod_trezorcrypto_Sha512_digest);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorcrypto_Sha512___del___obj, mod_trezorcrypto_Sha512___del__);
...
STATIC MP_DEFINE_CONST_DICT(
    mod_trezorcrypto_Sha512_locals_dict, mod_trezorcrypto_Sha512_locals_dict_table);
