...
static void ui_progress(mp_obj_t ui_wait_callback, uint32_t current, uint32_t total)
{
    if (mp_obj_is_callable(ui_wait_callback)) {
        mp_call_function_2_protected(
            ui_wait_callback, mp_obj_new_int(current), mp_obj_new_int(total));
    }
}
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorutils_memcpy_obj, 4, 5, mod_trezorutils_memcpy);
...
///     the key.
///     """
STATIC mp_obj_t mod_trezorutils_firmware_hash(size_t n_args, const mp_obj_t *args)
{
    BLAKE2S_CTX ctx;
    ...
    ensure((firmware_size % FW_HASHING_CHUNK_SIZE == 0) * sectrue, "Cannot compute FW hash.");
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorutils_firmware_hash_obj, 0, 2, mod_trezorutils_firmware_hash);
...
STATIC mp_obj_t mod_trezorutils_firmware_vendor(void)
{
    ...
    return mp_obj_new_str_copy(&mp_type_str, (const uint8_t *)vhdr.vstr, vhdr.vstr_len);
#endif
}
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorutils_firmware_vendor_obj, mod_trezorutils_firmware_vendor);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorutils_unit_color_obj, mod_trezorutils_unit_color);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(mod_trezorutils_unit_btconly_obj, mod_trezorutils_unit_btconly);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorutils_unit_packaging_obj, mod_trezorutils_unit_packaging);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorutils_sd_hotswap_enabled_obj, mod_trezorutils_sd_hotswap_enabled);
...
///     """
STATIC mp_obj_t mod_trezorutils_reboot_to_bootloader(size_t n_args, const mp_obj_t *args)
{
#ifndef TREZOR_EMULATOR
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(
    mod_trezorutils_reboot_to_bootloader_obj, 0, 2, mod_trezorutils_reboot_to_bootloader);
...
STATIC mp_obj_t mod_trezorutils_check_firmware_header(mp_obj_t header)
{
    ...
    if (sectrue == check_firmware_header(header_buf.buf, header_buf.len, &info)) {
        ...
        static const qstr fields[4] = {
            MP_QSTR_version, MP_QSTR_vendor, MP_QSTR_fingerprint, MP_QSTR_hash};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorutils_check_firmware_header_obj, mod_trezorutils_check_firmware_header);
...
STATIC mp_obj_t mod_trezorutils_bootloader_locked()
{
    ...
    return mp_const_true;
#else
    return (secret_bootloader_locked() == sectrue) ? mp_const_true : mp_const_false;
#endif
#else
    return mp_const_none;
#endif
...
STATIC MP_DEFINE_CONST_FUN_OBJ_0(
    mod_trezorutils_bootloader_locked_obj, mod_trezorutils_bootloader_locked);
...
STATIC mp_obj_str_t mod_trezorutils_full_name_obj = {
    {&mp_type_str}, 0, sizeof(MODEL_FULL_NAME) - 1, (const byte *)MODEL_FULL_NAME};

STATIC mp_obj_str_t mod_trezorutils_model_usb_manufacturer_obj = {
    {&mp_type_str}, 0, sizeof(MODEL_USB_MANUFACTURER) - 1, (const byte *)MODEL_USB_MANUFACTURER};

STATIC mp_obj_str_t mod_trezorutils_model_usb_product_obj = {
    {&mp_type_str}, 0, sizeof(MODEL_USB_PRODUCT) - 1, (const byte *)MODEL_USB_PRODUCT};
...
STATIC const mp_rom_map_elem_t mp_module_trezorutils_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_firmware_hash), MP_ROM_PTR(&mod_trezorutils_firmware_hash_obj)},
    {MP_ROM_QSTR(MP_QSTR_firmware_vendor), MP_ROM_PTR(&mod_trezorutils_firmware_vendor_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_bootloader_locked), MP_ROM_PTR(&mod_trezorutils_bootloader_locked_obj)},
    {MP_ROM_QSTR(MP_QSTR_unit_color), MP_ROM_PTR(&mod_trezorutils_unit_color_obj)},
    {MP_ROM_QSTR(MP_QSTR_unit_packaging), MP_ROM_PTR(&mod_trezorutils_unit_packaging_obj)},
    {MP_ROM_QSTR(MP_QSTR_unit_btconly), MP_ROM_PTR(&mod_trezorutils_unit_btconly_obj)},
    {MP_ROM_QSTR(MP_QSTR_sd_hotswap_enabled), MP_ROM_PTR(&mod_trezorutils_sd_hotswap_enabled_obj)},
    // various built-in constants
    {MP_ROM_QSTR(MP_QSTR_SCM_REVISION), MP_ROM_PTR(&mod_trezorutils_revision_obj)},
    ...
    {MP_ROM_QSTR(MP_QSTR_MODEL_FULL_NAME), MP_ROM_PTR(&mod_trezorutils_full_name_obj)},
    {MP_ROM_QSTR(MP_QSTR_MODEL_USB_MANUFACTURER),
     MP_ROM_PTR(&mod_trezorutils_model_usb_manufacturer_obj)},
    {MP_ROM_QSTR(MP_QSTR_MODEL_USB_PRODUCT), MP_ROM_PTR(&mod_trezorutils_model_usb_product_obj)},
    {MP_ROM_QSTR(MP_QSTR_INTERNAL_MODEL), MP_ROM_QSTR(MODEL_INTERNAL_NAME_QSTR)},
#ifdef TREZOR_EMULATOR
