...
from trezorlib.firmware import nrf, InvalidSignatureError
...
def wrap(binary_file: Path, output_file: Path) -> None:
    ...
    image = NrfImage.create(
        version=version, img_data=img_data, header_size=pm.mcuboot_pad.size
    )
