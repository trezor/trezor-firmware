...
from trezorlib.root_packet import RootPacket_AppRing0
...
def cli(directory: Path) -> None:
    ...
    rp0 = RootPacket_AppRing0(
        root_ring_0=app_tree.get_root_hash(),
        timestamp=0x78563412,
        flags={"reserved": 0, "is_dangerous": True, "is_dev_signed": False},
        sigmask=3,
