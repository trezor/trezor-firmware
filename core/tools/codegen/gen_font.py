...
if __name__ == "__main__":
    ...
    FaceProcessor("TTSatoshi", "Medium", 42, ext="otf").write_files()
    FaceProcessor("TTSatoshi", "Medium", 21, ext="otf").write_files()
    FaceProcessor("TTSatoshi", "Medium", 18, ext="otf").write_files()
