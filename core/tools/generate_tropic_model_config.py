...
DEST_PATH = CONFIG_DIR / "firmware_config" / "current.yml"
CFG_SPEC_PATH = (
...
# Before changing this file, see README.md in this directory.\n
"""
...
def get_tropic_configuration(path: Path) -> dict:
    ...
    config = {}
    default_cfg = {"reversible_configurations": 1, "irreversible_configurations": 0}
    for type_of_config in ["reversible_configurations", "irreversible_configurations"]:
        ...
        for config_version in all_config_versions[type_of_config]:
            if config_version["version"] == default_cfg[type_of_config]:
...
def generate_config(check: bool) -> None:
    ...
    chip_id = bytes.fromhex("0" * 56 + "41434142" + "0" * 128 + "190a081010" + "0" * 54)
    ...
    config_dict = {
        ...
        "chip_id": chip_id,
        "riscv_fw_version": "2.1.0",  # Version of the RISCV Firmware (also know as Application FW) used in TS7 devices
        "spect_fw_version": "1.3.0",
    ...
    base_config["r_user_data"][TROPIC_FW_VERSION_SLOT] = {
        "value": bytes.fromhex("0000010200000301")  # RISC-V 2.1.0, SPECT 1.3.0
    }
