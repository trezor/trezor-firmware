...
# See core/embed/sec/tropic/config/tropic_configs.c
distribution_version = {  # distribution version 0
    "reversible_configurations": 1,
    "irreversible_configurations": 0,
}
...
def get_tropic_configuration(path: Path) -> dict:
    ...
    config = {}
    for type_of_config, target_version in distribution_version.items():
        short_name = (
        ...
        for config_version in all_config_versions[type_of_config]:
            if config_version["version"] == target_version:
