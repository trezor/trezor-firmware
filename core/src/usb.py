...
# All the interfaces are (conditionally) created and added in add_interfaces()
iface_wire: io.WebUSB | None = None
iface_debug: io.WebUSB | None = None
iface_webauthn: io.HID | None = None
iface_vcp: io.VCP | None = None
