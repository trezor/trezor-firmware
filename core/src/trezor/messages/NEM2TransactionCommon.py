...
if __debug__:
    try:
        ...
        EnumTypeNEM2EntityType = Literal[0, 16705, 16717, 16718, 16724, 16961, 16973, 16974, 17230]
...
class NEM2TransactionCommon(p.MessageType):
    ...
    def get_fields(cls) -> Dict:
        return {
            1: ('type', p.EnumType("NEM2EntityType", (0, 16961, 16705, 16973, 16717, 16718, 16974, 17230, 16724)), 0),
