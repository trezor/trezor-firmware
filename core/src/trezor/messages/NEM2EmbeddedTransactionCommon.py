...
if __debug__:
    try:
        ...
        EnumTypeNEM2EntityType = Literal[0, 16705, 16712, 16717, 16718, 16722, 16724, 16725, 16961, 16973, 16974, 16978, 17220, 17230]
...
class NEM2EmbeddedTransactionCommon(p.MessageType):
    ...
    def get_fields(cls) -> Dict:
        return {
            1: ('type', p.EnumType("NEM2EntityType", (0, 16961, 16705, 17220, 16712, 16973, 16717, 16718, 16974, 17230, 16722, 16978, 16724, 16725)), 0),
