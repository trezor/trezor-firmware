...
BINDING_CONTEXT = BindingContext([(42220, unhexlify('d533ca259b330c7a88f74e000a3faea2d63b7972')), (44787, unhexlify('aa963fc97281d9632d96700ab62a4d1340f9a28a'))])
...
DISPLAY_FORMATS = [
    ...
    DisplayFormat(
        ...
        field_definitions=[
        FieldDefinition(ContainerPath.From, 'Signing Address', AddressNameFormatter),
        ],
    ),
    DisplayFormat(
        binding_context=BINDING_CONTEXT,
