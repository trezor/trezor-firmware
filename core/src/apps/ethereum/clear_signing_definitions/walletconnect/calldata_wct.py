...
BINDING_CONTEXT = BindingContext([(10, unhexlify('ef4461891dfb3ac8572ccf7c794664a8dd927945')), (1, unhexlify('ef4461891dfb3ac8572ccf7c794664a8dd927945')), (8453, unhexlify('ef4461891dfb3ac8572ccf7c794664a8dd927945'))])
...
DISPLAY_FORMATS = [
    DisplayFormat(
        ...
        field_definitions=[
        FieldDefinition((1,), 'Amount', TokenAmountFormatter(token_path='ContainerPath.TODO')),
