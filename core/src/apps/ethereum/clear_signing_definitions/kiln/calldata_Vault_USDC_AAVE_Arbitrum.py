...
BINDING_CONTEXT = BindingContext([(42161, unhexlify('ff131917e1d6751e4d1b17612751db521b1403c5'))])
...
DISPLAY_FORMATS = [
    ...
    DisplayFormat(
        binding_context=BINDING_CONTEXT,
        func_sig=unhexlify("b460af94"),  # withdraw(uint256 assets,address receiver,address owner)
        intent="Withdraw",
        parameter_definitions=[
            Atomic(parse_uint256), # assets
            Atomic(parse_address), # receiver
