...
DISPLAY_FORMATS = [
    DisplayFormat(
        ...
        field_definitions=[
        FieldDefinition((5, 0, 4), 'Amount to Send', TokenAmountFormatter(token_path=(5, 0, 2))),
        FieldDefinition((4,), 'Minimum to Receive', TokenAmountFormatter(token_path=(5, -1, 3))),
    ...
    DisplayFormat(
        ...
        field_definitions=[
        FieldDefinition((5, 4), 'Amount to Send', TokenAmountFormatter(token_path=(5, 2))),
        FieldDefinition((4,), 'Minimum to Receive', TokenAmountFormatter(token_path=(5, 3))),
        FieldDefinition((3,), 'Recipient', AddressNameFormatter),
        ],
    ),
    DisplayFormat(
