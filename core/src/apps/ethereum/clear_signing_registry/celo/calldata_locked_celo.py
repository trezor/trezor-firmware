...
BINDING_CONTEXT = BindingContext(
    [
        (42220, unhexlify("55e1a0c8f376964bd339167476063bfed7f213d5")),
        (44787, unhexlify("6a4cc5693dc5bfa3799c699f3b941ba2cb00c341")),
    ]
)
...
DISPLAY_FORMATS = [
    DisplayFormat(
        ...
        field_definitions=[
            FieldDefinition(
                (1,), "Fraction to Delegate", UnitFormatter(decimals=22, base="%")
            ),
    ...
    DisplayFormat(
        ...
        field_definitions=[
            FieldDefinition((0,), "Delegatee", AddressNameFormatter),
            FieldDefinition(
                (1,), "Fraction to Revoke", UnitFormatter(decimals=22, base="%")
            ),
        ],
    ),
    DisplayFormat(
