...
BINDING_CONTEXT = BindingContext(
    [
        (42220, unhexlify("aeb865bca93ddc8f47b8e29f40c5399ce34d0c58")),
        (44787, unhexlify("9acf2a99914e083ad0d610672e93d14b0736bbcc")),
    ]
)
...
DISPLAY_FORMATS = [
    ...
    DisplayFormat(
        ...
        field_definitions=[
            FieldDefinition(
                ContainerPath.From, "Validator Account", AddressNameFormatter
            ),
        ],
    ),
    DisplayFormat(
        ...
        field_definitions=[
            FieldDefinition(
                ContainerPath.From, "Validator Address", AddressNameFormatter
            ),
