...
async def sign_tx(msg: StellarSignTx, keychain: Slip21Keychain) -> StellarSignedTx:
    ...
    for _ in range(num_operations):
        ...
        await process_operation(w, op, current_output_index, confirm=verifier is None)  # type: ignore [Argument of type "MessageType" cannot be assigned to parameter "op" of type "StellarMessageType" in function "process_operation"]
