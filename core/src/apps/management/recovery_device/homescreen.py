...
class _DisplayHandler(RecoveryHandler):
    def __init__(
        self,
...
class _N4W1Handler(RecoveryHandler):
    def __init__(
        self,
        recovery_type: RecoveryType,
...
async def _recover_secret(recovery_type: RecoveryType) -> tuple[bytes, BackupType]:
    ...
    _HANDLER_TYPES: dict[BackupMethod, type[RecoveryHandler]] = {
        BackupMethod.Display: _DisplayHandler,
        BackupMethod.N4W1: _N4W1Handler,
    }
    handler_type = _HANDLER_TYPES[await layout._choose_method()]
