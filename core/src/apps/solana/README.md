...
[Tranzaction fee calculation](https://docs.solana.com/transaction_fees#prioritization-fee)
...
[Stake pool instructions](https://docs.rs/spl-stake-pool/0.6.4/spl_stake_pool/instruction/index.html)
...
- "programs": An array that lists the different Solana programs and their details.
  ...
  - "instructions": An array of instructions associated with the Solana program.
    ...
    - "is_multisig": A boolean indicating whether the instruction is multisignature.
    - "parameters": Describes the parameters required for this instruction.
      - "name": The parameter name.
      - "ui_name": A human-readable label for the parameter, suitable for user interfaces.
    ...
    - "references": Defines the references to accounts that this instruction requires.
      ...
      - "ui_name": A user-friendly label for the account.
