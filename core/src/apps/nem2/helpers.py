...
NEM2_NAMESPACE_REGISTRATION_TYPE_ROOT = const(0)
NEM2_NAMESPACE_REGISTRATION_TYPE_SUB = const(1)

NEM2_ALIAS_ACTION_TYPE_LINK = const(1)
NEM2_ALIAS_ACTION_TYPE_UNLINK = const(0)
