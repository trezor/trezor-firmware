...
async def process_action(
    ...
    if account == "eosio":
        if name == "buyram":
            ...
            assert action.update_auth is not None
            ...
            assert action.unlink_auth is not None
            ...
            assert action.new_account is not None
        ...
        assert action.transfer is not None
