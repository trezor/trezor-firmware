...
def stm32u3_common_files(env, features_wanted, defines, sources, paths):
    features_available: list[str] = []

    defines += [
        ("STM32_HAL_H", "<stm32u3xx.h>"),
        ("FLASH_BLOCK_WORDS", "2"),
        ("USE_FLASH_BURST", "1"),
    ...
    paths += [
        ...
        "embed/sec/trustzone/inc",
        "embed/sec/unit_properties/inc",
        "embed/sys/bsp/stm32u3",
        "embed/sys/cpuid/inc",
        "embed/sys/inc",
        "embed/sys/irq/inc",
        "embed/sys/flash/inc",
        ...
        "vendor/stm32u3xx_hal_driver/Inc",
        "vendor/cmsis_device_u3/Include",
        "vendor/cmsis_5/CMSIS/Core/Include",
    ]

    sources += [
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_cortex.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_cryp.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_dma.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_dma_ex.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_exti.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_flash.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_flash_ex.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_gpio.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_gtzc.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_hash.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_i2c.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_i2c_ex.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_icache.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_lptim.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_pcd.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_pcd_ex.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_pwr.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_pwr_ex.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_ramcfg.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_rtc.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_rtc_ex.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_spi.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_tim.c",
        "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_tim_ex.c",
    ]

    if "secure_mode" in features_wanted:
        sources += [
            "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_rcc.c",
            "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_hal_rcc_ex.c",
        ]
    ...
    sources += [
        ...
        "embed/sec/hash_processor/stm32u3/hash_processor.c",
        "embed/sec/hdp/stm32u3/hdp.c",
        "embed/sec/fwutils/fwutils.c",
        "embed/sec/monoctr/stm32u5/monoctr.c",
        "embed/sec/option_bytes/stm32u3/option_bytes.c",
        ...
        "embed/sec/trustzone/stm32u5/tz_init.c",
        ...
        "embed/sys/startup/stm32u3/startup_init.c",
        "embed/sys/startup/stm32u3/vectortable.S",
    ...
    if "app_loading" in features_wanted:
        ...
        sources += ["embed/io/app_loader/app_cache.c"]
        sources += ["embed/io/app_loader/app_task.c"]
        sources += ["embed/io/app_loader/app_arena.c"]
        defines += [("USE_APP_LOADING", "1")]
        paths += ["embed/io/app_loader/inc"]
    ...
    if "usb" in features_wanted:
        sources += [
            ...
            "vendor/stm32u3xx_hal_driver/Src/stm32u3xx_ll_usb.c",
        ]
