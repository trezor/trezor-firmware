...
class TR:
    ...
    buttons__confirm_hash_only: str = "Confirm hash only"
    ...
    ethereum__view_calldata_hash_confirmation: str = "View calldata hash confirmation. You can't return to view full calldata after this."
