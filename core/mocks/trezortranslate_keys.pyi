...
class TR:
    ...
    hibernate__hint: str = "Your Trezor will be disconnected from all hosts."
    hibernate__start_bootloader: str = "Start bootloader"
    hibernate__turn_trezor_off: str = "Turn your Trezor off?"
