...
class TR:
    ...
    ble__all_devices: str = "all remembered host devices"
    ble__all_forgotten: str = "All hosts have been forgotten."
    ble__connected_device: str = "connected device"
    ble__current_forgotten: str = "The host has been forgotten."
    ble__forget_all: str = "Forget all"
    ble__forget_template: str = "You're about to forget {0}."
