...
class TR:
    ...
    recovery__dry_run_bip39_valid_mismatch: str = "The entered wallet backup is valid but does not match the one in this device."
    recovery__dry_run_slip39_valid_match: str = "The entered recovery shares are valid and match what is in this device."
    recovery__dry_run_slip39_valid_mismatch: str = "The entered recovery shares are valid but do not match what is in this device."
    ...
    recovery__share_does_not_match: str = "Share does not match"
