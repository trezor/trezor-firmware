...
class TR:
    ...
    reset__num_of_shares_long_info_template: str = "Each recovery share is a sequence of {0} words. Next you will choose how many shares you need to recover your wallet."
    ...
    reset__slip39_checklist_write_down_recovery: str = "Write down and check all shares"
    reset__the_word_is_repeated: str = "The word is repeated"
    reset__threshold_desc_group_template: str = "You will need {0} of {1} shares to form Group #{2}."
    reset__threshold_desc_template: str = "You will need {0} of {1} shares to recover your wallet."
