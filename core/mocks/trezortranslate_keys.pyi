...
class TR:
    ...
    ethereum__authorization: str = "Authorization"
    ...
    ethereum__delegation: str = "Delegation"
    ethereum__deposit_amount: str = "Deposit amount"
    ethereum__deposit_to: str = "Deposit to"
    ethereum__eip_7702: str = "EIP-7702"
    ethereum__eip_7702_authorization_intro_title: str = "Authorize your account to a third-party contract using EIP-7702?"
    ethereum__eip_7702_authorization_signed: str = "EIP-7702 authorization signed"
    ethereum__eip_7702_delegation_intro_title: str = "Delegate your account to a third-party contract using EIP-7702?"
    ethereum__eip_7702_delegation_signed: str = "EIP-7702 delegation signed"
    ethereum__eip_7702_revocation_intro_template: str = "Revoking {0} from smart account delegation."
    ethereum__eip_7702_revocation_transaction_completion: str = "Account revocation signed."
    ethereum__eip_7702_smart_account_contract_info: str = "Smart account contract info"
    ...
    ethereum__revocation: str = "Revocation"
    ...
    words__transaction_details: str = "Transaction details"
