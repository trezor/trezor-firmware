...
class TR:
    ...
    darkfi__authorize_spend: str = "Authorize spend"
    darkfi__export_full_viewing_key: str = "Export Full Viewing Key"
    darkfi__export_fvk_warning: str = "The Full Viewing Key reveals your entire transaction history to whoever holds it, but cannot spend your funds."
    darkfi__spend_hook: str = "Spend hook"
    darkfi__spend_recipient: str = "Recipient"
    darkfi__spend_token: str = "Token"
    darkfi__spend_user_data: str = "User data"
    darkfi__spend_value: str = "Value"
    darkfi__transaction_id: str = "Transaction ID"
