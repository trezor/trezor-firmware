...
class TR:
    ...
    bip85__app_bip39_template: str = "BIP-39 mnemonic ({0} words)"
    bip85__app_hex_template: str = "Raw entropy ({0} bytes)"
    bip85__app_pwd_base64_template: str = "Base64 password ({0} characters)"
    bip85__app_pwd_base85_template: str = "Base85 password ({0} characters)"
    bip85__app_unknown_template: str = "Unknown application ({0})"
    bip85__app_wif: str = "HD-Seed WIF"
    bip85__app_xprv: str = "Extended private key (xprv)"
    bip85__application: str = "Application"
    bip85__derived_secret: str = "Derived secret"
    bip85__send_to_host: str = "Send the derived secret to the connected app?"
    bip85__title: str = "BIP-85 entropy"
