...
class TR:
    ...
    authenticate__confirm_template: str = "Allow connected computer to confirm your {} is genuine?"
    authenticate__header: str = "Authenticate device"
    auto_lock__change_template: str = "Auto-lock your Trezor after {} of inactivity?"
    ...
    cardano__for_account_and_index_template: str = "for account {} and index {}:"
    cardano__for_account_template: str = "for account {}:"
    ...
    cardano__nested_scripts_template: str = "Contains {} nested scripts."
    ...
    cardano__sign_tx_path_template: str = "Sign transaction with {}:"
    ...
    device_name__change_template: str = "Change device name to {}?"
    ...
    eos__about_to_sign_template: str = "You are about to sign {}."
    ...
    ethereum__data_size_template: str = "Size: {} bytes"
    ...
    ethereum__units_template: str = "{} units"
    ...
    fido__device_already_registered_with_template: str = "This device is already registered with {}."
    ...
    homescreen__title_hold_to_lock: str = "HOLD TO LOCK"
    ...
    monero__unlock_time_set_template: str = "Unlock time for this transaction is set to {}"
    ...
    nem__raw_units_template: str = "{} raw units"
    ...
    nem__supply_units_template: str = "{} supply by {} whole units?"
    ...
    progress__x_seconds_left_template: str = "{} seconds left"
    ...
    recovery__group_num_template: str = "Group {}"
    ...
    recovery__share_num_template: str = "Share {}"
    ...
    recovery__type_word_x_of_y_template: str = "Type word {} of {}"
    ...
    recovery__word_count_template: str = "({} words)"
    recovery__word_x_of_y_template: str = "WORD {} OF {}"
    ...
    recovery__x_of_y_entered_template: str = "{} of {} shares entered successfully."
    ...
    reset__all_x_of_y_template: str = "all {} of {} shares"
    reset__any_x_of_y_template: str = "any {} of {} shares"
    ...
    reset__check_group_share_title_template: str = "CHECK G{} - SHARE {}"
    reset__check_seed_title: str = "CHECK SEED"
    reset__check_share_title_template: str = "CHECK SHARE #{}"
    reset__continue_with_next_share: str = "Continue with the next share."
    reset__continue_with_share_template: str = "Continue with share #{}."
    reset__finished_verifying_group_template: str = "You have finished verifying your recovery shares for group {}."
    ...
    reset__group_share_checked_successfully_template: str = "Group {} - Share {} checked successfully."
    reset__group_share_title_template: str = "GROUP {} - SHARE {}"
    reset__more_info_at: str = "More info at"
    reset__need_all_share_template: str = "For recovery you need all {} of the shares."
    reset__need_any_share_template: str = "For recovery you need any {} of the shares."
    ...
    reset__num_of_share_holders_template: str = "{} people or locations will each hold one share."
    reset__num_of_shares_advanced_info_template: str = "Each recovery share is a sequence of 20 words. Next you will choose the threshold number of shares needed to form Group {}."
    ...
    reset__num_shares_for_group_template: str = "The required number of shares to form Group {}."
    ...
    reset__recovery_share_title_template: str = "RECOVERY SHARE #{}"
    ...
    reset__select_word_template: str = "SELECT {} WORD"
    reset__select_word_x_of_y_template: str = "Select word {} of {}:"
    reset__set_it_to_count_template: str = "Set it to {} and you will need "
    reset__share_checked_successfully_template: str = "Recovery share #{} checked successfully."
    ...
    reset__to_form_group_template: str = "to form Group {}."
    reset__tos_link: str = "trezor.io/tos"
    reset__total_number_of_shares_in_group_template: str = "Set the total number of shares in Group {}."
    reset__use_your_backup: str = "Use your backup when you need to recover your wallet."
    reset__write_down_words_template: str = "Write down all {} words in order."
    ...
    rotation__change_template: str = "Do you want to change device rotation to {}?"
    ...
    sign_message__bytes_template: str = "{} Bytes"
    ...
    solana__transaction_requires_x_signers_template: str = "Transaction requires {} signers which increases the fee."
    ...
    stellar__issuer_template: str = "{} issuer:"
    ...
    stellar__on_network_template: str = "Transaction is on {}"
    ...
    stellar__price_per_template: str = "Price per {}:"
    ...
    stellar__set_sequence_to_template: str = "Set sequence to {}?"
    stellar__sign_tx_count_template: str = "Sign this transaction made up of {}"
    ...
    stellar__wanna_clean_value_key_template: str = "Do you want to clear value key {}?"
    ...
    u2f__set_template: str = "Set the U2F counter to {}?"
