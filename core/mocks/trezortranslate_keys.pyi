...
class TR:
    ...
    evolu__enable_labeling_header: str = "Secure Sync"
    evolu__enable_labeling_message: str = "Allow {0} on {1} to use Secure Sync with this Trezor?"
    evolu__enable_labeling_message_no_thp: str = "Allow this Trezor Suite use Secure Sync with this passphrase?"
