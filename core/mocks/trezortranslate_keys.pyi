...
class TR:
    ...
    ble__continue_on_host: str = "Continue on host"
    ble__device_name_template: str = "{0} is your device name."
    ...
    ble__pair_code_match: str = "Pairing code match?"
    ble__pair_new: str = "Pair new device"
    ble__pair_title: str = "Pair & connect"
    ble__pairing: str = "Bluetooth pairing"
