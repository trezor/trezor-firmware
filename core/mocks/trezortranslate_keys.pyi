...
class TR:
    ...
    evolu__enable_labeling_message: str = "Do you really want to enable labeling for {0} on {1}?"
    evolu__enable_labeling_message_no_thp: str = "Do you really want to enable labeling on this Suite?"
