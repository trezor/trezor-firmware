...
class TR:
    ...
    cardano__delegating_always_abstain: str = "Always Abstain"
    cardano__delegating_always_no_confidence: str = "Always No Confidence"
    cardano__delegating_to: str = "Delegating to:"
    cardano__delegating_to_key_hash: str = "Delegating to key hash:"
    cardano__delegating_to_script_hash: str = "Delegating to script hash:"
