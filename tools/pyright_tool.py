...
Usage:
- there are three options how to ignore/silence a pyright error:
    ...
    3 - native pyright file-level directives, e.g. "# pyright: reportMissingImports=false"
        - disable specific rules in the whole file (handled by pyright itself, not by this tool)
