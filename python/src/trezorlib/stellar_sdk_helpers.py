...
"""Translation of stellar-sdk objects into Trezor protobuf messages.

Requires the optional `stellar-sdk` dependency (`pip install trezor[stellar]`)
and fails to import without it. Device communication lives in `trezorlib.stellar`.
"""
...
if t.TYPE_CHECKING:
    from .stellar import StellarMessageType
