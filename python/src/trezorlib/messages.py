...
class StellarSCVal(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        15: protobuf.Field("string", "string", repeated=False, required=False, default=None),
...
class StellarSignSorobanAuthorization(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        3: protobuf.Field("nonce", "sint64", repeated=False, required=True),
        4: protobuf.Field("signature_expiration_ledger", "uint32", repeated=False, required=True),
        5: protobuf.Field("invocation", "StellarSorobanAuthorizedInvocation", repeated=False, required=True),
    }
