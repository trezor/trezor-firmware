...
class EvoluGetDelegatedIdentityKey(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        2: protobuf.Field("_host_static_public_key", "bytes", repeated=False, required=False, default=None),
    }
    ...
    def __init__(
        ...
        *,
        ...
        _host_static_public_key: Optional["bytes"] = None,
    ) -> None:
        self.thp_credential = thp_credential
        self._host_static_public_key = _host_static_public_key
