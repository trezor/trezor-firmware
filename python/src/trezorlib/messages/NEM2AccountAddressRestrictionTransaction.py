...
class NEM2AccountAddressRestrictionTransaction(p.MessageType):

    def __init__(
        self,
        restriction_type: EnumTypeNEM2AccountRestrictionFlags = None,
        restriction_additions: List[NEM2Address] = None,
        restriction_deletions: List[NEM2Address] = None,
    ) -> None:
    ...
    def get_fields(cls) -> Dict:
        return {
            ...
            2: ('restriction_additions', NEM2Address, p.FLAG_REPEATED),
            3: ('restriction_deletions', NEM2Address, p.FLAG_REPEATED),
        }
