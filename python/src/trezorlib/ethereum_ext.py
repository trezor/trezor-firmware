...
class EthereumMessages(IntEnum):
    GetPublicKey = 0
    PublicKey = 1
    GetAddress = 2
    Address = 3
...
def message_id(message: type[MessageType]) -> int:
    if message == messages.EthereumGetPublicKey:
        return EthereumMessages.GetPublicKey
    elif message == messages.EthereumPublicKey:
        return EthereumMessages.PublicKey
    elif message == messages.EthereumGetAddress:
        return EthereumMessages.GetAddress
    elif message == messages.EthereumAddress:
        return EthereumMessages.Address
    elif message == messages.EthereumSignMessage:
        return EthereumMessages.SignMessage
    elif message == messages.EthereumMessageSignature:
        return EthereumMessages.MessageSignature
    elif message == messages.EthereumSignTx:
        ...
        return EthereumMessages.TypedDataSignature
    elif message == messages.EthereumTypedDataStructRequest:
        return EthereumMessages.TypedDataStructRequest
    elif message == messages.EthereumTypedDataStructAck:
        return EthereumMessages.TypedDataStructAck
    elif message == messages.EthereumTypedDataValueRequest:
        return EthereumMessages.TypedDataValueRequest
    elif message == messages.EthereumTypedDataValueAck:
...
def message_type(msg_id: int) -> type[MessageType]:
    if msg_id == EthereumMessages.GetPublicKey:
        return messages.EthereumGetPublicKey
    elif msg_id == EthereumMessages.PublicKey:
        return messages.EthereumPublicKey
    elif msg_id == EthereumMessages.GetAddress:
        return messages.EthereumGetAddress
    elif msg_id == EthereumMessages.Address:
        return messages.EthereumAddress
    elif msg_id == EthereumMessages.SignMessage:
        return messages.EthereumSignMessage
    elif msg_id == EthereumMessages.MessageSignature:
        return messages.EthereumMessageSignature
    elif msg_id == EthereumMessages.SignTx:
        return messages.EthereumSignTx
    elif msg_id == EthereumMessages.TxRequest:
        return messages.EthereumTxRequest
    elif msg_id == EthereumMessages.SignTypedData:
        return messages.EthereumSignTypedData
    elif msg_id == EthereumMessages.TypedDataSignature:
        return messages.EthereumTypedDataSignature
    elif msg_id == EthereumMessages.TypedDataStructRequest:
        return messages.EthereumTypedDataStructRequest
    elif msg_id == EthereumMessages.TypedDataStructAck:
        return messages.EthereumTypedDataStructAck
    elif msg_id == EthereumMessages.TypedDataValueRequest:
        return messages.EthereumTypedDataValueRequest
    elif msg_id == EthereumMessages.TypedDataValueAck:
        return messages.EthereumTypedDataValueAck
...
def call_ext(
    ...
    *,
    ...
    msg = messages.ExtAppMessage(
        instance_id=instance_id,
        message_id=message_id(type(msg_data)),
        data=buf.getvalue(),
    )
    ...
    with session:
        resp = session.client._call(
            session, msg, expect=messages.ExtAppResponse, timeout=timeout
        )
        ...
        try:
            ...
            raise exceptions.TrezorFailure(
                failure=messages.Failure(message="Unexpected response type")
            )
...
def get_authenticated_address(
    ...
    return call_ext(
        session,
        instance_id,
        msg_data=messages.EthereumGetAddress(
            address_n=n,
...
def get_public_node(
    ...
    return call_ext(
        session,
        instance_id,
        msg_data=messages.EthereumGetPublicKey(address_n=n, show_display=show_display),
...
def sign_tx(
    ...
    response = call_ext(
        ...
        instance_id,
        msg_data=msg,
        expect=[messages.EthereumTxRequest],
    )
    ...
    while response.data_length is not None:
        ...
        response = call_ext(
            session,
            instance_id,
            msg_data=messages.EthereumTxAck(data_chunk=chunk),
            expect=[messages.EthereumTxRequest],
        )
...
def sign_message(
    ...
    return call_ext(
        session,
        instance_id,
        msg_data=messages.EthereumSignMessage(
            address_n=n,
...
def sign_typed_data(
    ...
    *,
    ...
    response = call_ext(
        ...
        msg_data=request,
        expect=[
            messages.EthereumTypedDataStructRequest,
            messages.EthereumTypedDataValueRequest,
            messages.EthereumTypedDataSignature,
        ],
    )
...
def verify_message(
    ...
    try:
        call_ext(
            session,
            instance_id,
            msg_data=messages.EthereumVerifyMessage(
                address=address,
                signature=signature,
                message=prepare_message_bytes(message),
                chunkify=chunkify,
...
def sign_typed_data_hash(
    ...
    return call_ext(
        session,
        instance_id,
        msg_data=messages.EthereumSignTypedHash(
            address_n=n,
