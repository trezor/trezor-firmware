...
class Cmd:
    ...
    SECRETS_CERTDEV_READ = "secrets-certdev-read"
    SECRETS_CERTDEV_WRITE = "secrets-certdev-write"
    SECRETS_GET_MCU_DEVICE_KEY = "secrets-get-mcu-device-key"
    SECRETS_INIT = "secrets-init"
    SECRETS_LOCK = "secrets-lock"
    SECRETS_RESET = "secrets-reset"
