...
class TestMsgEosSignTx(TrezorTest):
    ...
    def test_eos_signtx_transfer_token(self):
        ...
        with self.client:
            ...
            assert resp.signature_r.hex() == "0a9a0f467697010b743ffd02eae6698464c8b5c84b696245397287c225f85e01"
            assert resp.signature_s.hex() == "3ec6a0175e5209be6789587a9d6b5f61593b841a751112faa05d9efdd9239d40"
    ...
    def test_eos_signtx_buyram(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "480bdc505ba196d445d92ea12bda9d39f986d01620efcffe98bcf645ddcbb4ec"
            assert resp.signature_s.hex() == "35c8e2105f0228c9e1e511682ae79eac1b7b90bc84c1a0dae13245b7f0f96abf"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_buyrambytes(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "52267ee5f3ff73939af5ccdaa3406e0783deaf76accf5ce4ceb9714cdbdf7d6b"
            assert resp.signature_s.hex() == "53aa9a9ecf044396441a559b51d3b97e239321c895823aad6888b0de2063a078"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_sellram(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "04c0fdf1d2e0ea21af292173eacc2c7db90f7764abe69b79a8c2b24201af27c4"
            assert resp.signature_s.hex() == "7bb29f12eaaabbebdb5190d30367012a80128138b5024b30e93e3afb3d24734e"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_delegate(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "03b4ccb74b7ad54f28fdeda244facb3038cf70424fd6aa4b171a3bb02a591504"
            assert resp.signature_s.hex() == "4e24e08d1789421e17ba47e0e4635a3721400a795e40a8896dc5e5af4a95343d"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_undelegate(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "3f39722a88f12395f3cfcdbe218c185f02295ec07a5da8f4b953d5ec3c9ec36b"
            assert resp.signature_s.hex() == "7acbae47d60cd538ca28fcc8f3dae8f03b3812e7719dd4e9c069a66dbac5ebf3"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_refund(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "113c4867f77c371ff4701beb794ff0a0a6a1137a0115d0f4b5245c391e9f596f"
            assert resp.signature_s.hex() == "27203aaaeb8cdbc92c0af32f840c385ac6202e3b4e927bda59d397ebef513381"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_linkauth(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "5c9bf154dc77649ccf5a997441fcd4041e9da79149078df27a1c6268cf237c75"
            assert resp.signature_s.hex() == "3e432ddcd17feb2997145d11240b0ca4344a01e2d96e9886533bca7ffceb10cd"
    ...
    def test_eos_signtx_unlinkauth(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "316c296594fd7a4dd3b615d80c630fda256e9a3460b00d4f16eede1fb2af9574"
            assert resp.signature_s.hex() == "76d023913b4f323cfa857d144bf78a4d561954bb23c5df9a31649c9503c3a3b7"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_updateauth(self):
        ...
        assert isinstance(resp, messages.EosSignedTx)
        assert resp.signature_r.hex() == "00f0ca8ffa8208e72df509a3b356e77056b234d4db167b58d485f30cb9c61841"
        assert resp.signature_s.hex() == "3f6fb40ffa4e1cf6f3bcb0d8fa3873a2b5a05384ca9251159968558688a4e43d"
        assert resp.signature_v == 31
    ...
    def test_eos_signtx_deleteauth(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "6fe7d66f8be2fe3de23c48561e8a17113d1a0aabcf0d4160e9bd8af90f5a608f"
            assert resp.signature_s.hex() == "3cec8db96be2f6aa7bb00302cec6ad3c8655b492f9a2b84b3c61df6bc81f0d83"
            assert resp.signature_v == 32
    ...
    def test_eos_signtx_vote_proxy(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "6f511059a910d256ac20483bfedef2ada3b2d04f3261c97c0fce9455ca8b7ef4"
            assert resp.signature_s.hex() == "58d795deaf5c9b686e5bcaeabee801ad78e6675f051c24972d8c47abd33585f0"
            assert resp.signature_v == 32
    ...
    def test_eos_signtx_unknown(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "0bcc986299cf4eb1d5e5bc73620972b2b6683cd4230953a6f1725017927fd9ba"
            assert resp.signature_s.hex() == "488f7830e30eea5c7b4a96156bf7ffb0983c45a96211ca070b9db3bc6ba4db02"
            assert resp.signature_v == 31
    ...
    def test_eos_signtx_setcontract(self):
        ...
        with self.client:
            ...
            assert isinstance(resp, messages.EosSignedTx)
            assert resp.signature_r.hex() == "7bcd72464bc600e2e835c0f94027b6401c8f4c1369e5764a5e19c4b19557f84f"
            assert resp.signature_s.hex() == "5e7b76f1e7d5ef830c7e5921136a00f9a32f81c183deaa2e425280851cfc68d8"
            assert resp.signature_v == 31
