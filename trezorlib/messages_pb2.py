...
_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_EthereumSignMessage', index=60, number=64,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_EthereumVerifyMessage', index=61, number=65,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_EthereumMessageSignature', index=62, number=66,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
