...
_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkDecision', index=72, number=100,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001\260\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkGetState', index=73, number=101,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkState', index=74, number=102,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\250\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkStop', index=75, number=103,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkLog', index=76, number=104,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\250\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkMemoryRead', index=77, number=110,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkMemory', index=78, number=111,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\250\265\030\001')),
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkFlashErase', index=80, number=113,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\240\265\030\001')),
      type=None),
  ],
