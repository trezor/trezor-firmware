...
_COINTYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='xpub_magic', full_name='CoinType.xpub_magic', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='xprv_magic', full_name='CoinType.xprv_magic', index=9,
