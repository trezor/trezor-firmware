...
pub enum ThpMessageType {
    // @@protoc_insertion_point(enum_value:hw.trezor.messages.thp.ThpMessageType.ThpMessageType_Failure)
    ThpMessageType_Failure = 3,
...
impl ::protobuf::Enum for ThpMessageType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ThpMessageType> {
        match value {
            3 => ::std::option::Option::Some(ThpMessageType::ThpMessageType_Failure),
    ...
    fn from_str(str: &str) -> ::std::option::Option<ThpMessageType> {
        match str {
            "ThpMessageType_Failure" => ::std::option::Option::Some(ThpMessageType::ThpMessageType_Failure),
    ...
    const VALUES: &'static [ThpMessageType] = &[
        ThpMessageType::ThpMessageType_Failure,
...
impl ::protobuf::EnumFull for ThpMessageType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ThpMessageType::ThpMessageType_Failure => 0,
            ThpMessageType::ThpMessageType_Cancel => 1,
            ThpMessageType::ThpMessageType_ButtonRequest => 2,
            ThpMessageType::ThpMessageType_ButtonAck => 3,
            ThpMessageType::ThpMessageType_ThpPairingRequest => 4,
            ThpMessageType::ThpMessageType_ThpPairingRequestApproved => 5,
            ThpMessageType::ThpMessageType_ThpSelectMethod => 6,
            ThpMessageType::ThpMessageType_ThpPairingPreparationsFinished => 7,
            ThpMessageType::ThpMessageType_ThpCredentialRequest => 8,
            ThpMessageType::ThpMessageType_ThpCredentialResponse => 9,
            ThpMessageType::ThpMessageType_ThpEndRequest => 10,
            ThpMessageType::ThpMessageType_ThpEndResponse => 11,
            ThpMessageType::ThpMessageType_ThpCodeEntryCommitment => 12,
            ThpMessageType::ThpMessageType_ThpCodeEntryChallenge => 13,
            ThpMessageType::ThpMessageType_ThpCodeEntryCpaceTrezor => 14,
            ThpMessageType::ThpMessageType_ThpCodeEntryCpaceHostTag => 15,
            ThpMessageType::ThpMessageType_ThpCodeEntrySecret => 16,
            ThpMessageType::ThpMessageType_ThpQrCodeTag => 17,
            ThpMessageType::ThpMessageType_ThpQrCodeSecret => 18,
            ThpMessageType::ThpMessageType_ThpNfcTagHost => 19,
            ThpMessageType::ThpMessageType_ThpNfcTagTrezor => 20,
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x98\xb2\x19\x01*\x9d\x07\n\x0eThpMessageType\x12\x1a\n\x16ThpMessageTyp\
    e_Failure\x10\x03\x12\x19\n\x15ThpMessageType_Cancel\x10\x14\x12\x20\n\
    \x1cThpMessageType_ButtonRequest\x10\x1a\x12\x1c\n\x18ThpMessageType_But\
    tonAck\x10\x1b\x12%\n\x20ThpMessageType_ThpPairingRequest\x10\xf0\x07\
    \x12-\n(ThpMessageType_ThpPairingRequestApproved\x10\xf1\x07\x12#\n\x1eT\
    hpMessageType_ThpSelectMethod\x10\xf2\x07\x122\n-ThpMessageType_ThpPairi\
    ngPreparationsFinished\x10\xf3\x07\x12(\n#ThpMessageType_ThpCredentialRe\
    quest\x10\xf8\x07\x12)\n$ThpMessageType_ThpCredentialResponse\x10\xf9\
    \x07\x12!\n\x1cThpMessageType_ThpEndRequest\x10\xfa\x07\x12\"\n\x1dThpMe\
    ssageType_ThpEndResponse\x10\xfb\x07\x12*\n%ThpMessageType_ThpCodeEntryC\
    ommitment\x10\x80\x08\x12)\n$ThpMessageType_ThpCodeEntryChallenge\x10\
    \x81\x08\x12+\n&ThpMessageType_ThpCodeEntryCpaceTrezor\x10\x82\x08\x12,\
    \n'ThpMessageType_ThpCodeEntryCpaceHostTag\x10\x83\x08\x12&\n!ThpMessage\
    Type_ThpCodeEntrySecret\x10\x84\x08\x12\x20\n\x1bThpMessageType_ThpQrCod\
    eTag\x10\x88\x08\x12#\n\x1eThpMessageType_ThpQrCodeSecret\x10\x89\x08\
    \x12!\n\x1cThpMessageType_ThpNfcTagHost\x10\x90\x08\x12#\n\x1eThpMessage\
    Type_ThpNfcTagTrezor\x10\x91\x08\x1a\x04\xd0\xf3\x18\x01\"\x04\x08\0\x10\
    \x02\"\x04\x08\x04\x10\x13\"\x04\x08\x15\x10\x19\"\x05\x08\x1c\x10\xe7\
