...
pub struct FirmwareBegin {
    ...
    // @@protoc_insertion_point(field:hw.trezor.messages.bootloader.FirmwareBegin.code_hash)
    pub code_hash: ::std::option::Option<::std::vec::Vec<u8>>,
...
impl FirmwareBegin {
    ...
    // optional bytes code_hash = 8;

    pub fn code_hash(&self) -> &[u8] {
        match self.code_hash.as_ref() {
            Some(v) => v,
            None => &[],
        }
    }
    ...
    pub fn clear_code_hash(&mut self) {
        self.code_hash = ::std::option::Option::None;
    }
    ...
    pub fn set_code_hash(&mut self, v: ::std::vec::Vec<u8>) {
        self.code_hash = ::std::option::Option::Some(v);
    }
    ...
    pub fn mut_code_hash(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.code_hash.is_none() {
            self.code_hash = ::std::option::Option::Some(::std::vec::Vec::new());
        }
    ...
    pub fn take_code_hash(&mut self) -> ::std::vec::Vec<u8> {
        self.code_hash.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "code_hash",
            |m: &FirmwareBegin| { &m.code_hash },
            |m: &mut FirmwareBegin| { &mut m.code_hash },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "nrf_length",
...
impl ::protobuf::Message for FirmwareBegin {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                66 => {
                    self.code_hash = ::std::option::Option::Some(is.read_bytes()?);
                },
                40 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.code_hash.as_ref() {
    ...
    fn default_instance() -> &'static FirmwareBegin {
        static instance: FirmwareBegin = FirmwareBegin {
            ...
            code_hash: ::std::option::Option::None,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ode_hash\x18\x08\x20\x01(\x0cR\x08codeHash\x12\x1d\n\nnrf_length\x18\x05\
    \x20\x01(\rR\tnrfLength\x12\x1e\n\x0bnrf_co_path\x18\x06\x20\x01(\x0cR\t\
    nrfCoPath\x12$\n\x0enrf_image_hash\x18\x07\x20\x01(\x0cR\x0cnrfImageHash\
    J\x04\x08\x04\x10\x05\"n\n\x0fFirmwareRequest\x12\x16\n\x06offset\x18\
    \x01\x20\x02(\rR\x06offset\x12\x16\n\x06length\x18\x02\x20\x02(\rR\x06le\
    ngth\x12+\n\x11coprocessor_index\x18\x03\x20\x01(\rR\x10coprocessorIndex\
    \"[\n\x0eFirmwareUpload\x12\x18\n\x07payload\x18\x01\x20\x02(\x0cR\x07pa\
    yload\x12\x12\n\x04hash\x18\x02\x20\x01(\x0cR\x04hash\x12\x1b\n\tprev_ha\
    sh\x18\x03\x20\x01(\x0cR\x08prevHash\"&\n\nProdTestT1\x12\x18\n\x07paylo\
    ad\x18\x01\x20\x01(\x0cR\x07payloadB>\n#com.satoshilabs.trezor.lib.proto\
    bufB\x17TrezorMessageBootloader\
";
