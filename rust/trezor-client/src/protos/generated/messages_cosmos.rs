...
pub struct CosmosPublicKey {
    // message fields
    // @@protoc_insertion_point(field:hw.trezor.messages.cosmos.CosmosPublicKey.key_type)
...
impl CosmosPublicKey {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "key_type",
            |m: &CosmosPublicKey| { &m.key_type },
            |m: &mut CosmosPublicKey| { &mut m.key_type },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "value",
...
impl CosmosModeInfoSingle {
    ...
    pub fn mode(&self) -> CosmosSignMode {
        match self.mode {
            Some(e) => e.enum_value_or(CosmosSignMode::SIGN_MODE_UNSPECIFIED),
            None => CosmosSignMode::SIGN_MODE_UNSPECIFIED,
        }
    }
...
pub enum CosmosSignMode {
    // @@protoc_insertion_point(enum_value:hw.trezor.messages.cosmos.CosmosSignMode.SIGN_MODE_UNSPECIFIED)
...
impl ::protobuf::Enum for CosmosSignMode {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CosmosSignMode> {
        match value {
            0 => ::std::option::Option::Some(CosmosSignMode::SIGN_MODE_UNSPECIFIED),
    ...
    fn from_str(str: &str) -> ::std::option::Option<CosmosSignMode> {
        match str {
            "SIGN_MODE_UNSPECIFIED" => ::std::option::Option::Some(CosmosSignMode::SIGN_MODE_UNSPECIFIED),
    ...
    const VALUES: &'static [CosmosSignMode] = &[
        CosmosSignMode::SIGN_MODE_UNSPECIFIED,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\taddress_n\x18\x01\x20\x03(\rR\x08addressN\x12!\n\x0cshow_display\x18\
    \x02\x20\x01(\x08R\x0bshowDisplay\"B\n\x0fCosmosPublicKey\x12\x19\n\x08k\
    ey_type\x18\x01\x20\x02(\tR\x07keyType\x12\x14\n\x05value\x18\x02\x20\
    \x02(\x0cR\x05value\"F\n\x0cCosmosSignTx\x12\x1b\n\taddress_n\x18\x01\
    \x20\x03(\rR\x08addressN\x12\x19\n\x08sign_doc\x18\x02\x20\x02(\x0cR\x07\
    signDoc\".\n\x0eCosmosSignedTx\x12\x1c\n\tsignature\x18\x01\x20\x02(\x0c\
    R\tsignature\"\x98\x01\n\rCosmosSignDoc\x12\x1d\n\nbody_bytes\x18\x01\
    \x20\x02(\x0cR\tbodyBytes\x12&\n\x0fauth_info_bytes\x18\x02\x20\x02(\x0c\
    R\rauthInfoBytes\x12\x19\n\x08chain_id\x18\x03\x20\x02(\tR\x07chainId\
    \x12%\n\x0eaccount_number\x18\x04\x20\x02(\x04R\raccountNumber\"\x98\x01\
    \n\x0eCosmosAuthInfo\x12N\n\x0csigner_infos\x18\x01\x20\x03(\x0b2+.hw.tr\
    ezor.messages.cosmos.CosmosSignerInfoR\x0bsignerInfos\x126\n\x03fee\x18\
    \x02\x20\x02(\x0b2$.hw.trezor.messages.cosmos.CosmosFeeR\x03fee\"\xbb\
    \x01\n\x10CosmosSignerInfo\x12C\n\npublic_key\x18\x01\x20\x02(\x0b2$.hw.\
    trezor.messages.cosmos.CosmosAnyR\tpublicKey\x12F\n\tmode_info\x18\x02\
    \x20\x02(\x0b2).hw.trezor.messages.cosmos.CosmosModeInfoR\x08modeInfo\
    \x12\x1a\n\x08sequence\x18\x03\x20\x02(\x04R\x08sequence\"Y\n\x0eCosmosM\
    odeInfo\x12G\n\x06single\x18\x01\x20\x02(\x0b2/.hw.trezor.messages.cosmo\
    s.CosmosModeInfoSingleR\x06single\"U\n\x14CosmosModeInfoSingle\x12=\n\
    \x04mode\x18\x01\x20\x02(\x0e2).hw.trezor.messages.cosmos.CosmosSignMode\
    R\x04mode\"\x8b\x01\n\x0cCosmosTxBody\x12@\n\x08messages\x18\x01\x20\x03\
    (\x0b2$.hw.trezor.messages.cosmos.CosmosAnyR\x08messages\x12\x12\n\x04me\
    mo\x18\x02\x20\x01(\tR\x04memo\x12%\n\x0etimeout_height\x18\x03\x20\x01(\
    \x04R\rtimeoutHeight\"\x94\x01\n\x11CosmosBankMsgSend\x12!\n\x0cfrom_add\
    ress\x18\x01\x20\x02(\tR\x0bfromAddress\x12\x1d\n\nto_address\x18\x02\
    \x20\x02(\tR\ttoAddress\x12=\n\x06amount\x18\x03\x20\x03(\x0b2%.hw.trezo\
    r.messages.cosmos.CosmosCoinR\x06amount\"\x97\x01\n\tCosmosFee\x12=\n\
    \x06amount\x18\x01\x20\x03(\x0b2%.hw.trezor.messages.cosmos.CosmosCoinR\
    \x06amount\x12\x1b\n\tgas_limit\x18\x02\x20\x02(\x04R\x08gasLimit\x12\
    \x14\n\x05payer\x18\x03\x20\x01(\tR\x05payer\x12\x18\n\x07granter\x18\
    \x04\x20\x01(\tR\x07granter\":\n\nCosmosCoin\x12\x14\n\x05denom\x18\x01\
    \x20\x02(\tR\x05denom\x12\x16\n\x06amount\x18\x02\x20\x02(\tR\x06amount\
    \")\n\x15CosmosSecp256k1Pubkey\x12\x10\n\x03key\x18\x01\x20\x02(\x0cR\
    \x03key\"<\n\tCosmosAny\x12\x19\n\x08type_url\x18\x01\x20\x02(\tR\x07typ\
    eUrl\x12\x14\n\x05value\x18\x02\x20\x02(\x0cR\x05value*A\n\x0eCosmosSign\
