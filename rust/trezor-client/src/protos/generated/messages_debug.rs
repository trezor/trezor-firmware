...
pub struct DebugLinkDecision {
    ...
    pub touch_event_type: ::std::option::Option<::protobuf::EnumOrUnknown<debug_link_decision::TouchEventType>>,
    // special fields
...
impl DebugLinkDecision {
    ...
    // optional .hw.trezor.messages.debug.DebugLinkDecision.TouchEventType touch_event_type = 9;

    pub fn touch_event_type(&self) -> debug_link_decision::TouchEventType {
        match self.touch_event_type {
            Some(e) => e.enum_value_or(debug_link_decision::TouchEventType::UNSPECIFIED),
            None => debug_link_decision::TouchEventType::UNSPECIFIED,
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_touch_event_type(&mut self, v: debug_link_decision::TouchEventType) {
...
pub mod debug_link_decision {
    ...
    #[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
    // @@protoc_insertion_point(enum:hw.trezor.messages.debug.DebugLinkDecision.TouchEventType)
    pub enum TouchEventType {
        // @@protoc_insertion_point(enum_value:hw.trezor.messages.debug.DebugLinkDecision.TouchEventType.UNSPECIFIED)
        UNSPECIFIED = 0,
        // @@protoc_insertion_point(enum_value:hw.trezor.messages.debug.DebugLinkDecision.TouchEventType.TOUCH_START)
        TOUCH_START = 1,
        // @@protoc_insertion_point(enum_value:hw.trezor.messages.debug.DebugLinkDecision.TouchEventType.TOUCH_END)
        TOUCH_END = 2,
    }

    impl ::protobuf::Enum for TouchEventType {
        ...
        fn from_i32(value: i32) -> ::std::option::Option<TouchEventType> {
            match value {
                0 => ::std::option::Option::Some(TouchEventType::UNSPECIFIED),
                1 => ::std::option::Option::Some(TouchEventType::TOUCH_START),
                2 => ::std::option::Option::Some(TouchEventType::TOUCH_END),
                _ => ::std::option::Option::None
            }
        }

        fn from_str(str: &str) -> ::std::option::Option<TouchEventType> {
            match str {
                "UNSPECIFIED" => ::std::option::Option::Some(TouchEventType::UNSPECIFIED),
                "TOUCH_START" => ::std::option::Option::Some(TouchEventType::TOUCH_START),
                "TOUCH_END" => ::std::option::Option::Some(TouchEventType::TOUCH_END),
                _ => ::std::option::Option::None
            }
        }

        const VALUES: &'static [TouchEventType] = &[
            TouchEventType::UNSPECIFIED,
            TouchEventType::TOUCH_START,
            TouchEventType::TOUCH_END,
        ];
    }

    impl ::protobuf::EnumFull for TouchEventType {
        fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().enum_by_package_relative_name("DebugLinkDecision.TouchEventType").unwrap()).clone()
        }
    ...
    impl ::std::default::Default for TouchEventType {
        fn default() -> Self {
            TouchEventType::UNSPECIFIED
        }
    }
    ...
    impl TouchEventType {
        pub(in super) fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
            ::protobuf::reflect::GeneratedEnumDescriptorData::new::<TouchEventType>("DebugLinkDecision.TouchEventType")
        }
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ecision.DebugPhysicalButtonR\x0ephysicalButton\x12d\n\x10touch_event_typ\
    e\x18\t\x20\x01(\x0e2:.hw.trezor.messages.debug.DebugLinkDecision.TouchE\
    ventTypeR\x0etouchEventType\"<\n\x13DebugSwipeDirection\x12\x06\n\x02UP\
    ...
    TOUCH_START\x10\x01\x12\r\n\tTOUCH_END\x10\x02\"-\n\x0fDebugLinkLayout\
    \x12\x16\n\x06tokens\x18\x01\x20\x03(\tR\x06tokens:\x02\x18\x01\"-\n\x15\
    DebugLinkReseedRandom\x12\x14\n\x05value\x18\x01\x20\x01(\rR\x05value\"j\
    \n\x15DebugLinkRecordScreen\x12)\n\x10target_directory\x18\x01\x20\x01(\
    \tR\x0ftargetDirectory\x12&\n\rrefresh_index\x18\x02\x20\x01(\r:\x010R\
    \x0crefreshIndex\"\xc6\x02\n\x11DebugLinkGetState\x12(\n\x0ewait_word_li\
    st\x18\x01\x20\x01(\x08R\x0cwaitWordListB\x02\x18\x01\x12&\n\rwait_word_\
    pos\x18\x02\x20\x01(\x08R\x0bwaitWordPosB\x02\x18\x01\x12e\n\x0bwait_lay\
    out\x18\x03\x20\x01(\x0e29.hw.trezor.messages.debug.DebugLinkGetState.De\
    bugWaitType:\tIMMEDIATER\nwaitLayout\x123\n\x12return_empty_state\x18\
    \x04\x20\x01(\x08:\x05falseR\x10returnEmptyState\"C\n\rDebugWaitType\x12\
    \r\n\tIMMEDIATE\x10\0\x12\x0f\n\x0bNEXT_LAYOUT\x10\x01\x12\x12\n\x0eCURR\
    ENT_LAYOUT\x10\x02\"\x97\x04\n\x0eDebugLinkState\x12\x16\n\x06layout\x18\
    \x01\x20\x01(\x0cR\x06layout\x12\x10\n\x03pin\x18\x02\x20\x01(\tR\x03pin\
    \x12\x16\n\x06matrix\x18\x03\x20\x01(\tR\x06matrix\x12'\n\x0fmnemonic_se\
    cret\x18\x04\x20\x01(\x0cR\x0emnemonicSecret\x129\n\x04node\x18\x05\x20\
    \x01(\x0b2%.hw.trezor.messages.common.HDNodeTypeR\x04node\x123\n\x15pass\
    phrase_protection\x18\x06\x20\x01(\x08R\x14passphraseProtection\x12\x1d\
    \n\nreset_word\x18\x07\x20\x01(\tR\tresetWord\x12#\n\rreset_entropy\x18\
    \x08\x20\x01(\x0cR\x0cresetEntropy\x12,\n\x12recovery_fake_word\x18\t\
    \x20\x01(\tR\x10recoveryFakeWord\x12*\n\x11recovery_word_pos\x18\n\x20\
    \x01(\rR\x0frecoveryWordPos\x12$\n\x0ereset_word_pos\x18\x0b\x20\x01(\rR\
    \x0cresetWordPos\x12N\n\rmnemonic_type\x18\x0c\x20\x01(\x0e2).hw.trezor.\
    messages.management.BackupTypeR\x0cmnemonicType\x12\x16\n\x06tokens\x18\
    \r\x20\x03(\tR\x06tokens\"\x87\x01\n\x17DebugLinkGetPairingInfo\x12\x1d\
    \n\nchannel_id\x18\x01\x20\x01(\x0cR\tchannelId\x12%\n\x0ehandshake_hash\
    \x18\x02\x20\x01(\x0cR\rhandshakeHash\x12&\n\x0fnfc_secret_host\x18\x03\
    \x20\x01(\x0cR\rnfcSecretHost\"\xd2\x01\n\x14DebugLinkPairingInfo\x12\
    \x1d\n\nchannel_id\x18\x01\x20\x01(\x0cR\tchannelId\x12%\n\x0ehandshake_\
    hash\x18\x02\x20\x01(\x0cR\rhandshakeHash\x12&\n\x0fcode_entry_code\x18\
    \x03\x20\x01(\rR\rcodeEntryCode\x12\x20\n\x0ccode_qr_code\x18\x04\x20\
    \x01(\x0cR\ncodeQrCode\x12*\n\x11nfc_secret_trezor\x18\x05\x20\x01(\x0cR\
    \x0fnfcSecretTrezor\"\x0f\n\rDebugLinkStop\"P\n\x0cDebugLinkLog\x12\x14\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            enums.push(debug_link_decision::TouchEventType::generated_enum_descriptor_data());
