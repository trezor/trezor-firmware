...
pub struct EvoluGetDelegatedIdentityKey {
    ...
    // @@protoc_insertion_point(field:hw.trezor.messages.evolu.EvoluGetDelegatedIdentityKey._host_static_public_key)
    pub _host_static_public_key: ::std::option::Option<::std::vec::Vec<u8>>,
    // special fields
...
impl EvoluGetDelegatedIdentityKey {
    ...
    // optional bytes _host_static_public_key = 2;

    pub fn _host_static_public_key(&self) -> &[u8] {
        match self._host_static_public_key.as_ref() {
            Some(v) => v,
            None => &[],
        }
    }

    pub fn clear__host_static_public_key(&mut self) {
        self._host_static_public_key = ::std::option::Option::None;
    }

    pub fn has__host_static_public_key(&self) -> bool {
        self._host_static_public_key.is_some()
    }

    // Param is passed by value, moved
    pub fn set__host_static_public_key(&mut self, v: ::std::vec::Vec<u8>) {
        self._host_static_public_key = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut__host_static_public_key(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self._host_static_public_key.is_none() {
            self._host_static_public_key = ::std::option::Option::Some(::std::vec::Vec::new());
        }
        self._host_static_public_key.as_mut().unwrap()
    }

    // Take field
    pub fn take__host_static_public_key(&mut self) -> ::std::vec::Vec<u8> {
        self._host_static_public_key.take().unwrap_or_else(|| ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "_host_static_public_key",
            |m: &EvoluGetDelegatedIdentityKey| { &m._host_static_public_key },
            |m: &mut EvoluGetDelegatedIdentityKey| { &mut m._host_static_public_key },
        ));
...
impl ::protobuf::Message for EvoluGetDelegatedIdentityKey {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    self._host_static_public_key = ::std::option::Option::Some(is.read_bytes()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self._host_static_public_key.as_ref() {
            my_size += ::protobuf::rt::bytes_size(2, &v);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
    ...
    fn default_instance() -> &'static EvoluGetDelegatedIdentityKey {
        static instance: EvoluGetDelegatedIdentityKey = EvoluGetDelegatedIdentityKey {
            ...
            _host_static_public_key: ::std::option::Option::None,
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x02(\x0cR\tsignature\"\x7f\n\x1cEvoluGetDelegatedIdentityKe\
    y\x12%\n\x0ethp_credential\x18\x01\x20\x01(\x0cR\rthpCredential\x128\n\
    \x17_host_static_public_key\x18\x02\x20\x01(\x0cR\x13HostStaticPublicKey\
