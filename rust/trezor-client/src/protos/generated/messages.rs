...
pub enum MessageType {
    ...
    // @@protoc_insertion_point(enum_value:hw.trezor.messages.MessageType.MessageType_DebugLinkNfcConnected)
    MessageType_DebugLinkNfcConnected = 9014,
    // @@protoc_insertion_point(enum_value:hw.trezor.messages.MessageType.MessageType_DebugLinkNfcWrite)
    MessageType_DebugLinkNfcWrite = 9015,
    // @@protoc_insertion_point(enum_value:hw.trezor.messages.MessageType.MessageType_DebugLinkNfcRead)
    MessageType_DebugLinkNfcRead = 9016,
    // @@protoc_insertion_point(enum_value:hw.trezor.messages.MessageType.MessageType_DebugLinkNfcResponse)
    MessageType_DebugLinkNfcResponse = 9017,
...
impl ::protobuf::Enum for MessageType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<MessageType> {
        match value {
            ...
            9014 => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcConnected),
            9015 => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcWrite),
            9016 => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcRead),
            9017 => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcResponse),
    ...
    fn from_str(str: &str) -> ::std::option::Option<MessageType> {
        match str {
            ...
            "MessageType_DebugLinkNfcConnected" => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcConnected),
            "MessageType_DebugLinkNfcWrite" => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcWrite),
            "MessageType_DebugLinkNfcRead" => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcRead),
            "MessageType_DebugLinkNfcResponse" => ::std::option::Option::Some(MessageType::MessageType_DebugLinkNfcResponse),
    ...
    const VALUES: &'static [MessageType] = &[
        ...
        MessageType::MessageType_DebugLinkNfcConnected,
        MessageType::MessageType_DebugLinkNfcWrite,
        MessageType::MessageType_DebugLinkNfcRead,
        MessageType::MessageType_DebugLinkNfcResponse,
...
impl ::protobuf::EnumFull for MessageType {
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            MessageType::MessageType_DebugLinkNfcConnected => 108,
            MessageType::MessageType_DebugLinkNfcWrite => 109,
            MessageType::MessageType_DebugLinkNfcRead => 110,
            MessageType::MessageType_DebugLinkNfcResponse => 111,
            ...
            MessageType::MessageType_BenchmarkListNames => 273,
            MessageType::MessageType_BenchmarkNames => 274,
            MessageType::MessageType_BenchmarkRun => 275,
            MessageType::MessageType_BenchmarkResult => 276,
            MessageType::MessageType_TelemetryGet => 277,
            MessageType::MessageType_Telemetry => 278,
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0emessages.proto\x12\x12hw.trezor.messages\x1a\roptions.proto*\xd0a\
    ...
    \x01\xa0\xb5\x18\x01\x120\n!MessageType_DebugLinkNfcConnected\x10\xb6F\
    \x1a\x08\x80\xa6\x1d\x01\xa0\xb5\x18\x01\x12,\n\x1dMessageType_DebugLink\
    NfcWrite\x10\xb7F\x1a\x08\x80\xa6\x1d\x01\xa8\xb5\x18\x01\x12+\n\x1cMess\
    ageType_DebugLinkNfcRead\x10\xb8F\x1a\x08\x80\xa6\x1d\x01\xa8\xb5\x18\
    \x01\x12/\n\x20MessageType_DebugLinkNfcResponse\x10\xb9F\x1a\x08\x80\xa6\
