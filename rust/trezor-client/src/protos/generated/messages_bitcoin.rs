...
pub struct GetAddress {
    ...
    pub miniscript: ::std::option::Option<::std::string::String>,
    // special fields
...
impl GetAddress {
    ...
    // optional string miniscript = 8;

    pub fn miniscript(&self) -> &str {
        match self.miniscript.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_miniscript(&mut self) {
        self.miniscript = ::std::option::Option::None;
    }

    pub fn has_miniscript(&self) -> bool {
        self.miniscript.is_some()
    }

    // Param is passed by value, moved
    pub fn set_miniscript(&mut self, v: ::std::string::String) {
        self.miniscript = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_miniscript(&mut self) -> &mut ::std::string::String {
        if self.miniscript.is_none() {
            self.miniscript = ::std::option::Option::Some(::std::string::String::new());
        }
        self.miniscript.as_mut().unwrap()
    }

    // Take field
    pub fn take_miniscript(&mut self) -> ::std::string::String {
        self.miniscript.take().unwrap_or_else(|| ::std::string::String::new())
    }
...
impl ::protobuf::Message for GetAddress {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                66 => {
                    self.miniscript = ::std::option::Option::Some(is.read_string()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static GetAddress {
        static instance: GetAddress = GetAddress {
            ...
            miniscript: ::std::option::Option::None,
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    rezor.messages.bitcoin.TxAck.TransactionTypeR\x02tx\x1a\xbd\x0f\n\x0fTra\
    ...
    \x1b\n\tbranch_id\x18\x0e\x20\x01(\rR\x08branchId\x1a\x91\x06\n\x0bTxInp\
    ...
    \x010R\rcoinjoinFlags\x12\x1e\n\nminiscript\x18\x15\x20\x01(\tR\nminiscr\
    ipt\x1a\x82\x01\n\x0fTxOutputBinType\x12\x16\n\x06amount\x18\x01\x20\x02\
    (\x04R\x06amount\x12#\n\rscript_pubkey\x18\x02\x20\x02(\x0cR\x0cscriptPu\
    bkey\x122\n\x15decred_script_version\x18\x03\x20\x01(\rR\x13decredScript\
    ...
    hw.trezor.messages.bitcoin.MultisigRedeemScriptTypeR\x08multisig\x12$\n\
    \x0eop_return_data\x18\x06\x20\x01(\x0cR\x0copReturnData\x12\x1b\n\torig\
    _hash\x18\n\x20\x01(\x0cR\x08origHash\x12\x1d\n\norig_index\x18\x0b\x20\
    \x01(\rR\torigIndex\x12*\n\x11payment_req_index\x18\x0c\x20\x01(\rR\x0fp\
    aymentReqIndex:\x02\x18\x01\"\x9f\x06\n\x07TxInput\x12\x1b\n\taddress_n\
    ...
    bkey\x12(\n\x0ecoinjoin_flags\x18\x14\x20\x01(\r:\x010R\rcoinjoinFlags\
    \x12\x1e\n\nminiscript\x18\x15\x20\x01(\tR\nminiscriptJ\x04\x08\n\x10\
    \x0bJ\x04\x08\x0b\x10\x0cJ\x04\x08\x0c\x10\r\"\xa8\x03\n\x08TxOutput\x12\
