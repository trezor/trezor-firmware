...
trezor_message_impl! {
    ...
    WardChainRequest => MessageType_WardChainRequest,
    WardChainLinkAck => MessageType_WardChainLinkAck,
    WardResetApp => MessageType_WardResetApp,
    WardResetAppAck => MessageType_WardResetAppAck,
