trezor_message_impl! {
    ...
    BLEUploadFirmwareInit => MessageType_BLEUploadFirmwareInit,
    BLEUploadFirmwareNextChunk => MessageType_BLEUploadFirmwareNextChunk,
    BLEUploadFirmwareChunk => MessageType_BLEUploadFirmwareChunk,
    BLEPairingRequest => MessageType_BLEPairingRequest,
    BLEAuthKey => MessageType_BLEAuthKey,
    BLERepairRequest => MessageType_BLERepairRequest,
    BLEEraseBonds => MessageType_BLEEraseBonds,
    BLEDisconnect => MessageType_BLEDisconnect,
    BLEComparisonRequest => MessageType_BLEComparisonRequest,
