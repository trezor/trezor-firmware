trezor_message_impl! {
    ...
    ExtAppHeaderRequest => MessageType_ExtAppHeaderRequest,
    ExtAppHeaderAck => MessageType_ExtAppHeaderAck,
    ExtAppRootPacketRequest => MessageType_ExtAppRootPacketRequest,
    ExtAppRootPacketAck => MessageType_ExtAppRootPacketAck,
    ExtAppDataChunkRequest => MessageType_ExtAppDataChunkRequest,
    ExtAppDataChunkAck => MessageType_ExtAppDataChunkAck,
