trezor_message_impl! {
    ...
    DatabaseWipe => MessageType_DatabaseWipe,
    DatabaseWipeResponse => MessageType_DatabaseWipeResponse,
    DatabaseModifyKey => MessageType_DatabaseModifyKey,
    DatabaseModifyKeyResponse => MessageType_DatabaseModifyKeyResponse,
    DatabaseProveMembership => MessageType_DatabaseProveMembership,
    DatabaseMerge => MessageType_DatabaseMerge,
    DatabaseMergeResponse => MessageType_DatabaseMergeResponse,
}
