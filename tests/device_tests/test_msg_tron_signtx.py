...
class TestMsgTronSignTx:
    def test_tron_send_trx(self, client):
    ...
    def test_tron_send_token(self, client):
    ...
    def test_tron_vote_witness(self, client):
    ...
    def test_tron_witness_create(self, client):
        msg = proto.TronSignTx(
    ...
    def test_tron_asset_issue(self, client):
        msg = proto.TronSignTx(
    ...
    def test_tron_witness_update(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_participate_asset(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_account_update(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_freeze_balance_bandwidth(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_freeze_balance_energy(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_freeze_balance_bandwidth_rental(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_freeze_balance_energy_rental(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_unfreeze_balance_bandwidth(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_unfreeze_balance_energy(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_unfreeze_balance_bandwidth_rental(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_unfreeze_balance_energy_rental(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_withdraw_balance(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_unfreeze_asset(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_update_asset(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_proposal_create_contract(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_proposal_approve_contract(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_proposal_delete_contract(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_set_account_id_contract(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("D0EF"),
            ref_block_hash=bytes.fromhex("6CD6025AFD991D7D"),
            expiration=1531429101000,
    ...
    def test_tron_create_exchange_contract(self, client):
        msg = proto.TronSignTx(
    ...
    def test_tron_exchange_inject_contract(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("b80e"),
            ref_block_hash=bytes.fromhex("2b264690d8bd9711"),
            expiration=1561994163000,
    ...
    def test_tron_exchange_withdraw_contract(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("b80e"),
            ref_block_hash=bytes.fromhex("2b264690d8bd9711"),
            expiration=1561994163000,
    ...
    def test_tron_exchange_transaction_contract(self, client):
        msg = proto.TronSignTx(
            ref_block_bytes=bytes.fromhex("b80e"),
            ref_block_hash=bytes.fromhex("2b264690d8bd9711"),
            expiration=1561994163000,
    ...
    def test_tron_transfer_trc20(self, client):
        data = bytearray()
    ...
    def test_tron_approve_trc20(self, client):
        data = bytearray()
        # method id signalizing `transfer(address _to, uint256 _value)` function
    ...
    def test_tron_transfer_trc20_not_in_list(self, client):
        data = bytearray()
        # method id signalizing `transfer(address _to, uint256 _value)` function
        data.extend(bytes.fromhex("a9059cbb"))
        # 1st function argument (to - the receiver)
