...
The existing xpub tests cannot observe the warning: InputFlowShowXpubQRCode
dismisses the warning screen, so they pass either way. Here the ButtonRequest
