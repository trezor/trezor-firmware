...
def select_number_of_words(
    ...
    def select_bolt() -> "LayoutContent":
        # click the button from ValuePad
        if unlock_repeated_backup:
            coords_map = {20: buttons.grid34(1, 2, debug.layout_type), 33: buttons.grid34(2, 2, debug.layout_type)}
        else:
            coords_map = {
    ...
    def select_delizia() -> "LayoutContent":
        # click the button from ValuePad
        if unlock_repeated_backup:
            coords_map = {20: buttons.grid34(0, 1, debug.layout_type), 33: buttons.grid34(2, 1, debug.layout_type)}
        else:
            coords_map = {
