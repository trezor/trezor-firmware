...
Seedless sessions are a special kind of sessions. These sessions can be used for operations that do not require seed to be derived - for instance management tasks. Only seedless sessions can be used on uninitialzed devices.
