...
let
  sources = {
    ...
    "electron-to-chromium-1.4.35" = {
      ...
      version = "1.4.35";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.35.tgz";
...
in
{
  "pyright-1.1.202" = nodeEnv.buildNodePackage {
    name = "pyright";
    packageName = "pyright";
    version = "1.1.202";
    src = fetchurl {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.4.35"
