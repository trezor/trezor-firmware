...
static void derivation_function(
    const uint8_t *input1, size_t input1_length, const uint8_t *input2, size_t input2_length,
...
void chacha_drbg_init(
    CHACHA_DRBG_CTX *ctx, const uint8_t *entropy, size_t entropy_length, const uint8_t *nonce,
    size_t nonce_length)
{
...
void chacha_drbg_reseed(
    CHACHA_DRBG_CTX *ctx, const uint8_t *entropy, size_t entropy_length,
