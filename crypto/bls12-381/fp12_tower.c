...
static void mul_by_xy0_fp6(vec384fp6 ret, const vec384fp6 a,
                           const vec384fp6 b) {
  vec384x t0, t1, /*t2,*/ t3, t4, t5;
...
static void conjugate_fp12(vec384fp12 a) { neg_fp6(a[1], a[1]); }
 ...
 */
void blst_fp12_sqr(vec384fp12 ret, const vec384fp12 a) { sqr_fp12(ret, a); }
...
void blst_fp12_conjugate(vec384fp12 a) { conjugate_fp12(a); }
