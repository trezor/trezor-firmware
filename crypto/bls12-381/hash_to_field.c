...
static const vec384 BLS12_381_RRRR = {/* RR^2 */
                                      TO_LIMB_T(0xed48ac6bd94ca1e0),
                                      TO_LIMB_T(0x315f831e03a7adf8),
                                      TO_LIMB_T(0x9a53352a615e29dd),
                                      TO_LIMB_T(0x34c04e5e921e1761),
                                      TO_LIMB_T(0x2512d43565724728),
                                      TO_LIMB_T(0x0aa6346091755d4d)};
...
static void vec_xor(void *restrict ret, const void *restrict a,
  ...
  for (i = 0; i < num; i++) rp[i] = ap[i] ^ bp[i];
}
...
static void hash_to_field(vec384 elems[], size_t nelems,
  ...
  expand_message_xmd((unsigned char *)pseudo_random, len_in_bytes, aug, aug_len,
