...
pub struct trezor_crypto_v1_t {
    ...
    pub sha3_256_Init: unsafe extern "C" fn(ctx: *mut SHA3_CTX),
    pub sha3_512_Init: unsafe extern "C" fn(ctx: *mut SHA3_CTX),
    pub sha3_Update: unsafe extern "C" fn(ctx: *mut SHA3_CTX, msg: *const u8, size: usize),
    pub sha3_Final: unsafe extern "C" fn(ctx: *mut SHA3_CTX, result: *mut u8),
    pub keccak_Final: unsafe extern "C" fn(ctx: *mut SHA3_CTX, result: *mut u8),
