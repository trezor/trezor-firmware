    ...
    while True:
        if isinstance(response, ethereum_messages.TxRequest):
            if (
                ...
                if msg_type is ethereum_messages.SignTx:
        ...
        elif isinstance(response, ethereum_messages.DefinitionRequest):
            ...
            if definition_provider is not None:
                ...
                ack = ethereum_messages.DefinitionAck(
                    definitions=None,
                )
            response = call_ext(
                session,
...
def sign_tx_eip1559(
    ...
    *,
    ...
    return _ethereum_sign_loop(
        session,
        instance_id,
        ethereum_messages.SignTxEIP1559,
        response,
        data,
        chain_id,
        definition_provider,
